(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();new NR;function NR(){var i=[],e=[],t="className",n="getElementsByClassName",r="length",s="display",a="transition",c="style",u="height",h="scrollTop",d="offsetHeight",p="fixed",_=document,g=document.documentElement,E=function(G,_e,F){G.addEventListener?G.addEventListener(_e,F,!1):G.attachEvent&&G.attachEvent("on"+_e,F)},x=function(G,_e){if(typeof getComputedStyle<"u")var F=getComputedStyle(G,null);else F=G.currentStyle;return F?F[_e]:p},y=function(){var G=_.body;return Math.max(G.scrollHeight,G[d],g.clientHeight,g.scrollHeight,g[d])},m=function(G,_e){for(var F=G[r];F--;)if(G[F]===_e)return!0;return!1},b=function(G,_e){return m(G[t].split(" "),_e)},T=function(G,_e){b(G,_e)||(G[t]?G[t]+=" "+_e:G[t]=_e)},C=function(G,_e){if(G[t]&&b(G,_e)){for(var F="",Pe=G[t].split(" "),Ce=0,Ee=Pe[r];Ce<Ee;Ce++)Pe[Ce]!==_e&&(F+=Pe[Ce]+" ");G[t]=F.replace(/^\s+|\s+$/g,"")}},w=function(){return window.pageYOffset||g[h]},I=function(G){return G.getBoundingClientRect().top},O=function(G){var _e=w();_e>G.oS&&!b(G,p)?T(G,p):b(G,p)&&_e<G.oS&&C(G,p)},B=function(){for(var G=0;G<e[r];G++)M(e[G])},M=function(G){G.oS?(G.fT&&clearTimeout(G.fT),G.fT=setTimeout(function(){G.aF?O(G):Q(G)},50)):Q(G)},L=function(G,_e,F){C(G,p),_e[s]="none",F.position=F.top=""},Q=function(G){var _e=I(G),F=G[d],Pe=G[c],Ce=G.pH[c],Ee=w();if(_e<G.oT&&Ee>G.oS&&!b(G,p)&&(window.innerHeight||g.clientHeight)>F){G.tP=Ee+_e-G.oT;var ze=y();if(F>ze-G.tP-F)var st=F;else st=0;Ce[s]="block",Ce[a]="none",Ce[u]=F+1+"px",G.pH[d],Ce[a]="height .3s",Ce[u]=st+"px",T(G,p),Pe.position=p,Pe.top=G.oT+"px",x(G,"position")!=p&&(Ce[s]="none")}else if(b(G,p)&&(Ee<G.tP||Ee<G.oS)){var Ue=x(G,"animation");if(G.oS&&G.classList&&Ue.indexOf("slide-down")!=-1){var He=x(G,"animationDuration");G.classList.remove(p),Pe.animationDirection="reverse",Pe.animationDuration="300ms",G[d],G.classList.add(p),setTimeout(function(){L(G,Ce,Pe),Pe.animationDirection="normal",Pe.animationDuration=He},300)}else L(G,Ce,Pe)}},te=function(){var G=[],_e,F;if(_[n])G=_[n]("float-panel"),i=_[n]("slideanim");else{var Pe=_.getElementsByTagName("*");for(_e=Pe[r];_e--;)b(Pe[_e],"float-panel")&&G.push(Pe[_e])}_e=G[r];for(var Ce=0;Ce<_e;Ce++)F=e[Ce]=G[Ce],F.oT=parseInt(F.getAttribute("data-top")||0),F.oS=parseInt(F.getAttribute("data-scroll")||0),F.oS>20&&x(F,"position")==p&&(F.aF=1),F.pH=_.createElement("div"),F.pH[c].width=F.offsetWidth+"px",F.pH[c][s]="none",F.parentNode.insertBefore(F.pH,F.nextSibling);e[r]&&(setTimeout(B,160),E(window,"scroll",B))},W,$=200,j=0,le,J,ne=function(){return window.innerWidth||g.clientWidth||_.body.clientWidth};function ge(){le||(le=setInterval(function(){var G=_.body;G[h]<3?G[h]=0:G[h]=G[h]/1.3,g[h]<3?g[h]=0:g[h]=g[h]/1.3,w()||(clearInterval(le),le=null)},14))}function he(){clearTimeout(J),w()>$&&ne()>j?(J=setTimeout(function(){C(W,"mcOut")},60),W[c][s]="block"):(T(W,"mcOut"),J=setTimeout(function(){W[c][s]="none"},500))}var Ie=function(){if(W=_.getElementById("backtop"),W){var G=W.getAttribute("data-v-w");G&&(G=G.replace(/\s/g,"").split(","),$=parseInt(G[0]),G[r]>1&&(j=parseInt(G[1]))),E(W,"click",ge),E(window,"scroll",he),he()}},ye=function(){for(var G=w(),_e=G+window.innerHeight,F=i[r],Pe,Ce,Ee=0;Ee<F;Ee++)Pe=G+I(i[Ee]),Ce=Pe+i[Ee][d],Pe<_e?T(i[Ee],"slide"):C(i[Ee],"slide")},ie=function(){i[r]&&(E(window,"scroll",ye),ye())},ce=function(){te(),Ie(),ie()};E(window,"load",ce),E(document,"touchstart",function(){})}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o_=[];var Ut;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(Ut||(Ut={}));const wy={debug:Ut.DEBUG,verbose:Ut.VERBOSE,info:Ut.INFO,warn:Ut.WARN,error:Ut.ERROR,silent:Ut.SILENT},cP=Ut.INFO,uP={[Ut.DEBUG]:"log",[Ut.VERBOSE]:"log",[Ut.INFO]:"info",[Ut.WARN]:"warn",[Ut.ERROR]:"error"},hP=(i,e,...t)=>{if(e<i.logLevel)return;const n=new Date().toISOString(),r=uP[e];if(r)console[r](`[${n}]  ${i.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Th{constructor(e){this.name=e,this._logLevel=cP,this._logHandler=hP,this._userLogHandler=null,o_.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Ut))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?wy[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Ut.DEBUG,...e),this._logHandler(this,Ut.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Ut.VERBOSE,...e),this._logHandler(this,Ut.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Ut.INFO,...e),this._logHandler(this,Ut.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Ut.WARN,...e),this._logHandler(this,Ut.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Ut.ERROR,...e),this._logHandler(this,Ut.ERROR,...e)}}function fP(i){o_.forEach(e=>{e.setLogLevel(i)})}function dP(i,e){for(const t of o_){let n=null;e&&e.level&&(n=wy[e.level]),i===null?t.userLogHandler=null:t.userLogHandler=(r,s,...a)=>{const c=a.map(u=>{if(u==null)return null;if(typeof u=="string")return u;if(typeof u=="number"||typeof u=="boolean")return u.toString();if(u instanceof Error)return u.message;try{return JSON.stringify(u)}catch{return null}}).filter(u=>u).join(" ");s>=(n??r.logLevel)&&i({level:Ut[s].toLowerCase(),message:c,args:a,type:r.name})}}}const pP=(i,e)=>e.some(t=>i instanceof t);let kv,zv;function _P(){return kv||(kv=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function mP(){return zv||(zv=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const by=new WeakMap,fp=new WeakMap,Ay=new WeakMap,hd=new WeakMap,a_=new WeakMap;function gP(i){const e=new Promise((t,n)=>{const r=()=>{i.removeEventListener("success",s),i.removeEventListener("error",a)},s=()=>{t(bs(i.result)),r()},a=()=>{n(i.error),r()};i.addEventListener("success",s),i.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&by.set(t,i)}).catch(()=>{}),a_.set(e,i),e}function vP(i){if(fp.has(i))return;const e=new Promise((t,n)=>{const r=()=>{i.removeEventListener("complete",s),i.removeEventListener("error",a),i.removeEventListener("abort",a)},s=()=>{t(),r()},a=()=>{n(i.error||new DOMException("AbortError","AbortError")),r()};i.addEventListener("complete",s),i.addEventListener("error",a),i.addEventListener("abort",a)});fp.set(i,e)}let dp={get(i,e,t){if(i instanceof IDBTransaction){if(e==="done")return fp.get(i);if(e==="objectStoreNames")return i.objectStoreNames||Ay.get(i);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return bs(i[e])},set(i,e,t){return i[e]=t,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function xP(i){dp=i(dp)}function yP(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const n=i.call(fd(this),e,...t);return Ay.set(n,e.sort?e.sort():[e]),bs(n)}:mP().includes(i)?function(...e){return i.apply(fd(this),e),bs(by.get(this))}:function(...e){return bs(i.apply(fd(this),e))}}function EP(i){return typeof i=="function"?yP(i):(i instanceof IDBTransaction&&vP(i),pP(i,_P())?new Proxy(i,dp):i)}function bs(i){if(i instanceof IDBRequest)return gP(i);if(hd.has(i))return hd.get(i);const e=EP(i);return e!==i&&(hd.set(i,e),a_.set(e,i)),e}const fd=i=>a_.get(i);function SP(i,e,{blocked:t,upgrade:n,blocking:r,terminated:s}={}){const a=indexedDB.open(i,e),c=bs(a);return n&&a.addEventListener("upgradeneeded",u=>{n(bs(a.result),u.oldVersion,u.newVersion,bs(a.transaction),u)}),t&&a.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),c.then(u=>{s&&u.addEventListener("close",()=>s()),r&&u.addEventListener("versionchange",h=>r(h.oldVersion,h.newVersion,h))}).catch(()=>{}),c}const MP=["get","getKey","getAll","getAllKeys","count"],TP=["put","add","delete","clear"],dd=new Map;function Gv(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(dd.get(e))return dd.get(e);const t=e.replace(/FromIndex$/,""),n=e!==t,r=TP.includes(t);if(!(t in(n?IDBIndex:IDBObjectStore).prototype)||!(r||MP.includes(t)))return;const s=async function(a,...c){const u=this.transaction(a,r?"readwrite":"readonly");let h=u.store;return n&&(h=h.index(c.shift())),(await Promise.all([h[t](...c),r&&u.done]))[0]};return dd.set(e,s),s}xP(i=>({...i,get:(e,t,n)=>Gv(e,t)||i.get(e,t,n),has:(e,t)=>!!Gv(e,t)||i.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wP{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(bP(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function bP(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const pp="@firebase/app",Hv="0.9.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Po=new Th("@firebase/app"),AP="@firebase/app-compat",CP="@firebase/analytics-compat",RP="@firebase/analytics",PP="@firebase/app-check-compat",IP="@firebase/app-check",LP="@firebase/auth",DP="@firebase/auth-compat",NP="@firebase/database",OP="@firebase/database-compat",UP="@firebase/functions",FP="@firebase/functions-compat",BP="@firebase/installations",kP="@firebase/installations-compat",zP="@firebase/messaging",GP="@firebase/messaging-compat",HP="@firebase/performance",WP="@firebase/performance-compat",VP="@firebase/remote-config",XP="@firebase/remote-config-compat",qP="@firebase/storage",YP="@firebase/storage-compat",$P="@firebase/firestore",KP="@firebase/firestore-compat",jP="firebase",ZP="9.22.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Os="[DEFAULT]",QP={[pp]:"fire-core",[AP]:"fire-core-compat",[RP]:"fire-analytics",[CP]:"fire-analytics-compat",[IP]:"fire-app-check",[PP]:"fire-app-check-compat",[LP]:"fire-auth",[DP]:"fire-auth-compat",[NP]:"fire-rtdb",[OP]:"fire-rtdb-compat",[UP]:"fire-fn",[FP]:"fire-fn-compat",[BP]:"fire-iid",[kP]:"fire-iid-compat",[zP]:"fire-fcm",[GP]:"fire-fcm-compat",[HP]:"fire-perf",[WP]:"fire-perf-compat",[VP]:"fire-rc",[XP]:"fire-rc-compat",[qP]:"fire-gcs",[YP]:"fire-gcs-compat",[$P]:"fire-fst",[KP]:"fire-fst-compat","fire-js":"fire-js",[jP]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gI(i){const e={},t={__esModule:!0,initializeApp:s,app:r,registerVersion:As,setLogLevel:Ly,onLog:Iy,apps:null,SDK_VERSION:l_,INTERNAL:{registerComponent:c,removeApp:n,useAsService:u,modularAPIs:pI}};t.default=t,Object.defineProperty(t,"apps",{get:a});function n(h){delete e[h]}function r(h){if(h=h||Os,!wi(e,h))throw qv.create("no-app",{appName:h});return e[h]}r.App=i;function s(h,d={}){const p=c_(h,d);if(wi(e,p.name))return e[p.name];const _=new i(p,t);return e[p.name]=_,_}function a(){return Object.keys(e).map(h=>e[h])}function c(h){const d=h.name,p=d.replace("-compat","");if(Ba(h)&&h.type==="PUBLIC"){const _=(g=r())=>{if(typeof g[p]!="function")throw qv.create("invalid-app-argument",{appName:d});return g[p]()};h.serviceProps!==void 0&&Kl(_,h.serviceProps),t[p]=_,i.prototype[p]=function(...g){return this._getService.bind(this,d).apply(this,h.multipleInstances?g:[])}}return h.type==="PUBLIC"?t[p]:null}function u(h,d){return d==="serverAuth"?null:d}return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */if(qR()&&self.firebase!==void 0){Yv.warn(`
  ...
  `);const i=self.firebase.SDK_VERSION;i&&i.indexOf("LITE")>=0&&Yv.warn(`
    ...
    `)}const wh=vI;EI();var SI="firebase",MI="9.22.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */wh.registerVersion(SI,MI,"app-compat");const $v="@firebase/database",Kv="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wI{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return wi(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const By=function(i){try{if(typeof window<"u"&&typeof window[i]<"u"){const e=window[i];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new TI(e)}}catch{}return new wI},vo=By("localStorage"),_p=By("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kI{constructor(){this.counters_={}}incrementCounter(e,t=1){wi(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return FR(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GI{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const n=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let r=0;r<n.length;++r)n[r]&&il(()=>{this.onMessage_(n[r])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let vp;function yL(i){vp=i}const hE=function(i){return typeof i=="number"?"number:"+Wy(i):"string:"+i},fE=function(i){if(i.isLeafNode()){const e=i.val();Me(typeof e=="string"||typeof e=="number"||typeof e=="object"&&wi(e,".sv"),"Priority must be a string or number.")}else Me(i===vp||i.isEmpty(),"priority of unexpected type.");Me(i===vp||i.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TL=Math.log(2);class wL{constructor(e){const t=s=>parseInt(Math.log(s)/TL,10),n=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const r=n(this.count);this.bits_=e+1&r}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const eh=function(i,e,t,n){i.sort(e);const r=function(u,h){const d=h-u;let p,_;if(d===0)return null;if(d===1)return p=i[u],_=t?t(p):p,new Sn(_,p.node,Sn.BLACK,null,null);{const g=parseInt(d/2,10)+u,E=r(u,g),x=r(g+1,h);return p=i[g],_=t?t(p):p,new Sn(_,p.node,Sn.BLACK,E,x)}},s=function(u){let h=null,d=null,p=i.length;const _=function(E,x){const y=p-E,m=p;p-=E;const b=r(y+1,m),T=i[y],C=t?t(T):T;g(new Sn(C,T.node,x,null,b))},g=function(E){h?(h.left=E,h=E):(d=E,h=E)};for(let E=0;E<u.count;++E){const x=u.nextBitIsOne(),y=Math.pow(2,u.count-(E+1));x?_(y,Sn.BLACK):(_(y,Sn.BLACK),_(y,Sn.RED))}return d},a=new wL(i.length),c=s(a);return new ni(n||e,c)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let vd;const oa={};class Qr{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return Me(oa&&Gt,"ChildrenNode.ts has not been loaded"),vd=vd||new Qr({".priority":oa},{".priority":Gt}),vd}get(e){const t=Ro(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof ni?t:null}hasIndex(e){return wi(this.indexSet_,e.toString())}addIndex(e,t){Me(e!==Mr,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const s=t.getIterator(dt.Wrap);let a=s.getNext();for(;a;)r=r||e.isDefinedOn(a.node),n.push(a),a=s.getNext();let c;r?c=eh(n,e.getCompare()):c=oa;const u=e.toString(),h=Object.assign({},this.indexSet_);h[u]=e;const d=Object.assign({},this.indexes_);return d[u]=c,new Qr(d,h)}addToIndexes(e,t){const n=ju(this.indexes_,(r,s)=>{const a=Ro(this.indexSet_,s);if(Me(a,"Missing index implementation for "+s),r===oa)if(a.isDefinedOn(e.node)){const c=[],u=t.getIterator(dt.Wrap);let h=u.getNext();for(;h;)h.name!==e.name&&c.push(h),h=u.getNext();return c.push(e),eh(c,a.getCompare())}else return oa;else{const c=t.get(e.name);let u=r;return c&&(u=u.remove(new dt(e.name,c))),u.insert(e,e.node)}});return new Qr(n,this.indexSet_)}removeFromIndexes(e,t){const n=ju(this.indexes_,r=>{if(r===oa)return r;{const s=t.get(e.name);return s?r.remove(new dt(e.name,s)):r}});return new Qr(n,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BL{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&wn(this.last_,(n,r)=>{t[n]=t[n]-r}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f0=10*1e3,kL=30*1e3,zL=5*60*1e3;class GL{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new BL(e);const n=f0+(kL-f0)*Math.random();Gl(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;wn(e,(r,s)=>{s>0&&wi(this.statsToReport_,r)&&(t[r]=s,n=!0)}),n&&this.server_.reportStats(t),Gl(this.reportStats_.bind(this),Math.floor(Math.random()*2*zL))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ga{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=hr.MERGE}operationForChild(e){if(ht(this.path)){const t=this.children.subtree(new At(e));return t.isEmpty()?null:t.value?new Io(this.source,St(),t.value):new Ga(this.source,St(),t)}else return Me(ut(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ga(this.source,Ft(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fr{constructor(e){this.writeTree_=e}static empty(){return new fr(new zt(null))}}function Wl(i,e,t){if(ht(e))return new fr(new zt(t));{const n=i.writeTree_.findRootMostValueAndPath(e);if(n!=null){const r=n.path;let s=n.value;const a=$n(r,e);return s=s.updateChild(a,t),new fr(i.writeTree_.set(r,s))}else{const r=new zt(t),s=i.writeTree_.setTree(e,r);return new fr(s)}}}function Mp(i,e,t){let n=i;return wn(t,(r,s)=>{n=Wl(n,qt(e,r),s)}),n}function d0(i,e){if(ht(e))return fr.empty();{const t=i.writeTree_.setTree(e,new zt(null));return new fr(t)}}function Tp(i,e){return zo(i,e)!=null}function zo(i,e){const t=i.writeTree_.findRootMostValueAndPath(e);return t!=null?i.writeTree_.get(t.path).getChild($n(t.path,e)):null}function p0(i){const e=[],t=i.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(Gt,(n,r)=>{e.push(new dt(n,r))}):i.writeTree_.children.inorderTraversal((n,r)=>{r.value!=null&&e.push(new dt(n,r.value))}),e}function Cs(i,e){if(ht(e))return i;{const t=zo(i,e);return t!=null?new fr(new zt(t)):new fr(i.writeTree_.subtree(e))}}function wp(i){return i.writeTree_.isEmpty()}function Ha(i,e){return gE(St(),i.writeTree_,e)}function gE(i,e,t){if(e.value!=null)return t.updateChild(i,e.value);{let n=null;return e.children.inorderTraversal((r,s)=>{r===".priority"?(Me(s.value!==null,"Priority writes must always be leaf nodes"),n=s.value):t=gE(qt(i,r),s,t)}),!t.getChild(i).isEmpty()&&n!==null&&(t=t.updateChild(qt(i,".priority"),n)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ih(i,e){return EE(e,i)}function YL(i,e,t,n,r){Me(n>i.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),i.allWrites.push({path:e,snap:t,writeId:n,visible:r}),r&&(i.visibleWrites=Wl(i.visibleWrites,e,t)),i.lastWriteId=n}function $L(i,e,t,n){Me(n>i.lastWriteId,"Stacking an older merge on top of newer ones"),i.allWrites.push({path:e,children:t,writeId:n,visible:!0}),i.visibleWrites=Mp(i.visibleWrites,e,t),i.lastWriteId=n}function KL(i,e){for(let t=0;t<i.allWrites.length;t++){const n=i.allWrites[t];if(n.writeId===e)return n}return null}function jL(i,e){const t=i.allWrites.findIndex(c=>c.writeId===e);Me(t>=0,"removeWrite called with nonexistent writeId.");const n=i.allWrites[t];i.allWrites.splice(t,1);let r=n.visible,s=!1,a=i.allWrites.length-1;for(;r&&a>=0;){const c=i.allWrites[a];c.visible&&(a>=t&&ZL(c,n.path)?r=!1:Xi(n.path,c.path)&&(s=!0)),a--}if(r){if(s)return QL(i),!0;if(n.snap)i.visibleWrites=d0(i.visibleWrites,n.path);else{const c=n.children;wn(c,u=>{i.visibleWrites=d0(i.visibleWrites,qt(n.path,u))})}return!0}else return!1}function ZL(i,e){if(i.snap)return Xi(i.path,e);for(const t in i.children)if(i.children.hasOwnProperty(t)&&Xi(qt(i.path,t),e))return!0;return!1}function QL(i){i.visibleWrites=vE(i.allWrites,JL,St()),i.allWrites.length>0?i.lastWriteId=i.allWrites[i.allWrites.length-1].writeId:i.lastWriteId=-1}function JL(i){return i.visible}function vE(i,e,t){let n=fr.empty();for(let r=0;r<i.length;++r){const s=i[r];if(e(s)){const a=s.path;let c;if(s.snap)Xi(t,a)?(c=$n(t,a),n=Wl(n,c,s.snap)):Xi(a,t)&&(c=$n(a,t),n=Wl(n,St(),s.snap.getChild(c)));else if(s.children){if(Xi(t,a))c=$n(t,a),n=Mp(n,c,s.children);else if(Xi(a,t))if(c=$n(a,t),ht(c))n=Mp(n,St(),s.children);else{const u=Ro(s.children,ut(c));if(u){const h=u.getChild(Ft(c));n=Wl(n,St(),h)}}}else throw tl("WriteRecord should have .snap or .children")}}return n}function xE(i,e,t,n,r){if(!n&&!r){const s=zo(i.visibleWrites,e);if(s!=null)return s;{const a=Cs(i.visibleWrites,e);if(wp(a))return t;if(t==null&&!Tp(a,St()))return null;{const c=t||Ye.EMPTY_NODE;return Ha(a,c)}}}else{const s=Cs(i.visibleWrites,e);if(!r&&wp(s))return t;if(!r&&t==null&&!Tp(s,St()))return null;{const a=function(h){return(h.visible||r)&&(!n||!~n.indexOf(h.writeId))&&(Xi(h.path,e)||Xi(e,h.path))},c=vE(i.allWrites,a,e),u=t||Ye.EMPTY_NODE;return Ha(c,u)}}}function eD(i,e,t){let n=Ye.EMPTY_NODE;const r=zo(i.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(Gt,(s,a)=>{n=n.updateImmediateChild(s,a)}),n;if(t){const s=Cs(i.visibleWrites,e);return t.forEachChild(Gt,(a,c)=>{const u=Ha(Cs(s,new At(a)),c);n=n.updateImmediateChild(a,u)}),p0(s).forEach(a=>{n=n.updateImmediateChild(a.name,a.node)}),n}else{const s=Cs(i.visibleWrites,e);return p0(s).forEach(a=>{n=n.updateImmediateChild(a.name,a.node)}),n}}function tD(i,e,t,n,r){Me(n||r,"Either existingEventSnap or existingServerSnap must exist");const s=qt(e,t);if(Tp(i.visibleWrites,s))return null;{const a=Cs(i.visibleWrites,s);return wp(a)?r.getChild(t):Ha(a,r.getChild(t))}}function nD(i,e,t,n){const r=qt(e,t),s=zo(i.visibleWrites,r);if(s!=null)return s;if(n.isCompleteForChild(t)){const a=Cs(i.visibleWrites,r);return Ha(a,n.getNode().getImmediateChild(t))}else return null}function iD(i,e){return zo(i.visibleWrites,e)}function rD(i,e,t,n,r,s,a){let c;const u=Cs(i.visibleWrites,e),h=zo(u,St());if(h!=null)c=h;else if(t!=null)c=Ha(u,t);else return[];if(c=c.withIndex(a),!c.isEmpty()&&!c.isLeafNode()){const d=[],p=a.getCompare(),_=s?c.getReverseIteratorFrom(n,a):c.getIteratorFrom(n,a);let g=_.getNext();for(;g&&d.length<r;)p(g,n)!==0&&d.push(g),g=_.getNext();return d}else return[]}function sD(){return{visibleWrites:fr.empty(),allWrites:[],lastWriteId:-1}}function sh(i,e,t,n){return xE(i.writeTree,i.treePath,e,t,n)}function T_(i,e){return eD(i.writeTree,i.treePath,e)}function _0(i,e,t,n){return tD(i.writeTree,i.treePath,e,t,n)}function oh(i,e){return iD(i.writeTree,qt(i.treePath,e))}function oD(i,e,t,n,r,s){return rD(i.writeTree,i.treePath,e,t,n,r,s)}function w_(i,e,t){return nD(i.writeTree,i.treePath,e,t)}function yE(i,e){return EE(qt(i.treePath,e),i.writeTree)}function EE(i,e){return{treePath:i,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lD{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}}const SE=new lD;class b_{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const n=this.optCompleteServerCache_!=null?new ks(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return w_(this.writes_,e,n)}}getChildAfterChild(e,t,n){const r=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Lo(this.viewCache_),s=oD(this.writes_,r,t,1,n,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ch;function CD(i){Me(!ch,"__referenceConstructor has already been defined"),ch=i}function RD(){return Me(ch,"Reference.ts has not been loaded"),ch}let PD=1;class E0{constructor(e){this.listenProvider_=e,this.syncPointTree_=new zt(null),this.pendingWriteTree_=sD(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function C_(i,e,t,n,r){return YL(i.pendingWriteTree_,e,t,n,r),r?sl(i,new Io(E_(),e,t)):[]}function ID(i,e,t,n){$L(i.pendingWriteTree_,e,t,n);const r=zt.fromObject(t);return sl(i,new Ga(E_(),e,r))}function Ss(i,e,t=!1){const n=KL(i.pendingWriteTree_,e);if(jL(i.pendingWriteTree_,e)){let s=new zt(null);return n.snap!=null?s=s.set(St(),!0):wn(n.children,a=>{s=s.set(new At(a),!0)}),sl(i,new ih(n.path,s,t))}else return[]}function xc(i,e,t){return sl(i,new Io(S_(),e,t))}function LD(i,e,t){const n=zt.fromObject(t);return sl(i,new Ga(S_(),e,n))}function DD(i,e){return sl(i,new ic(S_(),e))}function ND(i,e,t){const n=R_(i,t);if(n){const r=P_(n),s=r.path,a=r.queryId,c=$n(s,e),u=new ic(M_(a),c);return I_(i,s,u)}else return[]}function uh(i,e,t,n,r=!1){const s=e._path,a=i.syncPointTree_.get(s);let c=[];if(a&&(e._queryIdentifier==="default"||RE(a,e))){const u=AD(a,e,t,n);wD(a)&&(i.syncPointTree_=i.syncPointTree_.remove(s));const h=u.removed;if(c=u.events,!r){const d=h.findIndex(_=>_._queryParams.loadsAllData())!==-1,p=i.syncPointTree_.findOnPath(s,(_,g)=>zs(g));if(d&&!p){const _=i.syncPointTree_.subtree(s);if(!_.isEmpty()){const g=FD(_);for(let E=0;E<g.length;++E){const x=g[E],y=x.query,m=DE(i,x);i.listenProvider_.startListening(Vl(y),rc(i,y),m.hashFn,m.onComplete)}}}!p&&h.length>0&&!n&&(d?i.listenProvider_.stopListening(Vl(e),null):h.forEach(_=>{const g=i.queryToTagMap.get(Nh(_));i.listenProvider_.stopListening(Vl(_),g)}))}BD(i,h)}return c}function PE(i,e,t,n){const r=R_(i,n);if(r!=null){const s=P_(r),a=s.path,c=s.queryId,u=$n(a,e),h=new Io(M_(c),u,t);return I_(i,a,h)}else return[]}function OD(i,e,t,n){const r=R_(i,n);if(r){const s=P_(r),a=s.path,c=s.queryId,u=$n(a,e),h=zt.fromObject(t),d=new Ga(M_(c),u,h);return I_(i,a,d)}else return[]}function Cp(i,e,t,n=!1){const r=e._path;let s=null,a=!1;i.syncPointTree_.foreachOnPath(r,(_,g)=>{const E=$n(_,r);s=s||Rs(g,E),a=a||zs(g)});let c=i.syncPointTree_.get(r);c?(a=a||zs(c),s=s||Rs(c,St())):(c=new wE,i.syncPointTree_=i.syncPointTree_.set(r,c));let u;s!=null?u=!0:(u=!1,s=Ye.EMPTY_NODE,i.syncPointTree_.subtree(r).foreachChild((g,E)=>{const x=Rs(E,St());x&&(s=s.updateImmediateChild(g,x))}));const h=RE(c,e);if(!h&&!e._queryParams.loadsAllData()){const _=Nh(e);Me(!i.queryToTagMap.has(_),"View does not exist, but we have a tag");const g=kD();i.queryToTagMap.set(_,g),i.tagToQueryMap.set(g,_)}const d=Ih(i.pendingWriteTree_,r);let p=bD(c,e,t,d,s,u);if(!h&&!a&&!n){const _=CE(c,e);p=p.concat(zD(i,e,_))}return p}function Dh(i,e,t){const r=i.pendingWriteTree_,s=i.syncPointTree_.findOnPath(e,(a,c)=>{const u=$n(a,e),h=Rs(c,u);if(h)return h});return xE(r,e,s,t,!0)}function UD(i,e){const t=e._path;let n=null;i.syncPointTree_.foreachOnPath(t,(h,d)=>{const p=$n(h,t);n=n||Rs(d,p)});let r=i.syncPointTree_.get(t);r?n=n||Rs(r,St()):(r=new wE,i.syncPointTree_=i.syncPointTree_.set(t,r));const s=n!=null,a=s?new ks(n,!0,!1):null,c=Ih(i.pendingWriteTree_,e._path),u=bE(r,e,c,s?a.getNode():Ye.EMPTY_NODE,s);return xD(u)}function sl(i,e){return IE(e,i.syncPointTree_,null,Ih(i.pendingWriteTree_,St()))}function IE(i,e,t,n){if(ht(i.path))return LE(i,e,t,n);{const r=e.get(St());t==null&&r!=null&&(t=Rs(r,St()));let s=[];const a=ut(i.path),c=i.operationForChild(a),u=e.children.get(a);if(u&&c){const h=t?t.getImmediateChild(a):null,d=yE(n,a);s=s.concat(IE(c,u,h,d))}return r&&(s=s.concat(A_(r,i,n,t))),s}}function LE(i,e,t,n){const r=e.get(St());t==null&&r!=null&&(t=Rs(r,St()));let s=[];return e.children.inorderTraversal((a,c)=>{const u=t?t.getImmediateChild(a):null,h=yE(n,a),d=i.operationForChild(a);d&&(s=s.concat(LE(d,c,u,h)))}),r&&(s=s.concat(A_(r,i,n,t))),s}function DE(i,e){const t=e.query,n=rc(i,t);return{hashFn:()=>(vD(e)||Ye.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return n?ND(i,t._path,n):DD(i,t._path);{const s=II(r,t);return uh(i,t,null,s)}}}}function rc(i,e){const t=Nh(e);return i.queryToTagMap.get(t)}function Nh(i){return i._path.toString()+"$"+i._queryIdentifier}function R_(i,e){return i.tagToQueryMap.get(e)}function P_(i){const e=i.indexOf("$");return Me(e!==-1&&e<i.length-1,"Bad queryKey."),{queryId:i.substr(e+1),path:new At(i.substr(0,e))}}function I_(i,e,t){const n=i.syncPointTree_.get(e);Me(n,"Missing sync point for query tag that we're tracking");const r=Ih(i.pendingWriteTree_,e);return A_(n,t,r,null)}function FD(i){return i.fold((e,t,n)=>{if(t&&zs(t))return[Lh(t)];{let r=[];return t&&(r=AE(t)),wn(n,(s,a)=>{r=r.concat(a)}),r}})}function Vl(i){return i._queryParams.loadsAllData()&&!i._queryParams.isDefault()?new(RD())(i._repo,i._path):i}function BD(i,e){for(let t=0;t<e.length;++t){const n=e[t];if(!n._queryParams.loadsAllData()){const r=Nh(n),s=i.queryToTagMap.get(r);i.queryToTagMap.delete(r),i.tagToQueryMap.delete(s)}}}function kD(){return PD++}function zD(i,e,t){const n=e._path,r=rc(i,e),s=DE(i,t),a=i.listenProvider_.startListening(Vl(e),r,s.hashFn,s.onComplete),c=i.syncPointTree_.subtree(n);if(r)Me(!zs(c.value),"If we're adding a query, it shouldn't be shadowed");else{const u=c.fold((h,d,p)=>{if(!ht(h)&&d&&zs(d))return[Lh(d).query];{let _=[];return d&&(_=_.concat(AE(d).map(g=>g.query))),wn(p,(g,E)=>{_=_.concat(E)}),_}});for(let h=0;h<u.length;++h){const d=u[h];i.listenProvider_.stopListening(Vl(d),rc(i,d))}}return a}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U_{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function Oh(i,e){let t=e instanceof At?e:new At(e),n=i,r=ut(t);for(;r!==null;){const s=Ro(n.node.children,r)||{children:{},childCount:0};n=new U_(r,n,s),t=Ft(t),r=ut(t)}return n}function Go(i){return i.node.value}function F_(i,e){i.node.value=e,Rp(i)}function OE(i){return i.node.childCount>0}function VD(i){return Go(i)===void 0&&!OE(i)}function Uh(i,e){wn(i.node.children,(t,n)=>{e(new U_(t,i,n))})}function UE(i,e,t,n){t&&!n&&e(i),Uh(i,r=>{UE(r,e,!0,n)}),t&&n&&e(i)}function XD(i,e,t){let n=t?i:i.parent;for(;n!==null;){if(e(n))return!0;n=n.parent}return!1}function yc(i){return new At(i.parent===null?i.name:yc(i.parent)+"/"+i.name)}function Rp(i){i.parent!==null&&qD(i.parent,i.name,i)}function qD(i,e,t){const n=VD(t),r=wi(i.node.children,e);n&&r?(delete i.node.children[e],i.node.childCount--,Rp(i)):!n&&!r&&(i.node.children[e]=t.node,i.node.childCount++,Rp(i))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QD{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Bh(i,e){let t=null;for(let n=0;n<e.length;n++){const r=e[n],s=r.getPath();t!==null&&!__(s,t.path)&&(i.eventLists_.push(t),t=null),t===null&&(t={events:[],path:s}),t.events.push(r)}t&&i.eventLists_.push(t)}function zE(i,e,t){Bh(i,t),GE(i,n=>__(n,e))}function bi(i,e,t){Bh(i,t),GE(i,n=>Xi(n,e)||Xi(e,n))}function GE(i,e){i.recursionDepth_++;let t=!0;for(let n=0;n<i.eventLists_.length;n++){const r=i.eventLists_[n];if(r){const s=r.path;e(s)?(JD(i.eventLists_[n]),i.eventLists_[n]=null):t=!1}}t&&(i.eventLists_=[]),i.recursionDepth_--}function JD(i){for(let e=0;e<i.events.length;e++){const t=i.events[e];if(t!==null){i.events[e]=null;const n=t.getEventRunner();So&&Mn("event: "+t.toString()),il(n)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HE="repo_interrupt",eN=25;class tN{constructor(e,t,n,r){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new QD,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=nh(),this.transactionQueueTree_=new U_,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function nN(i,e,t){if(i.stats_=f_(i.repoInfo_),i.forceRestClient_||OI())i.server_=new th(i.repoInfo_,(n,r,s,a)=>{M0(i,n,r,s,a)},i.authTokenProvider_,i.appCheckProvider_),setTimeout(()=>T0(i,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{dn(t)}catch(n){throw new Error("Invalid authOverride provided: "+n)}}i.persistentConnection_=new ns(i.repoInfo_,e,(n,r,s,a)=>{M0(i,n,r,s,a)},n=>{T0(i,n)},n=>{iN(i,n)},i.authTokenProvider_,i.appCheckProvider_,t),i.server_=i.persistentConnection_}i.authTokenProvider_.addTokenChangeListener(n=>{i.server_.refreshAuthToken(n)}),i.appCheckProvider_.addTokenChangeListener(n=>{i.server_.refreshAppCheckToken(n.token)}),i.statsReporter_=zI(i.repoInfo_,()=>new GL(i.stats_,i.server_)),i.infoData_=new UL,i.infoSyncTree_=new E0({startListening:(n,r,s,a)=>{let c=[];const u=i.infoData_.getNode(n._path);return u.isEmpty()||(c=xc(i.infoSyncTree_,n._path,u),setTimeout(()=>{a("ok")},0)),c},stopListening:()=>{}}),k_(i,"connected",!1),i.serverSyncTree_=new E0({startListening:(n,r,s,a)=>(i.server_.listen(n,s,r,(c,u)=>{const h=a(c,u);bi(i.eventQueue_,n._path,h)}),[]),stopListening:(n,r)=>{i.server_.unlisten(n,r)}})}function WE(i){const t=i.infoData_.getNode(new At(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Mc(i){return GD({timestamp:WE(i)})}function M0(i,e,t,n,r){i.dataUpdateCount++;const s=new At(e);t=i.interceptServerDataCallback_?i.interceptServerDataCallback_(e,t):t;let a=[];if(r)if(n){const u=ju(t,h=>Zt(h));a=OD(i.serverSyncTree_,s,u,r)}else{const u=Zt(t);a=PE(i.serverSyncTree_,s,u,r)}else if(n){const u=ju(t,h=>Zt(h));a=LD(i.serverSyncTree_,s,u)}else{const u=Zt(t);a=xc(i.serverSyncTree_,s,u)}let c=s;a.length>0&&(c=Wa(i,s)),bi(i.eventQueue_,c,a)}function T0(i,e){k_(i,"connected",e),e===!1&&oN(i)}function iN(i,e){wn(e,(t,n)=>{k_(i,t,n)})}function k_(i,e,t){const n=new At("/.info/"+e),r=Zt(t);i.infoData_.updateSnapshot(n,r);const s=xc(i.infoSyncTree_,n,r);bi(i.eventQueue_,n,s)}function kh(i){return i.nextWriteId_++}function rN(i,e,t){const n=UD(i.serverSyncTree_,e);return n!=null?Promise.resolve(n):i.server_.get(e).then(r=>{const s=Zt(r).withIndex(e._queryParams.getIndex());Cp(i.serverSyncTree_,e,t,!0);let a;if(e._queryParams.loadsAllData())a=xc(i.serverSyncTree_,e._path,s);else{const c=rc(i.serverSyncTree_,e);a=PE(i.serverSyncTree_,e._path,s,c)}return bi(i.eventQueue_,e._path,a),uh(i.serverSyncTree_,e,t,null,!0),s},r=>(ol(i,"get for query "+dn(e)+" failed: "+r),Promise.reject(new Error(r))))}function z_(i,e,t,n,r){ol(i,"set",{path:e.toString(),value:t,priority:n});const s=Mc(i),a=Zt(t,n),c=Dh(i.serverSyncTree_,e),u=N_(a,c,s),h=kh(i),d=C_(i.serverSyncTree_,e,u,h,!0);Bh(i.eventQueue_,d),i.server_.put(e.toString(),a.val(!0),(_,g)=>{const E=_==="ok";E||Bn("set at "+e+" failed: "+_);const x=Ss(i.serverSyncTree_,h,!E);bi(i.eventQueue_,e,x),Gs(i,r,_,g)});const p=H_(i,e);Wa(i,p),bi(i.eventQueue_,p,[])}function sN(i,e,t,n){ol(i,"update",{path:e.toString(),value:t});let r=!0;const s=Mc(i),a={};if(wn(t,(c,u)=>{r=!1,a[c]=NE(qt(e,c),Zt(u),i.serverSyncTree_,s)}),r)Mn("update() called with empty data.  Don't do anything."),Gs(i,n,"ok",void 0);else{const c=kh(i),u=ID(i.serverSyncTree_,e,a,c);Bh(i.eventQueue_,u),i.server_.merge(e.toString(),t,(h,d)=>{const p=h==="ok";p||Bn("update at "+e+" failed: "+h);const _=Ss(i.serverSyncTree_,c,!p),g=_.length>0?Wa(i,e):e;bi(i.eventQueue_,g,_),Gs(i,n,h,d)}),wn(t,h=>{const d=H_(i,qt(e,h));Wa(i,d)}),bi(i.eventQueue_,e,[])}}function oN(i){ol(i,"onDisconnectEvents");const e=Mc(i),t=nh();Sp(i.onDisconnect_,St(),(r,s)=>{const a=NE(r,s,i.serverSyncTree_,e);rl(t,r,a)});let n=[];Sp(t,St(),(r,s)=>{n=n.concat(xc(i.serverSyncTree_,r,s));const a=H_(i,r);Wa(i,a)}),i.onDisconnect_=nh(),bi(i.eventQueue_,St(),n)}function aN(i,e,t){i.server_.onDisconnectCancel(e.toString(),(n,r)=>{n==="ok"&&Ep(i.onDisconnect_,e),Gs(i,t,n,r)})}function w0(i,e,t,n){const r=Zt(t);i.server_.onDisconnectPut(e.toString(),r.val(!0),(s,a)=>{s==="ok"&&rl(i.onDisconnect_,e,r),Gs(i,n,s,a)})}function lN(i,e,t,n,r){const s=Zt(t,n);i.server_.onDisconnectPut(e.toString(),s.val(!0),(a,c)=>{a==="ok"&&rl(i.onDisconnect_,e,s),Gs(i,r,a,c)})}function cN(i,e,t,n){if(up(t)){Mn("onDisconnect().update() called with empty data.  Don't do anything."),Gs(i,n,"ok",void 0);return}i.server_.onDisconnectMerge(e.toString(),t,(r,s)=>{r==="ok"&&wn(t,(a,c)=>{const u=Zt(c);rl(i.onDisconnect_,qt(e,a),u)}),Gs(i,n,r,s)})}function uN(i,e,t){let n;ut(e._path)===".info"?n=Cp(i.infoSyncTree_,e,t):n=Cp(i.serverSyncTree_,e,t),zE(i.eventQueue_,e._path,n)}function Pp(i,e,t){let n;ut(e._path)===".info"?n=uh(i.infoSyncTree_,e,t):n=uh(i.serverSyncTree_,e,t),zE(i.eventQueue_,e._path,n)}function VE(i){i.persistentConnection_&&i.persistentConnection_.interrupt(HE)}function hN(i){i.persistentConnection_&&i.persistentConnection_.resume(HE)}function ol(i,...e){let t="";i.persistentConnection_&&(t=i.persistentConnection_.id+":"),Mn(t,...e)}function Gs(i,e,t,n){e&&il(()=>{if(t==="ok")e(null);else{const r=(t||"error").toUpperCase();let s=r;n&&(s+=": "+n);const a=new Error(s);a.code=r,e(a)}})}function fN(i,e,t,n,r,s){ol(i,"transaction on "+e);const a={path:e,update:t,onComplete:n,status:null,order:ky(),applyLocally:s,retryCount:0,unwatcher:r,abortReason:null,currentWriteId:null,currentInputSnapshot:null,currentOutputSnapshotRaw:null,currentOutputSnapshotResolved:null},c=G_(i,e,void 0);a.currentInputSnapshot=c;const u=a.update(c.val());if(u===void 0)a.unwatcher(),a.currentOutputSnapshotRaw=null,a.currentOutputSnapshotResolved=null,a.onComplete&&a.onComplete(null,!1,a.currentInputSnapshot);else{Ec("transaction failed: Data returned ",u,a.path),a.status=0;const h=Oh(i.transactionQueueTree_,e),d=Go(h)||[];d.push(a),F_(h,d);let p;typeof u=="object"&&u!==null&&wi(u,".priority")?(p=Ro(u,".priority"),Me(sc(p),"Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")):p=(Dh(i.serverSyncTree_,e)||Ye.EMPTY_NODE).getPriority().val();const _=Mc(i),g=Zt(u,p),E=N_(g,c,_);a.currentOutputSnapshotRaw=g,a.currentOutputSnapshotResolved=E,a.currentWriteId=kh(i);const x=C_(i.serverSyncTree_,e,E,a.currentWriteId,a.applyLocally);bi(i.eventQueue_,e,x),zh(i,i.transactionQueueTree_)}}function G_(i,e,t){return Dh(i.serverSyncTree_,e,t)||Ye.EMPTY_NODE}function zh(i,e=i.transactionQueueTree_){if(e||Gh(i,e),Go(e)){const t=qE(i,e);Me(t.length>0,"Sending zero length transaction queue"),t.every(r=>r.status===0)&&dN(i,yc(e),t)}else OE(e)&&Uh(e,t=>{zh(i,t)})}function dN(i,e,t){const n=t.map(h=>h.currentWriteId),r=G_(i,e,n);let s=r;const a=r.hash();for(let h=0;h<t.length;h++){const d=t[h];Me(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const p=$n(e,d.path);s=s.updateChild(p,d.currentOutputSnapshotRaw)}const c=s.val(!0),u=e;i.server_.put(u.toString(),c,h=>{ol(i,"transaction put response",{path:u.toString(),status:h});let d=[];if(h==="ok"){const p=[];for(let _=0;_<t.length;_++)t[_].status=2,d=d.concat(Ss(i.serverSyncTree_,t[_].currentWriteId)),t[_].onComplete&&p.push(()=>t[_].onComplete(null,!0,t[_].currentOutputSnapshotResolved)),t[_].unwatcher();Gh(i,Oh(i.transactionQueueTree_,e)),zh(i,i.transactionQueueTree_),bi(i.eventQueue_,e,d);for(let _=0;_<p.length;_++)il(p[_])}else{if(h==="datastale")for(let p=0;p<t.length;p++)t[p].status===3?t[p].status=4:t[p].status=0;else{Bn("transaction at "+u.toString()+" failed: "+h);for(let p=0;p<t.length;p++)t[p].status=4,t[p].abortReason=h}Wa(i,e)}},a)}function Wa(i,e){const t=XE(i,e),n=yc(t),r=qE(i,t);return pN(i,r,n),n}function pN(i,e,t){if(e.length===0)return;const n=[];let r=[];const a=e.filter(c=>c.status===0).map(c=>c.currentWriteId);for(let c=0;c<e.length;c++){const u=e[c],h=$n(t,u.path);let d=!1,p;if(Me(h!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),u.status===4)d=!0,p=u.abortReason,r=r.concat(Ss(i.serverSyncTree_,u.currentWriteId,!0));else if(u.status===0)if(u.retryCount>=eN)d=!0,p="maxretry",r=r.concat(Ss(i.serverSyncTree_,u.currentWriteId,!0));else{const _=G_(i,u.path,a);u.currentInputSnapshot=_;const g=e[c].update(_.val());if(g!==void 0){Ec("transaction failed: Data returned ",g,u.path);let E=Zt(g);typeof g=="object"&&g!=null&&wi(g,".priority")||(E=E.updatePriority(_.getPriority()));const y=u.currentWriteId,m=Mc(i),b=N_(E,_,m);u.currentOutputSnapshotRaw=E,u.currentOutputSnapshotResolved=b,u.currentWriteId=kh(i),a.splice(a.indexOf(y),1),r=r.concat(C_(i.serverSyncTree_,u.path,b,u.currentWriteId,u.applyLocally)),r=r.concat(Ss(i.serverSyncTree_,y,!0))}else d=!0,p="nodata",r=r.concat(Ss(i.serverSyncTree_,u.currentWriteId,!0))}bi(i.eventQueue_,t,r),r=[],d&&(e[c].status=2,function(_){setTimeout(_,Math.floor(0))}(e[c].unwatcher),e[c].onComplete&&(p==="nodata"?n.push(()=>e[c].onComplete(null,!1,e[c].currentInputSnapshot)):n.push(()=>e[c].onComplete(new Error(p),!1,null))))}Gh(i,i.transactionQueueTree_);for(let c=0;c<n.length;c++)il(n[c]);zh(i,i.transactionQueueTree_)}function XE(i,e){let t,n=i.transactionQueueTree_;for(t=ut(e);t!==null&&Go(n)===void 0;)n=Oh(n,t),e=Ft(e),t=ut(e);return n}function qE(i,e){const t=[];return YE(i,e,t),t.sort((n,r)=>n.order-r.order),t}function YE(i,e,t){const n=Go(e);if(n)for(let r=0;r<n.length;r++)t.push(n[r]);Uh(e,r=>{YE(i,r,t)})}function Gh(i,e){const t=Go(e);if(t){let n=0;for(let r=0;r<t.length;r++)t[r].status!==2&&(t[n]=t[r],n++);t.length=n,F_(e,t.length>0?t:void 0)}Uh(e,n=>{Gh(i,n)})}function H_(i,e){const t=yc(XE(i,e)),n=Oh(i.transactionQueueTree_,e);return XD(n,r=>{Ed(i,r)}),Ed(i,n),UE(n,r=>{Ed(i,r)}),t}function Ed(i,e){const t=Go(e);if(t){const n=[];let r=[],s=-1;for(let a=0;a<t.length;a++)t[a].status===3||(t[a].status===1?(Me(s===a-1,"All SENT items should be at beginning of queue."),s=a,t[a].status=3,t[a].abortReason="set"):(Me(t[a].status===0,"Unexpected transaction status in abort"),t[a].unwatcher(),r=r.concat(Ss(i.serverSyncTree_,t[a].currentWriteId,!0)),t[a].onComplete&&n.push(t[a].onComplete.bind(null,new Error("set"),!1,null))));s===-1?F_(e,void 0):t.length=s+1,bi(i.eventQueue_,yc(e),r);for(let a=0;a<n.length;a++)il(n[a])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b0="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",vN=function(){let i=0;const e=[];return function(t){const n=t===i;i=t;let r;const s=new Array(8);for(r=7;r>=0;r--)s[r]=b0.charAt(t%64),t=Math.floor(t/64);Me(t===0,"Cannot push at time == 0");let a=s.join("");if(n){for(r=11;r>=0&&e[r]===63;r--)e[r]=0;e[r]++}else for(r=0;r<12;r++)e[r]=Math.floor(Math.random()*64);for(r=0;r<12;r++)a+=b0.charAt(e[r]);return Me(a.length===20,"nextPushId: Length should be 20."),a}}();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xN=class{constructor(e,t){this._repo=e,this._path=t}cancel(){const e=new ei;return aN(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){qi("OnDisconnect.remove",this._path);const e=new ei;return w0(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){qi("OnDisconnect.set",this._path),Cr("OnDisconnect.set",e,this._path,!1);const t=new ei;return w0(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}setWithPriority(e,t){qi("OnDisconnect.setWithPriority",this._path),Cr("OnDisconnect.setWithPriority",e,this._path,!1),B_("OnDisconnect.setWithPriority",t,!1);const n=new ei;return lN(this._repo,this._path,e,t,n.wrapCallback(()=>{})),n.promise}update(e){qi("OnDisconnect.update",this._path),BE("OnDisconnect.update",e,this._path,!1);const t=new ei;return cN(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`)}function BB(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let c=1;s.type===i.FLOAT_MAT2&&(c=2),s.type===i.FLOAT_MAT3&&(c=3),s.type===i.FLOAT_MAT4&&(c=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:c}}return t}function Bl(i){return i!==""}function Hx(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Wx(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const kB=/^[ \t]*#include +<([\w\d./]+)>/gm;function Hp(i){return i.replace(kB,zB)}function zB(i,e){const t=ct[e];if(t===void 0)throw new Error("Can not resolve #include <"+e+">");return Hp(t)}const GB=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Vx(i){return i.replace(GB,HB)}function HB(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Xx(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function WB(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===nS?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===b2?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Yr&&(e="SHADOWMAP_TYPE_VSM"),e}function VB(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Va:case Xa:e="ENVMAP_TYPE_CUBE";break;case qh:e="ENVMAP_TYPE_CUBE_UV";break}return e}function XB(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Xa:e="ENVMAP_MODE_REFRACTION";break}return e}function qB(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case q_:e="ENVMAP_BLENDING_MULTIPLY";break;case q2:e="ENVMAP_BLENDING_MIX";break;case Y2:e="ENVMAP_BLENDING_ADD";break}return e}function YB(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function $B(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,c=t.fragmentShader;const u=WB(t),h=VB(t),d=XB(t),p=qB(t),_=YB(t),g=t.isWebGL2?"":UB(t),E=FB(s),x=r.createProgram();let y,m,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Bl).join(`
`)),a=Hp(a),a=Hx(a,t),a=Wx(a,t),c=Hp(c),c=Hx(c,t),c=Wx(c,t),a=Vx(a),c=Vx(c),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(b=`#version 300 es
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var sy,Ts,Ua,fm,Eo,oy,dm,yz=function(){return typeof window<"u"},os={},mo=180/Math.PI,Fa=Math.PI/180,wa=Math.atan2,ay=1e8,pm=/([A-Z])/g,Ez=/(left|right|width|margin|padding|x)/i,Sz=/[\s,\(]\S/,Sr={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},e_=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Mz=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Tz=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},wz=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},xM=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},yM=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},bz=function(e,t,n){return e.style[t]=n},Az=function(e,t,n){return e.style.setProperty(t,n)},Cz=function(e,t,n){return e._gsap[t]=n},Rz=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},Pz=function(e,t,n,r,s){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},Iz=function(e,t,n,r,s){var a=e._gsap;a[t]=n,a.renderTransform(s,a)},Qt="transform",dr=Qt+"Origin",Lz=function i(e,t){var n=this,r=this.target,s=r.style;if(e in os){if(this.tfm=this.tfm||{},e!=="transform")e=Sr[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return n.tfm[a]=Kr(r,a)}):this.tfm[e]=r._gsap.x?r._gsap[e]:Kr(r,e);else return Sr.transform.split(",").forEach(function(a){return i.call(n,a,t)});if(this.props.indexOf(Qt)>=0)return;r._gsap.svg&&(this.svgo=r.getAttribute("data-svg-origin"),this.props.push(dr,t,"")),e=Qt}(s||t)&&this.props.push(e,t,s[e])},EM=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},Dz=function(){var e=this.props,t=this.target,n=t.style,r=t._gsap,s,a;for(s=0;s<e.length;s+=3)e[s+1]?t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(pm,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)r[a]=this.tfm[a];r.svg&&(r.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=dm(),(!s||!s.isStart)&&!n[Qt]&&(EM(n),r.uncache=1)}},SM=function(e,t){var n={target:e,props:[],revert:Dz,save:Lz};return e._gsap||li.core.getCache(e),t&&t.split(",").forEach(function(r){return n.save(r)}),n},MM,t_=function(e,t){var n=Ts.createElementNS?Ts.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):Ts.createElement(e);return n.style?n:Ts.createElement(e)},br=function i(e,t,n){var r=getComputedStyle(e);return r[t]||r.getPropertyValue(t.replace(pm,"-$1").toLowerCase())||r.getPropertyValue(t)||!n&&i(e,el(t)||t,1)||""},ly="O,Moz,ms,Ms,Webkit".split(","),el=function(e,t,n){var r=t||Eo,s=r.style,a=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(ly[a]+e in s););return a<0?null:(a===3?"ms":a>=0?ly[a]:"")+e},n_=function(){yz()&&window.document&&(sy=window,Ts=sy.document,Ua=Ts.documentElement,Eo=t_("div")||{style:{}},t_("div"),Qt=el(Qt),dr=Qt+"Origin",Eo.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",MM=!!el("perspective"),dm=li.core.reverting,fm=1)},op=function i(e){var t=t_("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,r=this.nextSibling,s=this.style.cssText,a;if(Ua.appendChild(t),t.appendChild(this),this.style.display="block",e)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=i}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(r?n.insertBefore(this,r):n.appendChild(this)),Ua.removeChild(t),this.style.cssText=s,a},cy=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},TM=function(e){var t;try{t=e.getBBox()}catch{t=op.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===op||(t=op.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+cy(e,["x","cx","x1"])||0,y:+cy(e,["y","cy","y1"])||0,width:0,height:0}:t},wM=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&TM(e))},dc=function(e,t){if(t){var n=e.style;t in os&&t!==dr&&(t=Qt),n.removeProperty?((t.substr(0,2)==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(t.replace(pm,"-$1").toLowerCase())):n.removeAttribute(t)}},ws=function(e,t,n,r,s,a){var c=new ai(e._pt,t,n,0,1,a?yM:xM);return e._pt=c,c.b=r,c.e=s,e._props.push(n),c},uy={deg:1,rad:1,turn:1},Nz={grid:1,flex:1},Vs=function i(e,t,n,r){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",c=Eo.style,u=Ez.test(t),h=e.tagName.toLowerCase()==="svg",d=(h?"client":"offset")+(u?"Width":"Height"),p=100,_=r==="px",g=r==="%",E,x,y,m;return r===a||!s||uy[r]||uy[a]?s:(a!=="px"&&!_&&(s=i(e,t,n,"px")),m=e.getCTM&&wM(e),(g||a==="%")&&(os[t]||~t.indexOf("adius"))?(E=m?e.getBBox()[u?"width":"height"]:e[d],on(g?s/E*p:s/100*E)):(c[u?"width":"height"]=p+(_?a:r),x=~t.indexOf("adius")||r==="em"&&e.appendChild&&!h?e:e.parentNode,m&&(x=(e.ownerSVGElement||{}).parentNode),(!x||x===Ts||!x.appendChild)&&(x=Ts.body),y=x._gsap,y&&g&&y.width&&u&&y.time===Si.time&&!y.uncache?on(s/y.width*p):((g||a==="%")&&!Nz[br(x,"display")]&&(c.position=br(e,"position")),x===e&&(c.position="static"),x.appendChild(Eo),E=Eo[d],x.removeChild(Eo),c.position="absolute",u&&g&&(y=bo(x),y.time=Si.time,y.width=x[d]),on(_?E*s/p:E&&s?p/E*s:0))))},Kr=function(e,t,n,r){var s;return fm||n_(),t in Sr&&t!=="transform"&&(t=Sr[t],~t.indexOf(",")&&(t=t.split(",")[0])),os[t]&&t!=="transform"?(s=_c(e,r),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:xh(br(e,dr))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||r||~(s+"").indexOf("calc("))&&(s=vh[t]&&vh[t](e,t,n)||br(e,t)||GS(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?Vs(e,t,s,n)+n:s},Oz=function(e,t,n,r){if(!n||n==="none"){var s=el(t,e,1),a=s&&br(e,s,1);a&&a!==n?(t=s,n=a):t==="borderColor"&&(n=br(e,"borderTopColor"))}var c=new ai(this._pt,e.style,t,0,1,mM),u=0,h=0,d,p,_,g,E,x,y,m,b,T,C,w;if(c.b=n,c.e=r,n+="",r+="",r==="auto"&&(e.style[t]=r,r=br(e,t)||r,e.style[t]=n),d=[n,r],oM(d),n=d[0],r=d[1],_=n.match(Ca)||[],w=r.match(Ca)||[],w.length){for(;p=Ca.exec(r);)y=p[0],b=r.substring(u,p.index),E?E=(E+1)%5:(b.substr(-5)==="rgba("||b.substr(-5)==="hsla(")&&(E=1),y!==(x=_[h++]||"")&&(g=parseFloat(x)||0,C=x.substr((g+"").length),y.charAt(1)==="="&&(y=Oa(g,y)+C),m=parseFloat(y),T=y.substr((m+"").length),u=Ca.lastIndex-T.length,T||(T=T||Ti.units[t]||C,u===r.length&&(r+=T,c.e+=T)),C!==T&&(g=Vs(e,t,x,T)||0),c._pt={_next:c._pt,p:b||h===1?b:",",s:g,c:m-g,m:E&&E<4||t==="zIndex"?Math.round:0});c.c=u<r.length?r.substring(u,r.length):""}else c.r=t==="display"&&r==="none"?yM:xM;return OS.test(r)&&(c.e=0),this._pt=c,c},hy={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Uz=function(e){var t=e.split(" "),n=t[0],r=t[1]||"50%";return(n==="top"||n==="bottom"||r==="left"||r==="right")&&(e=n,n=r,r=e),t[0]=hy[n]||n,t[1]=hy[r]||r,t.join(" ")},Fz=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,r=n.style,s=t.u,a=n._gsap,c,u,h;if(s==="all"||s===!0)r.cssText="",u=1;else for(s=s.split(","),h=s.length;--h>-1;)c=s[h],os[c]&&(u=1,c=c==="transformOrigin"?dr:Qt),dc(n,c);u&&(dc(n,Qt),a&&(a.svg&&n.removeAttribute("transform"),_c(n,1),a.uncache=1,EM(r)))}},vh={clearProps:function(e,t,n,r,s){if(s.data!=="isFromStart"){var a=e._pt=new ai(e._pt,t,n,0,0,Fz);return a.u=r,a.pr=-10,a.tween=s,e._props.push(n),1}}},pc=[1,0,0,1,0,0],bM={},AM=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},fy=function(e){var t=br(e,Qt);return AM(t)?pc:t.substr(7).match(NS).map(on)},_m=function(e,t){var n=e._gsap||bo(e),r=e.style,s=fy(e),a,c,u,h;return n.svg&&e.getAttribute("transform")?(u=e.transform.baseVal.consolidate().matrix,s=[u.a,u.b,u.c,u.d,u.e,u.f],s.join(",")==="1,0,0,1,0,0"?pc:s):(s===pc&&!e.offsetParent&&e!==Ua&&!n.svg&&(u=r.display,r.display="block",a=e.parentNode,(!a||!e.offsetParent)&&(h=1,c=e.nextElementSibling,Ua.appendChild(e)),s=fy(e),u?r.display=u:dc(e,"display"),h&&(c?a.insertBefore(e,c):a?a.appendChild(e):Ua.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},i_=function(e,t,n,r,s,a){var c=e._gsap,u=s||_m(e,!0),h=c.xOrigin||0,d=c.yOrigin||0,p=c.xOffset||0,_=c.yOffset||0,g=u[0],E=u[1],x=u[2],y=u[3],m=u[4],b=u[5],T=t.split(" "),C=parseFloat(T[0])||0,w=parseFloat(T[1])||0,I,O,B,M;n?u!==pc&&(O=g*y-E*x)&&(B=C*(y/O)+w*(-x/O)+(x*b-y*m)/O,M=C*(-E/O)+w*(g/O)-(g*b-E*m)/O,C=B,w=M):(I=TM(e),C=I.x+(~T[0].indexOf("%")?C/100*I.width:C),w=I.y+(~(T[1]||T[0]).indexOf("%")?w/100*I.height:w)),r||r!==!1&&c.smooth?(m=C-h,b=w-d,c.xOffset=p+(m*g+b*x)-m,c.yOffset=_+(m*E+b*y)-b):c.xOffset=c.yOffset=0,c.xOrigin=C,c.yOrigin=w,c.smooth=!!r,c.origin=t,c.originIsAbsolute=!!n,e.style[dr]="0px 0px",a&&(ws(a,c,"xOrigin",h,C),ws(a,c,"yOrigin",d,w),ws(a,c,"xOffset",p,c.xOffset),ws(a,c,"yOffset",_,c.yOffset)),e.setAttribute("data-svg-origin",C+" "+w)},_c=function(e,t){var n=e._gsap||new uM(e);if("x"in n&&!t&&!n.uncache)return n;var r=e.style,s=n.scaleX<0,a="px",c="deg",u=getComputedStyle(e),h=br(e,dr)||"0",d,p,_,g,E,x,y,m,b,T,C,w,I,O,B,M,L,Q,te,W,$,j,le,J,ne,ge,he,Ie,ye,ie,ce,G;return d=p=_=x=y=m=b=T=C=0,g=E=1,n.svg=!!(e.getCTM&&wM(e)),u.translate&&((u.translate!=="none"||u.scale!=="none"||u.rotate!=="none")&&(r[Qt]=(u.translate!=="none"?"translate3d("+(u.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(u.rotate!=="none"?"rotate("+u.rotate+") ":"")+(u.scale!=="none"?"scale("+u.scale.split(" ").join(",")+") ":"")+(u[Qt]!=="none"?u[Qt]:"")),r.scale=r.rotate=r.translate="none"),O=_m(e,n.svg),n.svg&&(n.uncache?(ne=e.getBBox(),h=n.xOrigin-ne.x+"px "+(n.yOrigin-ne.y)+"px",J=""):J=!t&&e.getAttribute("data-svg-origin"),i_(e,J||h,!!J||n.originIsAbsolute,n.smooth!==!1,O)),w=n.xOrigin||0,I=n.yOrigin||0,O!==pc&&(Q=O[0],te=O[1],W=O[2],$=O[3],d=j=O[4],p=le=O[5],O.length===6?(g=Math.sqrt(Q*Q+te*te),E=Math.sqrt($*$+W*W),x=Q||te?wa(te,Q)*mo:0,b=W||$?wa(W,$)*mo+x:0,b&&(E*=Math.abs(Math.cos(b*Fa))),n.svg&&(d-=w-(w*Q+I*W),p-=I-(w*te+I*$))):(G=O[6],ie=O[7],he=O[8],Ie=O[9],ye=O[10],ce=O[11],d=O[12],p=O[13],_=O[14],B=wa(G,ye),y=B*mo,B&&(M=Math.cos(-B),L=Math.sin(-B),J=j*M+he*L,ne=le*M+Ie*L,ge=G*M+ye*L,he=j*-L+he*M,Ie=le*-L+Ie*M,ye=G*-L+ye*M,ce=ie*-L+ce*M,j=J,le=ne,G=ge),B=wa(-W,ye),m=B*mo,B&&(M=Math.cos(-B),L=Math.sin(-B),J=Q*M-he*L,ne=te*M-Ie*L,ge=W*M-ye*L,ce=$*L+ce*M,Q=J,te=ne,W=ge),B=wa(te,Q),x=B*mo,B&&(M=Math.cos(B),L=Math.sin(B),J=Q*M+te*L,ne=j*M+le*L,te=te*M-Q*L,le=le*M-j*L,Q=J,j=ne),y&&Math.abs(y)+Math.abs(x)>359.9&&(y=x=0,m=180-m),g=on(Math.sqrt(Q*Q+te*te+W*W)),E=on(Math.sqrt(le*le+G*G)),B=wa(j,le),b=Math.abs(B)>2e-4?B*mo:0,C=ce?1/(ce<0?-ce:ce):0),n.svg&&(J=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!AM(br(e,Qt)),J&&e.setAttribute("transform",J))),Math.abs(b)>90&&Math.abs(b)<270&&(s?(g*=-1,b+=x<=0?180:-180,x+=x<=0?180:-180):(E*=-1,b+=b<=0?180:-180)),t=t||n.uncache,n.x=d-((n.xPercent=d&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-d)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=p-((n.yPercent=p&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-p)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=_+a,n.scaleX=on(g),n.scaleY=on(E),n.rotation=on(x)+c,n.rotationX=on(y)+c,n.rotationY=on(m)+c,n.skewX=b+c,n.skewY=T+c,n.transformPerspective=C+a,(n.zOrigin=parseFloat(h.split(" ")[2])||0)&&(r[dr]=xh(h)),n.xOffset=n.yOffset=0,n.force3D=Ti.force3D,n.renderTransform=n.svg?kz:MM?CM:Bz,n.uncache=0,n},xh=function(e){return(e=e.split(" "))[0]+" "+e[1]},ap=function(e,t,n){var r=Fn(t);return on(parseFloat(t)+parseFloat(Vs(e,"x",n+"px",r)))+r},Bz=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,CM(e,t)},co="0deg",Ul="0px",uo=") ",CM=function(e,t){var n=t||this,r=n.xPercent,s=n.yPercent,a=n.x,c=n.y,u=n.z,h=n.rotation,d=n.rotationY,p=n.rotationX,_=n.skewX,g=n.skewY,E=n.scaleX,x=n.scaleY,y=n.transformPerspective,m=n.force3D,b=n.target,T=n.zOrigin,C="",w=m==="auto"&&e&&e!==1||m===!0;if(T&&(p!==co||d!==co)){var I=parseFloat(d)*Fa,O=Math.sin(I),B=Math.cos(I),M;I=parseFloat(p)*Fa,M=Math.cos(I),a=ap(b,a,O*M*-T),c=ap(b,c,-Math.sin(I)*-T),u=ap(b,u,B*M*-T+T)}y!==Ul&&(C+="perspective("+y+uo),(r||s)&&(C+="translate("+r+"%, "+s+"%) "),(w||a!==Ul||c!==Ul||u!==Ul)&&(C+=u!==Ul||w?"translate3d("+a+", "+c+", "+u+") ":"translate("+a+", "+c+uo),h!==co&&(C+="rotate("+h+uo),d!==co&&(C+="rotateY("+d+uo),p!==co&&(C+="rotateX("+p+uo),(_!==co||g!==co)&&(C+="skew("+_+", "+g+uo),(E!==1||x!==1)&&(C+="scale("+E+", "+x+uo),b.style[Qt]=C||"translate(0, 0)"},kz=function(e,t){var n=t||this,r=n.xPercent,s=n.yPercent,a=n.x,c=n.y,u=n.rotation,h=n.skewX,d=n.skewY,p=n.scaleX,_=n.scaleY,g=n.target,E=n.xOrigin,x=n.yOrigin,y=n.xOffset,m=n.yOffset,b=n.forceCSS,T=parseFloat(a),C=parseFloat(c),w,I,O,B,M;u=parseFloat(u),h=parseFloat(h),d=parseFloat(d),d&&(d=parseFloat(d),h+=d,u+=d),u||h?(u*=Fa,h*=Fa,w=Math.cos(u)*p,I=Math.sin(u)*p,O=Math.sin(u-h)*-_,B=Math.cos(u-h)*_,h&&(d*=Fa,M=Math.tan(h-d),M=Math.sqrt(1+M*M),O*=M,B*=M,d&&(M=Math.tan(d),M=Math.sqrt(1+M*M),w*=M,I*=M)),w=on(w),I=on(I),O=on(O),B=on(B)):(w=p,B=_,I=O=0),(T&&!~(a+"").indexOf("px")||C&&!~(c+"").indexOf("px"))&&(T=Vs(g,"x",a,"px"),C=Vs(g,"y",c,"px")),(E||x||y||m)&&(T=on(T+E-(E*w+x*O)+y),C=on(C+x-(E*I+x*B)+m)),(r||s)&&(M=g.getBBox(),T=on(T+r/100*M.width),C=on(C+s/100*M.height)),M="matrix("+w+","+I+","+O+","+B+","+T+","+C+")",g.setAttribute("transform",M),b&&(g.style[Qt]=M)},zz=function(e,t,n,r,s){var a=360,c=bn(s),u=parseFloat(s)*(c&&~s.indexOf("rad")?mo:1),h=u-r,d=r+h+"deg",p,_;return c&&(p=s.split("_")[1],p==="short"&&(h%=a,h!==h%(a/2)&&(h+=h<0?a:-a)),p==="cw"&&h<0?h=(h+a*ay)%a-~~(h/a)*a:p==="ccw"&&h>0&&(h=(h-a*ay)%a-~~(h/a)*a)),e._pt=_=new ai(e._pt,t,n,r,h,Mz),_.e=d,_.u="deg",e._props.push(n),_},dy=function(e,t){for(var n in t)e[n]=t[n];return e},Gz=function(e,t,n){var r=dy({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,c,u,h,d,p,_,g,E;r.svg?(h=n.getAttribute("transform"),n.setAttribute("transform",""),a[Qt]=t,c=_c(n,1),dc(n,Qt),n.setAttribute("transform",h)):(h=getComputedStyle(n)[Qt],a[Qt]=t,c=_c(n,1),a[Qt]=h);for(u in os)h=r[u],d=c[u],h!==d&&s.indexOf(u)<0&&(g=Fn(h),E=Fn(d),p=g!==E?Vs(n,u,h,E):parseFloat(h),_=parseFloat(d),e._pt=new ai(e._pt,c,u,p,_-p,e_),e._pt.u=E||0,e._props.push(u));dy(c,r)};oi("padding,margin,Width,Radius",function(i,e){var t="Top",n="Right",r="Bottom",s="Left",a=(e<3?[t,n,r,s]:[t+s,t+n,r+n,r+s]).map(function(c){return e<2?i+c:"border"+c+i});vh[e>1?"border"+i:i]=function(c,u,h,d,p){var _,g;if(arguments.length<4)return _=a.map(function(E){return Kr(c,E,h)}),g=_.join(" "),g.split(_[0]).length===5?_[0]:g;_=(d+"").split(" "),g={},a.forEach(function(E,x){return g[E]=_[x]=_[x]||_[(x-1)/2|0]}),c.init(u,g,p)}});var RM={name:"css",register:n_,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,r,s){var a=this._props,c=e.style,u=n.vars.startAt,h,d,p,_,g,E,x,y,m,b,T,C,w,I,O,B;fm||n_(),this.styles=this.styles||SM(e),B=this.styles.props,this.tween=n;for(x in t)if(x!=="autoRound"&&(d=t[x],!(yi[x]&&hM(x,t,n,r,e,s)))){if(g=typeof d,E=vh[x],g==="function"&&(d=d.call(n,r,e,s),g=typeof d),g==="string"&&~d.indexOf("random(")&&(d=hc(d)),E)E(this,e,x,d,n)&&(O=1);else if(x.substr(0,2)==="--")h=(getComputedStyle(e).getPropertyValue(x)+"").trim(),d+="",Ds.lastIndex=0,Ds.test(h)||(y=Fn(h),m=Fn(d)),m?y!==m&&(h=Vs(e,x,h,m)+m):y&&(d+=y),this.add(c,"setProperty",h,d,r,s,0,0,x),a.push(x),B.push(x,0,c[x]);else if(g!=="undefined"){if(u&&x in u?(h=typeof u[x]=="function"?u[x].call(n,r,e,s):u[x],bn(h)&&~h.indexOf("random(")&&(h=hc(h)),Fn(h+"")||(h+=Ti.units[x]||Fn(Kr(e,x))||""),(h+"").charAt(1)==="="&&(h=Kr(e,x))):h=Kr(e,x),_=parseFloat(h),b=g==="string"&&d.charAt(1)==="="&&d.substr(0,2),b&&(d=d.substr(2)),p=parseFloat(d),x in Sr&&(x==="autoAlpha"&&(_===1&&Kr(e,"visibility")==="hidden"&&p&&(_=0),B.push("visibility",0,c.visibility),ws(this,c,"visibility",_?"inherit":"hidden",p?"inherit":"hidden",!p)),x!=="scale"&&x!=="transform"&&(x=Sr[x],~x.indexOf(",")&&(x=x.split(",")[0]))),T=x in os,T){if(this.styles.save(x),C||(w=e._gsap,w.renderTransform&&!t.parseTransform||_c(e,t.parseTransform),I=t.smoothOrigin!==!1&&w.smooth,C=this._pt=new ai(this._pt,c,Qt,0,1,w.renderTransform,w,0,-1),C.dep=1),x==="scale")this._pt=new ai(this._pt,w,"scaleY",w.scaleY,(b?Oa(w.scaleY,b+p):p)-w.scaleY||0,e_),this._pt.u=0,a.push("scaleY",x),x+="X";else if(x==="transformOrigin"){B.push(dr,0,c[dr]),d=Uz(d),w.svg?i_(e,d,0,I,0,this):(m=parseFloat(d.split(" ")[2])||0,m!==w.zOrigin&&ws(this,w,"zOrigin",w.zOrigin,m),ws(this,c,x,xh(h),xh(d)));continue}else if(x==="svgOrigin"){i_(e,d,1,I,0,this);continue}else if(x in bM){zz(this,w,x,_,b?Oa(_,b+d):d);continue}else if(x==="smoothOrigin"){ws(this,w,"smooth",w.smooth,d);continue}else if(x==="force3D"){w[x]=d;continue}else if(x==="transform"){Gz(this,d,e);continue}}else x in c||(x=el(x)||x);if(T||(p||p===0)&&(_||_===0)&&!Sz.test(d)&&x in c)y=(h+"").substr((_+"").length),p||(p=0),m=Fn(d)||(x in Ti.units?Ti.units[x]:y),y!==m&&(_=Vs(e,x,h,m)),this._pt=new ai(this._pt,T?w:c,x,_,(b?Oa(_,b+p):p)-_,!T&&(m==="px"||x==="zIndex")&&t.autoRound!==!1?wz:e_),this._pt.u=m||0,y!==m&&m!=="%"&&(this._pt.b=h,this._pt.r=Tz);else if(x in c)Oz.call(this,e,x,h,b?b+d:d);else if(x in e)this.add(e,x,h||e[x],b?b+d:d,r,s);else if(x!=="parseTransform"){im(x,d);continue}T||(x in c?B.push(x,0,c[x]):B.push(x,1,h||e[x])),a.push(x)}}O&&gM(this)},render:function(e,t){if(t.tween._time||!dm())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Kr,aliases:Sr,getSetter:function(e,t,n){var r=Sr[t];return r&&r.indexOf(",")<0&&(t=r),t in os&&t!==dr&&(e._gsap.x||Kr(e,"x"))?n&&oy===n?t==="scale"?Rz:Cz:(oy=n||{})&&(t==="scale"?Pz:Iz):e.style&&!em(e.style[t])?bz:~t.indexOf("-")?Az:um(e,t)},core:{_removeProperty:dc,_getMatrix:_m}};li.utils.checkPrefix=el;li.core.getStyleSaver=SM;(function(i,e,t,n){var r=oi(i+","+e+","+t,function(s){os[s]=1});oi(e,function(s){Ti.units[s]="deg",bM[s]=1}),Sr[r[13]]=i+","+e,oi(n,function(s){var a=s.split(":");Sr[a[1]]=r[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");oi("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(i){Ti.units[i]="px"});li.registerPlugin(RM);var PM=li.registerPlugin(RM)||li;PM.core.Tween;const py={type:"change"},lp={type:"start"},_y={type:"end"};class Hz extends Ho{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new Y,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:aa.ROTATE,MIDDLE:aa.DOLLY,RIGHT:aa.PAN},this.touches={ONE:la.ROTATE,TWO:la.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return c.phi},this.getAzimuthalAngle=function(){return c.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(k){k.addEventListener("keydown",Et),this._domElementKeyEvents=k},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",Et),this._domElementKeyEvents=null},this.saveState=function(){n.target0.copy(n.target),n.position0.copy(n.object.position),n.zoom0=n.object.zoom},this.reset=function(){n.target.copy(n.target0),n.object.position.copy(n.position0),n.object.zoom=n.zoom0,n.object.updateProjectionMatrix(),n.dispatchEvent(py),n.update(),s=r.NONE},this.update=function(){const k=new Y,fe=new Uo().setFromUnitVectors(e.up,new Y(0,1,0)),ee=fe.clone().invert(),we=new Y,De=new Uo,Fe=2*Math.PI;return function(){const Oe=n.object.position;k.copy(Oe).sub(n.target),k.applyQuaternion(fe),c.setFromVector3(k),n.autoRotate&&s===r.NONE&&M(O()),n.enableDamping?(c.theta+=u.theta*n.dampingFactor,c.phi+=u.phi*n.dampingFactor):(c.theta+=u.theta,c.phi+=u.phi);let Ke=n.minAzimuthAngle,Je=n.maxAzimuthAngle;return isFinite(Ke)&&isFinite(Je)&&(Ke<-Math.PI?Ke+=Fe:Ke>Math.PI&&(Ke-=Fe),Je<-Math.PI?Je+=Fe:Je>Math.PI&&(Je-=Fe),Ke<=Je?c.theta=Math.max(Ke,Math.min(Je,c.theta)):c.theta=c.theta>(Ke+Je)/2?Math.max(Ke,c.theta):Math.min(Je,c.theta)),c.phi=Math.max(n.minPolarAngle,Math.min(n.maxPolarAngle,c.phi)),c.makeSafe(),c.radius*=h,c.radius=Math.max(n.minDistance,Math.min(n.maxDistance,c.radius)),n.enableDamping===!0?n.target.addScaledVector(d,n.dampingFactor):n.target.add(d),k.setFromSpherical(c),k.applyQuaternion(ee),Oe.copy(n.target).add(k),n.object.lookAt(n.target),n.enableDamping===!0?(u.theta*=1-n.dampingFactor,u.phi*=1-n.dampingFactor,d.multiplyScalar(1-n.dampingFactor)):(u.set(0,0,0),d.set(0,0,0)),h=1,p||we.distanceToSquared(n.object.position)>a||8*(1-De.dot(n.object.quaternion))>a?(n.dispatchEvent(py),we.copy(n.object.position),De.copy(n.object.quaternion),p=!1,!0):!1}}(),this.dispose=function(){n.domElement.removeEventListener("contextmenu",P),n.domElement.removeEventListener("pointerdown",He),n.domElement.removeEventListener("pointercancel",Ht),n.domElement.removeEventListener("wheel",yt),n.domElement.removeEventListener("pointermove",It),n.domElement.removeEventListener("pointerup",Ht),n._domElementKeyEvents!==null&&(n._domElementKeyEvents.removeEventListener("keydown",Et),n._domElementKeyEvents=null)};const n=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const a=1e-6,c=new Zx,u=new Zx;let h=1;const d=new Y;let p=!1;const _=new nt,g=new nt,E=new nt,x=new nt,y=new nt,m=new nt,b=new nt,T=new nt,C=new nt,w=[],I={};function O(){return 2*Math.PI/60/60*n.autoRotateSpeed}function B(){return Math.pow(.95,n.zoomSpeed)}function M(k){u.theta-=k}function L(k){u.phi-=k}const Q=function(){const k=new Y;return function(ee,we){k.setFromMatrixColumn(we,0),k.multiplyScalar(-ee),d.add(k)}}(),te=function(){const k=new Y;return function(ee,we){n.screenSpacePanning===!0?k.setFromMatrixColumn(we,1):(k.setFromMatrixColumn(we,0),k.crossVectors(n.object.up,k)),k.multiplyScalar(ee),d.add(k)}}(),W=function(){const k=new Y;return function(ee,we){const De=n.domElement;if(n.object.isPerspectiveCamera){const Fe=n.object.position;k.copy(Fe).sub(n.target);let Re=k.length();Re*=Math.tan(n.object.fov/2*Math.PI/180),Q(2*ee*Re/De.clientHeight,n.object.matrix),te(2*we*Re/De.clientHeight,n.object.matrix)}else n.object.isOrthographicCamera?(Q(ee*(n.object.right-n.object.left)/n.object.zoom/De.clientWidth,n.object.matrix),te(we*(n.object.top-n.object.bottom)/n.object.zoom/De.clientHeight,n.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),n.enablePan=!1)}}();function $(k){n.object.isPerspectiveCamera?h/=k:n.object.isOrthographicCamera?(n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom*k)),n.object.updateProjectionMatrix(),p=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function j(k){n.object.isPerspectiveCamera?h*=k:n.object.isOrthographicCamera?(n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/k)),n.object.updateProjectionMatrix(),p=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function le(k){_.set(k.clientX,k.clientY)}function J(k){b.set(k.clientX,k.clientY)}function ne(k){x.set(k.clientX,k.clientY)}function ge(k){g.set(k.clientX,k.clientY),E.subVectors(g,_).multiplyScalar(n.rotateSpeed);const fe=n.domElement;M(2*Math.PI*E.x/fe.clientHeight),L(2*Math.PI*E.y/fe.clientHeight),_.copy(g),n.update()}function he(k){T.set(k.clientX,k.clientY),C.subVectors(T,b),C.y>0?$(B()):C.y<0&&j(B()),b.copy(T),n.update()}function Ie(k){y.set(k.clientX,k.clientY),m.subVectors(y,x).multiplyScalar(n.panSpeed),W(m.x,m.y),x.copy(y),n.update()}function ye(k){k.deltaY<0?j(B()):k.deltaY>0&&$(B()),n.update()}function ie(k){let fe=!1;switch(k.code){case n.keys.UP:k.ctrlKey||k.metaKey||k.shiftKey?L(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):W(0,n.keyPanSpeed),fe=!0;break;case n.keys.BOTTOM:k.ctrlKey||k.metaKey||k.shiftKey?L(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):W(0,-n.keyPanSpeed),fe=!0;break;case n.keys.LEFT:k.ctrlKey||k.metaKey||k.shiftKey?M(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):W(n.keyPanSpeed,0),fe=!0;break;case n.keys.RIGHT:k.ctrlKey||k.metaKey||k.shiftKey?M(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):W(-n.keyPanSpeed,0),fe=!0;break}fe&&(k.preventDefault(),n.update())}function ce(){if(w.length===1)_.set(w[0].pageX,w[0].pageY);else{const k=.5*(w[0].pageX+w[1].pageX),fe=.5*(w[0].pageY+w[1].pageY);_.set(k,fe)}}function G(){if(w.length===1)x.set(w[0].pageX,w[0].pageY);else{const k=.5*(w[0].pageX+w[1].pageX),fe=.5*(w[0].pageY+w[1].pageY);x.set(k,fe)}}function _e(){const k=w[0].pageX-w[1].pageX,fe=w[0].pageY-w[1].pageY,ee=Math.sqrt(k*k+fe*fe);b.set(0,ee)}function F(){n.enableZoom&&_e(),n.enablePan&&G()}function Pe(){n.enableZoom&&_e(),n.enableRotate&&ce()}function Ce(k){if(w.length==1)g.set(k.pageX,k.pageY);else{const ee=Te(k),we=.5*(k.pageX+ee.x),De=.5*(k.pageY+ee.y);g.set(we,De)}E.subVectors(g,_).multiplyScalar(n.rotateSpeed);const fe=n.domElement;M(2*Math.PI*E.x/fe.clientHeight),L(2*Math.PI*E.y/fe.clientHeight),_.copy(g)}function Ee(k){if(w.length===1)y.set(k.pageX,k.pageY);else{const fe=Te(k),ee=.5*(k.pageX+fe.x),we=.5*(k.pageY+fe.y);y.set(ee,we)}m.subVectors(y,x).multiplyScalar(n.panSpeed),W(m.x,m.y),x.copy(y)}function ze(k){const fe=Te(k),ee=k.pageX-fe.x,we=k.pageY-fe.y,De=Math.sqrt(ee*ee+we*we);T.set(0,De),C.set(0,Math.pow(T.y/b.y,n.zoomSpeed)),$(C.y),b.copy(T)}function st(k){n.enableZoom&&ze(k),n.enablePan&&Ee(k)}function Ue(k){n.enableZoom&&ze(k),n.enableRotate&&Ce(k)}function He(k){n.enabled!==!1&&(w.length===0&&(n.domElement.setPointerCapture(k.pointerId),n.domElement.addEventListener("pointermove",It),n.domElement.addEventListener("pointerup",Ht)),re(k),k.pointerType==="touch"?Lt(k):Tt(k))}function It(k){n.enabled!==!1&&(k.pointerType==="touch"?N(k):Vt(k))}function Ht(k){ve(k),w.length===0&&(n.domElement.releasePointerCapture(k.pointerId),n.domElement.removeEventListener("pointermove",It),n.domElement.removeEventListener("pointerup",Ht)),n.dispatchEvent(_y),s=r.NONE}function Tt(k){let fe;switch(k.button){case 0:fe=n.mouseButtons.LEFT;break;case 1:fe=n.mouseButtons.MIDDLE;break;case 2:fe=n.mouseButtons.RIGHT;break;default:fe=-1}switch(fe){case aa.DOLLY:if(n.enableZoom===!1)return;J(k),s=r.DOLLY;break;case aa.ROTATE:if(k.ctrlKey||k.metaKey||k.shiftKey){if(n.enablePan===!1)return;ne(k),s=r.PAN}else{if(n.enableRotate===!1)return;le(k),s=r.ROTATE}break;case aa.PAN:if(k.ctrlKey||k.metaKey||k.shiftKey){if(n.enableRotate===!1)return;le(k),s=r.ROTATE}else{if(n.enablePan===!1)return;ne(k),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(lp)}function Vt(k){switch(s){case r.ROTATE:if(n.enableRotate===!1)return;ge(k);break;case r.DOLLY:if(n.enableZoom===!1)return;he(k);break;case r.PAN:if(n.enablePan===!1)return;Ie(k);break}}function yt(k){n.enabled===!1||n.enableZoom===!1||s!==r.NONE||(k.preventDefault(),n.dispatchEvent(lp),ye(k),n.dispatchEvent(_y))}function Et(k){n.enabled===!1||n.enablePan===!1||ie(k)}function Lt(k){switch(Se(k),w.length){case 1:switch(n.touches.ONE){case la.ROTATE:if(n.enableRotate===!1)return;ce(),s=r.TOUCH_ROTATE;break;case la.PAN:if(n.enablePan===!1)return;G(),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(n.touches.TWO){case la.DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;F(),s=r.TOUCH_DOLLY_PAN;break;case la.DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;Pe(),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(lp)}function N(k){switch(Se(k),s){case r.TOUCH_ROTATE:if(n.enableRotate===!1)return;Ce(k),n.update();break;case r.TOUCH_PAN:if(n.enablePan===!1)return;Ee(k),n.update();break;case r.TOUCH_DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;st(k),n.update();break;case r.TOUCH_DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;Ue(k),n.update();break;default:s=r.NONE}}function P(k){n.enabled!==!1&&k.preventDefault()}function re(k){w.push(k)}function ve(k){delete I[k.pointerId];for(let fe=0;fe<w.length;fe++)if(w[fe].pointerId==k.pointerId){w.splice(fe,1);return}}function Se(k){let fe=I[k.pointerId];fe===void 0&&(fe=new nt,I[k.pointerId]=fe),fe.set(k.pageX,k.pageY)}function Te(k){const fe=k.pointerId===w[0].pointerId?w[1]:w[0];return I[fe.pointerId]}n.domElement.addEventListener("contextmenu",P),n.domElement.addEventListener("pointerdown",He),n.domElement.addEventListener("pointercancel",Ht),n.domElement.addEventListener("wheel",yt,{passive:!1}),this.update()}}var Fl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},yh={exports:{}};/**
 * @license
 ...
 */yh.exports;(function(i,e){(function(){var t,n="4.17.21",r=200,s="Unsupported core-js use. Try https://npms.io/search?q=ponyfill.",a="Expected a function",c="Invalid `variable` option passed into `_.template`",u="__lodash_hash_undefined__",h=500,d="__lodash_placeholder__",p=1,_=2,g=4,E=1,x=2,y=1,m=2,b=4,T=8,C=16,w=32,I=64,O=128,B=256,M=512,L=30,Q="...",te=800,W=16,$=1,j=2,le=3,J=1/0,ne=9007199254740991,ge=17976931348623157e292,he=0/0,Ie=4294967295,ye=Ie-1,ie=Ie>>>1,ce=[["ary",O],["bind",y],["bindKey",m],["curry",T],["curryRight",C],["flip",M],["partial",w],["partialRight",I],["rearg",B]],G="[object Arguments]",_e="[object Array]",F="[object AsyncFunction]",Pe="[object Boolean]",Ce="[object Date]",Ee="[object DOMException]",ze="[object Error]",st="[object Function]",Ue="[object GeneratorFunction]",He="[object Map]",It="[object Number]",Ht="[object Null]",Tt="[object Object]",Vt="[object Promise]",yt="[object Proxy]",Et="[object RegExp]",Lt="[object Set]",N="[object String]",P="[object Symbol]",re="[object Undefined]",ve="[object WeakMap]",Se="[object WeakSet]",Te="[object ArrayBuffer]",k="[object DataView]",fe="[object Float32Array]",ee="[object Float64Array]",we="[object Int8Array]",De="[object Int16Array]",Fe="[object Int32Array]",Re="[object Uint8Array]",Oe="[object Uint8ClampedArray]",Ke="[object Uint16Array]",Je="[object Uint32Array]",Yt=/\b__p \+= '';/g,H=/\b(__p \+=) '' \+/g,se=/(__e\(.*?\)|\b__t\)) \+\n'';/g,xe=/&(?:amp|lt|gt|quot|#39);/g,Le=/[&<>"']/g,ke=RegExp(xe.source),Ct=RegExp(Le.source),Rt=/<%-([\s\S]+?)%>/g,gn=/<%([\s\S]+?)%>/g,Qi=/<%=([\s\S]+?)%>/g,$t=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,Kn=/^\w*$/,Ri=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,as=/[\\^$.*+?()[\]{}|]/g,Ic=RegExp(as.source),ll=/^\s+/,Qh=/\s/,Jh=/\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/,D=/\{\n\/\* \[wrapped with (.+)\] \*/,K=/,? & /,oe=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g,q=/[()=,{}\[\]\/\s]/,ue=/\\(\\)?/g,Ge=/\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g,We=/\w*$/,je=/^[-+]0x[0-9a-f]+$/i,et=/^0b[01]+$/i,ot=/^\[object .+?Constructor\]$/,at=/^0o[0-7]+$/i,ft=/^(?:0|[1-9]\d*)$/,wt=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,an=/($^)/,ui=/['\n\r\u2028\u2029\\]/g,Pi="\\ud800-\\udfff",Jt="\\u0300-\\u036f",_t="\\ufe20-\\ufe2f",cl="\\u20d0-\\u20ff",nn=Jt+_t+cl,_r="\\u2700-\\u27bf",ul="a-z\\xdf-\\xf6\\xf8-\\xff",js="\\xac\\xb1\\xd7\\xf7",hl="\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf",An="\\u2000-\\u206f",Ir=" \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",Vo="A-Z\\xc0-\\xd6\\xd8-\\xde",Ln="\\ufe0e\\ufe0f",Xo=js+hl+An+Ir,fl="['’]",Lc="["+Pi+"]",vm="["+Xo+"]",Dc="["+nn+"]",xm="\\d+",OM="["+_r+"]",ym="["+ul+"]",Em="[^"+Pi+Xo+xm+_r+ul+Vo+"]",ef="\\ud83c[\\udffb-\\udfff]",UM="(?:"+Dc+"|"+ef+")",Sm="[^"+Pi+"]",tf="(?:\\ud83c[\\udde6-\\uddff]){2}",nf="[\\ud800-\\udbff][\\udc00-\\udfff]",qo="["+Vo+"]",Mm="\\u200d",Tm="(?:"+ym+"|"+Em+")",FM="(?:"+qo+"|"+Em+")",wm="(?:"+fl+"(?:d|ll|m|re|s|t|ve))?",bm="(?:"+fl+"(?:D|LL|M|RE|S|T|VE))?",Am=UM+"?",Cm="["+Ln+"]?",BM="(?:"+Mm+"(?:"+[Sm,tf,nf].join("|")+")"+Cm+Am+")*",kM="\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",zM="\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",Rm=Cm+Am+BM,GM="(?:"+[OM,tf,nf].join("|")+")"+Rm,HM="(?:"+[Sm+Dc+"?",Dc,tf,nf,Lc].join("|")+")",WM=RegExp(fl,"g"),VM=RegExp(Dc,"g"),rf=RegExp(ef+"(?="+ef+")|"+HM+Rm,"g"),XM=RegExp([qo+"?"+ym+"+"+wm+"(?="+[vm,qo,"$"].join("|")+")",FM+"+"+bm+"(?="+[vm,qo+Tm,"$"].join("|")+")",qo+"?"+Tm+"+"+wm,qo+"+"+bm,zM,kM,xm,GM].join("|"),"g"),qM=RegExp("["+Mm+Pi+nn+Ln+"]"),YM=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/,$M=["Array","Buffer","DataView","Date","Error","Float32Array","Float64Array","Function","Int8Array","Int16Array","Int32Array","Map","Math","Object","Promise","RegExp","Set","String","Symbol","TypeError","Uint8Array","Uint8ClampedArray","Uint16Array","Uint32Array","WeakMap","_","clearTimeout","isFinite","parseInt","setTimeout"],KM=-1,Wt={};Wt[fe]=Wt[ee]=Wt[we]=Wt[De]=Wt[Fe]=Wt[Re]=Wt[Oe]=Wt[Ke]=Wt[Je]=!0,Wt[G]=Wt[_e]=Wt[Te]=Wt[Pe]=Wt[k]=Wt[Ce]=Wt[ze]=Wt[st]=Wt[He]=Wt[It]=Wt[Tt]=Wt[Et]=Wt[Lt]=Wt[N]=Wt[ve]=!1;var kt={};kt[G]=kt[_e]=kt[Te]=kt[k]=kt[Pe]=kt[Ce]=kt[fe]=kt[ee]=kt[we]=kt[De]=kt[Fe]=kt[He]=kt[It]=kt[Tt]=kt[Et]=kt[Lt]=kt[N]=kt[P]=kt[Re]=kt[Oe]=kt[Ke]=kt[Je]=!0,kt[ze]=kt[st]=kt[ve]=!1;var jM={À:"A",Á:"A",Â:"A",Ã:"A",Ä:"A",Å:"A",à:"a",á:"a",â:"a",ã:"a",ä:"a",å:"a",Ç:"C",ç:"c",Ð:"D",ð:"d",È:"E",É:"E",Ê:"E",Ë:"E",è:"e",é:"e",ê:"e",ë:"e",Ì:"I",Í:"I",Î:"I",Ï:"I",ì:"i",í:"i",î:"i",ï:"i",Ñ:"N",ñ:"n",Ò:"O",Ó:"O",Ô:"O",Õ:"O",Ö:"O",Ø:"O",ò:"o",ó:"o",ô:"o",õ:"o",ö:"o",ø:"o",Ù:"U",Ú:"U",Û:"U",Ü:"U",ù:"u",ú:"u",û:"u",ü:"u",Ý:"Y",ý:"y",ÿ:"y",Æ:"Ae",æ:"ae",Þ:"Th",þ:"th",ß:"ss",Ā:"A",Ă:"A",Ą:"A",ā:"a",ă:"a",ą:"a",Ć:"C",Ĉ:"C",Ċ:"C",Č:"C",ć:"c",ĉ:"c",ċ:"c",č:"c",Ď:"D",Đ:"D",ď:"d",đ:"d",Ē:"E",Ĕ:"E",Ė:"E",Ę:"E",Ě:"E",ē:"e",ĕ:"e",ė:"e",ę:"e",ě:"e",Ĝ:"G",Ğ:"G",Ġ:"G",Ģ:"G",ĝ:"g",ğ:"g",ġ:"g",ģ:"g",Ĥ:"H",Ħ:"H",ĥ:"h",ħ:"h",Ĩ:"I",Ī:"I",Ĭ:"I",Į:"I",İ:"I",ĩ:"i",ī:"i",ĭ:"i",į:"i",ı:"i",Ĵ:"J",ĵ:"j",Ķ:"K",ķ:"k",ĸ:"k",Ĺ:"L",Ļ:"L",Ľ:"L",Ŀ:"L",Ł:"L",ĺ:"l",ļ:"l",ľ:"l",ŀ:"l",ł:"l",Ń:"N",Ņ:"N",Ň:"N",Ŋ:"N",ń:"n",ņ:"n",ň:"n",ŋ:"n",Ō:"O",Ŏ:"O",Ő:"O",ō:"o",ŏ:"o",ő:"o",Ŕ:"R",Ŗ:"R",Ř:"R",ŕ:"r",ŗ:"r",ř:"r",Ś:"S",Ŝ:"S",Ş:"S",Š:"S",ś:"s",ŝ:"s",ş:"s",š:"s",Ţ:"T",Ť:"T",Ŧ:"T",ţ:"t",ť:"t",ŧ:"t",Ũ:"U",Ū:"U",Ŭ:"U",Ů:"U",Ű:"U",Ų:"U",ũ:"u",ū:"u",ŭ:"u",ů:"u",ű:"u",ų:"u",Ŵ:"W",ŵ:"w",Ŷ:"Y",ŷ:"y",Ÿ:"Y",Ź:"Z",Ż:"Z",Ž:"Z",ź:"z",ż:"z",ž:"z",Ĳ:"IJ",ĳ:"ij",Œ:"Oe",œ:"oe",ŉ:"'n",ſ:"s"},ZM={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},QM={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"',"&#39;":"'"},JM={"\\":"\\","'":"'","\n":"n","\r":"r","\u2028":"u2028","\u2029":"u2029"},eT=parseFloat,tT=parseInt,Pm=typeof Fl=="object"&&Fl&&Fl.Object===Object&&Fl,nT=typeof self=="object"&&self&&self.Object===Object&&self,Cn=Pm||nT||Function("return this")(),sf=e&&!e.nodeType&&e,Zs=sf&&!0&&i&&!i.nodeType&&i,Im=Zs&&Zs.exports===sf,of=Im&&Pm.process,Ii=function(){try{var V=Zs&&Zs.require&&Zs.require("util").types;return V||of&&of.binding&&of.binding("util")}catch{}}(),Lm=Ii&&Ii.isArrayBuffer,Dm=Ii&&Ii.isDate,Nm=Ii&&Ii.isMap,Om=Ii&&Ii.isRegExp,Um=Ii&&Ii.isSet,Fm=Ii&&Ii.isTypedArray;function hi(V,ae,Z){switch(Z.length){case 0:return V.call(ae);case 1:return V.call(ae,Z[0]);case 2:return V.call(ae,Z[0],Z[1]);case 3:return V.call(ae,Z[0],Z[1],Z[2])}return V.apply(ae,Z)}function iT(V,ae,Z,Ne){for(var Ze=-1,Mt=V==null?0:V.length;++Ze<Mt;){var un=V[Ze];ae(Ne,un,Z(un),V)}return Ne}function Li(V,ae){for(var Z=-1,Ne=V==null?0:V.length;++Z<Ne&&ae(V[Z],Z,V)!==!1;);return V}function rT(V,ae){for(var Z=V==null?0:V.length;Z--&&ae(V[Z],Z,V)!==!1;);return V}function Bm(V,ae){for(var Z=-1,Ne=V==null?0:V.length;++Z<Ne;)if(!ae(V[Z],Z,V))return!1;return!0}function ls(V,ae){for(var Z=-1,Ne=V==null?0:V.length,Ze=0,Mt=[];++Z<Ne;){var un=V[Z];ae(un,Z,V)&&(Mt[Ze++]=un)}return Mt}function Nc(V,ae){var Z=V==null?0:V.length;return!!Z&&Yo(V,ae,0)>-1}function af(V,ae,Z){for(var Ne=-1,Ze=V==null?0:V.length;++Ne<Ze;)if(Z(ae,V[Ne]))return!0;return!1}function Xt(V,ae){for(var Z=-1,Ne=V==null?0:V.length,Ze=Array(Ne);++Z<Ne;)Ze[Z]=ae(V[Z],Z,V);return Ze}function cs(V,ae){for(var Z=-1,Ne=ae.length,Ze=V.length;++Z<Ne;)V[Ze+Z]=ae[Z];return V}function lf(V,ae,Z,Ne){var Ze=-1,Mt=V==null?0:V.length;for(Ne&&Mt&&(Z=V[++Ze]);++Ze<Mt;)Z=ae(Z,V[Ze],Ze,V);return Z}function sT(V,ae,Z,Ne){var Ze=V==null?0:V.length;for(Ne&&Ze&&(Z=V[--Ze]);Ze--;)Z=ae(Z,V[Ze],Ze,V);return Z}function cf(V,ae){for(var Z=-1,Ne=V==null?0:V.length;++Z<Ne;)if(ae(V[Z],Z,V))return!0;return!1}var oT=uf("length");function aT(V){return V.split("")}function lT(V){return V.match(oe)||[]}function km(V,ae,Z){var Ne;return Z(V,function(Ze,Mt,un){if(ae(Ze,Mt,un))return Ne=Mt,!1}),Ne}function Oc(V,ae,Z,Ne){for(var Ze=V.length,Mt=Z+(Ne?1:-1);Ne?Mt--:++Mt<Ze;)if(ae(V[Mt],Mt,V))return Mt;return-1}function Yo(V,ae,Z){return ae===ae?yT(V,ae,Z):Oc(V,zm,Z)}function cT(V,ae,Z,Ne){for(var Ze=Z-1,Mt=V.length;++Ze<Mt;)if(Ne(V[Ze],ae))return Ze;return-1}function zm(V){return V!==V}function Gm(V,ae){var Z=V==null?0:V.length;return Z?ff(V,ae)/Z:he}function uf(V){return function(ae){return ae==null?t:ae[V]}}function hf(V){return function(ae){return V==null?t:V[ae]}}function Hm(V,ae,Z,Ne,Ze){return Ze(V,function(Mt,un,Nt){Z=Ne?(Ne=!1,Mt):ae(Z,Mt,un,Nt)}),Z}function uT(V,ae){var Z=V.length;for(V.sort(ae);Z--;)V[Z]=V[Z].value;return V}function ff(V,ae){for(var Z,Ne=-1,Ze=V.length;++Ne<Ze;){var Mt=ae(V[Ne]);Mt!==t&&(Z=Z===t?Mt:Z+Mt)}return Z}function df(V,ae){for(var Z=-1,Ne=Array(V);++Z<V;)Ne[Z]=ae(Z);return Ne}function hT(V,ae){return Xt(ae,function(Z){return[Z,V[Z]]})}function Wm(V){return V&&V.slice(0,Ym(V)+1).replace(ll,"")}function fi(V){return function(ae){return V(ae)}}function pf(V,ae){return Xt(ae,function(Z){return V[Z]})}function dl(V,ae){return V.has(ae)}function Vm(V,ae){for(var Z=-1,Ne=V.length;++Z<Ne&&Yo(ae,V[Z],0)>-1;);return Z}function Xm(V,ae){for(var Z=V.length;Z--&&Yo(ae,V[Z],0)>-1;);return Z}function fT(V,ae){for(var Z=V.length,Ne=0;Z--;)V[Z]===ae&&++Ne;return Ne}var dT=hf(jM),pT=hf(ZM);function _T(V){return"\\"+JM[V]}function mT(V,ae){return V==null?t:V[ae]}function $o(V){return qM.test(V)}function gT(V){return YM.test(V)}function vT(V){for(var ae,Z=[];!(ae=V.next()).done;)Z.push(ae.value);return Z}function _f(V){var ae=-1,Z=Array(V.size);return V.forEach(function(Ne,Ze){Z[++ae]=[Ze,Ne]}),Z}function qm(V,ae){return function(Z){return V(ae(Z))}}function us(V,ae){for(var Z=-1,Ne=V.length,Ze=0,Mt=[];++Z<Ne;){var un=V[Z];(un===ae||un===d)&&(V[Z]=d,Mt[Ze++]=Z)}return Mt}function Uc(V){var ae=-1,Z=Array(V.size);return V.forEach(function(Ne){Z[++ae]=Ne}),Z}function xT(V){var ae=-1,Z=Array(V.size);return V.forEach(function(Ne){Z[++ae]=[Ne,Ne]}),Z}function yT(V,ae,Z){for(var Ne=Z-1,Ze=V.length;++Ne<Ze;)if(V[Ne]===ae)return Ne;return-1}function ET(V,ae,Z){for(var Ne=Z+1;Ne--;)if(V[Ne]===ae)return Ne;return Ne}function Ko(V){return $o(V)?MT(V):oT(V)}function Ji(V){return $o(V)?TT(V):aT(V)}function Ym(V){for(var ae=V.length;ae--&&Qh.test(V.charAt(ae)););return ae}var ST=hf(QM);function MT(V){for(var ae=rf.lastIndex=0;rf.test(V);)++ae;return ae}function TT(V){return V.match(rf)||[]}function wT(V){return V.match(XM)||[]}var bT=function V(ae){ae=ae==null?Cn:jo.defaults(Cn.Object(),ae,jo.pick(Cn,$M));var Z=ae.Array,Ne=ae.Date,Ze=ae.Error,Mt=ae.Function,un=ae.Math,Nt=ae.Object,mf=ae.RegExp,AT=ae.String,Di=ae.TypeError,Fc=Z.prototype,CT=Mt.prototype,Zo=Nt.prototype,Bc=ae["__core-js_shared__"],kc=CT.toString,Pt=Zo.hasOwnProperty,RT=0,$m=function(){var o=/[^.]+$/.exec(Bc&&Bc.keys&&Bc.keys.IE_PROTO||"");return o?"Symbol(src)_1."+o:""}(),zc=Zo.toString,PT=kc.call(Nt),IT=Cn._,LT=mf("^"+kc.call(Pt).replace(as,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$"),Gc=Im?ae.Buffer:t,hs=ae.Symbol,Hc=ae.Uint8Array,Km=Gc?Gc.allocUnsafe:t,Wc=qm(Nt.getPrototypeOf,Nt),jm=Nt.create,Zm=Zo.propertyIsEnumerable,Vc=Fc.splice,Qm=hs?hs.isConcatSpreadable:t,pl=hs?hs.iterator:t,Qs=hs?hs.toStringTag:t,Xc=function(){try{var o=io(Nt,"defineProperty");return o({},"",{}),o}catch{}}(),DT=ae.clearTimeout!==Cn.clearTimeout&&ae.clearTimeout,NT=Ne&&Ne.now!==Cn.Date.now&&Ne.now,OT=ae.setTimeout!==Cn.setTimeout&&ae.setTimeout,qc=un.ceil,Yc=un.floor,gf=Nt.getOwnPropertySymbols,UT=Gc?Gc.isBuffer:t,Jm=ae.isFinite,FT=Fc.join,BT=qm(Nt.keys,Nt),hn=un.max,Dn=un.min,kT=Ne.now,zT=ae.parseInt,eg=un.random,GT=Fc.reverse,vf=io(ae,"DataView"),_l=io(ae,"Map"),xf=io(ae,"Promise"),Qo=io(ae,"Set"),ml=io(ae,"WeakMap"),gl=io(Nt,"create"),$c=ml&&new ml,Jo={},HT=ro(vf),WT=ro(_l),VT=ro(xf),XT=ro(Qo),qT=ro(ml),Kc=hs?hs.prototype:t,vl=Kc?Kc.valueOf:t,tg=Kc?Kc.toString:t;function A(o){if(en(o)&&!Qe(o)&&!(o instanceof mt)){if(o instanceof Ni)return o;if(Pt.call(o,"__wrapped__"))return nv(o)}return new Ni(o)}var ea=function(){function o(){}return function(l){if(!Kt(l))return{};if(jm)return jm(l);o.prototype=l;var f=new o;return o.prototype=t,f}}();function jc(){}function Ni(o,l){this.__wrapped__=o,this.__actions__=[],this.__chain__=!!l,this.__index__=0,this.__values__=t}A.templateSettings={escape:Rt,evaluate:gn,interpolate:Qi,variable:"",imports:{_:A}},A.prototype=jc.prototype,A.prototype.constructor=A,Ni.prototype=ea(jc.prototype),Ni.prototype.constructor=Ni;function mt(o){this.__wrapped__=o,this.__actions__=[],this.__dir__=1,this.__filtered__=!1,this.__iteratees__=[],this.__takeCount__=Ie,this.__views__=[]}function YT(){var o=new mt(this.__wrapped__);return o.__actions__=jn(this.__actions__),o.__dir__=this.__dir__,o.__filtered__=this.__filtered__,o.__iteratees__=jn(this.__iteratees__),o.__takeCount__=this.__takeCount__,o.__views__=jn(this.__views__),o}function $T(){if(this.__filtered__){var o=new mt(this);o.__dir__=-1,o.__filtered__=!0}else o=this.clone(),o.__dir__*=-1;return o}function KT(){var o=this.__wrapped__.value(),l=this.__dir__,f=Qe(o),v=l<0,S=f?o.length:0,R=ab(0,S,this.__views__),U=R.start,z=R.end,X=z-U,de=v?z:U-1,pe=this.__iteratees__,me=pe.length,Ae=0,Be=Dn(X,this.__takeCount__);if(!f||!v&&S==X&&Be==X)return wg(o,this.__actions__);var Xe=[];e:for(;X--&&Ae<Be;){de+=l;for(var it=-1,qe=o[de];++it<me;){var pt=pe[it],gt=pt.iteratee,_i=pt.type,Vn=gt(qe);if(_i==j)qe=Vn;else if(!Vn){if(_i==$)continue e;break e}}Xe[Ae++]=qe}return Xe}mt.prototype=ea(jc.prototype),mt.prototype.constructor=mt;function Js(o){var l=-1,f=o==null?0:o.length;for(this.clear();++l<f;){var v=o[l];this.set(v[0],v[1])}}function jT(){this.__data__=gl?gl(null):{},this.size=0}function ZT(o){var l=this.has(o)&&delete this.__data__[o];return this.size-=l?1:0,l}function QT(o){var l=this.__data__;if(gl){var f=l[o];return f===u?t:f}return Pt.call(l,o)?l[o]:t}function JT(o){var l=this.__data__;return gl?l[o]!==t:Pt.call(l,o)}function ew(o,l){var f=this.__data__;return this.size+=this.has(o)?0:1,f[o]=gl&&l===t?u:l,this}Js.prototype.clear=jT,Js.prototype.delete=ZT,Js.prototype.get=QT,Js.prototype.has=JT,Js.prototype.set=ew;function Lr(o){var l=-1,f=o==null?0:o.length;for(this.clear();++l<f;){var v=o[l];this.set(v[0],v[1])}}function tw(){this.__data__=[],this.size=0}function nw(o){var l=this.__data__,f=Zc(l,o);if(f<0)return!1;var v=l.length-1;return f==v?l.pop():Vc.call(l,f,1),--this.size,!0}function iw(o){var l=this.__data__,f=Zc(l,o);return f<0?t:l[f][1]}function rw(o){return Zc(this.__data__,o)>-1}function sw(o,l){var f=this.__data__,v=Zc(f,o);return v<0?(++this.size,f.push([o,l])):f[v][1]=l,this}Lr.prototype.clear=tw,Lr.prototype.delete=nw,Lr.prototype.get=iw,Lr.prototype.has=rw,Lr.prototype.set=sw;function Dr(o){var l=-1,f=o==null?0:o.length;for(this.clear();++l<f;){var v=o[l];this.set(v[0],v[1])}}function ow(){this.size=0,this.__data__={hash:new Js,map:new(_l||Lr),string:new Js}}function aw(o){var l=cu(this,o).delete(o);return this.size-=l?1:0,l}function lw(o){return cu(this,o).get(o)}function cw(o){return cu(this,o).has(o)}function uw(o,l){var f=cu(this,o),v=f.size;return f.set(o,l),this.size+=f.size==v?0:1,this}Dr.prototype.clear=ow,Dr.prototype.delete=aw,Dr.prototype.get=lw,Dr.prototype.has=cw,Dr.prototype.set=uw;function eo(o){var l=-1,f=o==null?0:o.length;for(this.__data__=new Dr;++l<f;)this.add(o[l])}function hw(o){return this.__data__.set(o,u),this}function fw(o){return this.__data__.has(o)}eo.prototype.add=eo.prototype.push=hw,eo.prototype.has=fw;function er(o){var l=this.__data__=new Lr(o);this.size=l.size}function dw(){this.__data__=new Lr,this.size=0}function pw(o){var l=this.__data__,f=l.delete(o);return this.size=l.size,f}function _w(o){return this.__data__.get(o)}function mw(o){return this.__data__.has(o)}function gw(o,l){var f=this.__data__;if(f instanceof Lr){var v=f.__data__;if(!_l||v.length<r-1)return v.push([o,l]),this.size=++f.size,this;f=this.__data__=new Dr(v)}return f.set(o,l),this.size=f.size,this}er.prototype.clear=dw,er.prototype.delete=pw,er.prototype.get=_w,er.prototype.has=mw,er.prototype.set=gw;function ng(o,l){var f=Qe(o),v=!f&&so(o),S=!f&&!v&&ms(o),R=!f&&!v&&!S&&ra(o),U=f||v||S||R,z=U?df(o.length,AT):[],X=z.length;for(var de in o)(l||Pt.call(o,de))&&!(U&&(de=="length"||S&&(de=="offset"||de=="parent")||R&&(de=="buffer"||de=="byteLength"||de=="byteOffset")||Fr(de,X)))&&z.push(de);return z}function ig(o){var l=o.length;return l?o[Pf(0,l-1)]:t}function vw(o,l){return uu(jn(o),to(l,0,o.length))}function xw(o){return uu(jn(o))}function yf(o,l,f){(f!==t&&!tr(o[l],f)||f===t&&!(l in o))&&Nr(o,l,f)}function xl(o,l,f){var v=o[l];(!(Pt.call(o,l)&&tr(v,f))||f===t&&!(l in o))&&Nr(o,l,f)}function Zc(o,l){for(var f=o.length;f--;)if(tr(o[f][0],l))return f;return-1}function yw(o,l,f,v){return fs(o,function(S,R,U){l(v,S,f(S),U)}),v}function rg(o,l){return o&&gr(l,vn(l),o)}function Ew(o,l){return o&&gr(l,Qn(l),o)}function Nr(o,l,f){l=="__proto__"&&Xc?Xc(o,l,{configurable:!0,enumerable:!0,value:f,writable:!0}):o[l]=f}function Ef(o,l){for(var f=-1,v=l.length,S=Z(v),R=o==null;++f<v;)S[f]=R?t:td(o,l[f]);return S}function to(o,l,f){return o===o&&(f!==t&&(o=o<=f?o:f),l!==t&&(o=o>=l?o:l)),o}function Oi(o,l,f,v,S,R){var U,z=l&p,X=l&_,de=l&g;if(f&&(U=S?f(o,v,S,R):f(o)),U!==t)return U;if(!Kt(o))return o;var pe=Qe(o);if(pe){if(U=cb(o),!z)return jn(o,U)}else{var me=Nn(o),Ae=me==st||me==Ue;if(ms(o))return Cg(o,z);if(me==Tt||me==G||Ae&&!S){if(U=X||Ae?{}:Yg(o),!z)return X?Qw(o,Ew(U,o)):Zw(o,rg(U,o))}else{if(!kt[me])return S?o:{};U=ub(o,me,z)}}R||(R=new er);var Be=R.get(o);if(Be)return Be;R.set(o,U),Sv(o)?o.forEach(function(qe){U.add(Oi(qe,l,f,qe,o,R))}):yv(o)&&o.forEach(function(qe,pt){U.set(pt,Oi(qe,l,f,pt,o,R))});var Xe=de?X?Gf:zf:X?Qn:vn,it=pe?t:Xe(o);return Li(it||o,function(qe,pt){it&&(pt=qe,qe=o[pt]),xl(U,pt,Oi(qe,l,f,pt,o,R))}),U}function Sw(o){var l=vn(o);return function(f){return sg(f,o,l)}}function sg(o,l,f){var v=f.length;if(o==null)return!v;for(o=Nt(o);v--;){var S=f[v],R=l[S],U=o[S];if(U===t&&!(S in o)||!R(U))return!1}return!0}function og(o,l,f){if(typeof o!="function")throw new Di(a);return bl(function(){o.apply(t,f)},l)}function yl(o,l,f,v){var S=-1,R=Nc,U=!0,z=o.length,X=[],de=l.length;if(!z)return X;f&&(l=Xt(l,fi(f))),v?(R=af,U=!1):l.length>=r&&(R=dl,U=!1,l=new eo(l));e:for(;++S<z;){var pe=o[S],me=f==null?pe:f(pe);if(pe=v||pe!==0?pe:0,U&&me===me){for(var Ae=de;Ae--;)if(l[Ae]===me)continue e;X.push(pe)}else R(l,me,v)||X.push(pe)}return X}var fs=Dg(mr),ag=Dg(Mf,!0);function Mw(o,l){var f=!0;return fs(o,function(v,S,R){return f=!!l(v,S,R),f}),f}function Qc(o,l,f){for(var v=-1,S=o.length;++v<S;){var R=o[v],U=l(R);if(U!=null&&(z===t?U===U&&!pi(U):f(U,z)))var z=U,X=R}return X}function Tw(o,l,f,v){var S=o.length;for(f=tt(f),f<0&&(f=-f>S?0:S+f),v=v===t||v>S?S:tt(v),v<0&&(v+=S),v=f>v?0:Tv(v);f<v;)o[f++]=l;return o}function lg(o,l){var f=[];return fs(o,function(v,S,R){l(v,S,R)&&f.push(v)}),f}function Rn(o,l,f,v,S){var R=-1,U=o.length;for(f||(f=fb),S||(S=[]);++R<U;){var z=o[R];l>0&&f(z)?l>1?Rn(z,l-1,f,v,S):cs(S,z):v||(S[S.length]=z)}return S}var Sf=Ng(),cg=Ng(!0);function mr(o,l){return o&&Sf(o,l,vn)}function Mf(o,l){return o&&cg(o,l,vn)}function Jc(o,l){return ls(l,function(f){return Br(o[f])})}function no(o,l){l=ps(l,o);for(var f=0,v=l.length;o!=null&&f<v;)o=o[vr(l[f++])];return f&&f==v?o:t}function ug(o,l,f){var v=l(o);return Qe(o)?v:cs(v,f(o))}function Hn(o){return o==null?o===t?re:Ht:Qs&&Qs in Nt(o)?ob(o):xb(o)}function Tf(o,l){return o>l}function ww(o,l){return o!=null&&Pt.call(o,l)}function bw(o,l){return o!=null&&l in Nt(o)}function Aw(o,l,f){return o>=Dn(l,f)&&o<hn(l,f)}function wf(o,l,f){for(var v=f?af:Nc,S=o[0].length,R=o.length,U=R,z=Z(R),X=1/0,de=[];U--;){var pe=o[U];U&&l&&(pe=Xt(pe,fi(l))),X=Dn(pe.length,X),z[U]=!f&&(l||S>=120&&pe.length>=120)?new eo(U&&pe):t}pe=o[0];var me=-1,Ae=z[0];e:for(;++me<S&&de.length<X;){var Be=pe[me],Xe=l?l(Be):Be;if(Be=f||Be!==0?Be:0,!(Ae?dl(Ae,Xe):v(de,Xe,f))){for(U=R;--U;){var it=z[U];if(!(it?dl(it,Xe):v(o[U],Xe,f)))continue e}Ae&&Ae.push(Xe),de.push(Be)}}return de}function Cw(o,l,f,v){return mr(o,function(S,R,U){l(v,f(S),R,U)}),v}function El(o,l,f){l=ps(l,o),o=Zg(o,l);var v=o==null?o:o[vr(Fi(l))];return v==null?t:hi(v,o,f)}function hg(o){return en(o)&&Hn(o)==G}function Rw(o){return en(o)&&Hn(o)==Te}function Pw(o){return en(o)&&Hn(o)==Ce}function Sl(o,l,f,v,S){return o===l?!0:o==null||l==null||!en(o)&&!en(l)?o!==o&&l!==l:Iw(o,l,f,v,Sl,S)}function Iw(o,l,f,v,S,R){var U=Qe(o),z=Qe(l),X=U?_e:Nn(o),de=z?_e:Nn(l);X=X==G?Tt:X,de=de==G?Tt:de;var pe=X==Tt,me=de==Tt,Ae=X==de;if(Ae&&ms(o)){if(!ms(l))return!1;U=!0,pe=!1}if(Ae&&!pe)return R||(R=new er),U||ra(o)?Vg(o,l,f,v,S,R):rb(o,l,X,f,v,S,R);if(!(f&E)){var Be=pe&&Pt.call(o,"__wrapped__"),Xe=me&&Pt.call(l,"__wrapped__");if(Be||Xe){var it=Be?o.value():o,qe=Xe?l.value():l;return R||(R=new er),S(it,qe,f,v,R)}}return Ae?(R||(R=new er),sb(o,l,f,v,S,R)):!1}function Lw(o){return en(o)&&Nn(o)==He}function bf(o,l,f,v){var S=f.length,R=S,U=!v;if(o==null)return!R;for(o=Nt(o);S--;){var z=f[S];if(U&&z[2]?z[1]!==o[z[0]]:!(z[0]in o))return!1}for(;++S<R;){z=f[S];var X=z[0],de=o[X],pe=z[1];if(U&&z[2]){if(de===t&&!(X in o))return!1}else{var me=new er;if(v)var Ae=v(de,pe,X,o,l,me);if(!(Ae===t?Sl(pe,de,E|x,v,me):Ae))return!1}}return!0}function fg(o){if(!Kt(o)||pb(o))return!1;var l=Br(o)?LT:ot;return l.test(ro(o))}function Dw(o){return en(o)&&Hn(o)==Et}function Nw(o){return en(o)&&Nn(o)==Lt}function Ow(o){return en(o)&&mu(o.length)&&!!Wt[Hn(o)]}function dg(o){return typeof o=="function"?o:o==null?Jn:typeof o=="object"?Qe(o)?mg(o[0],o[1]):_g(o):Ov(o)}function Af(o){if(!wl(o))return BT(o);var l=[];for(var f in Nt(o))Pt.call(o,f)&&f!="constructor"&&l.push(f);return l}function Uw(o){if(!Kt(o))return vb(o);var l=wl(o),f=[];for(var v in o)v=="constructor"&&(l||!Pt.call(o,v))||f.push(v);return f}function Cf(o,l){return o<l}function pg(o,l){var f=-1,v=Zn(o)?Z(o.length):[];return fs(o,function(S,R,U){v[++f]=l(S,R,U)}),v}function _g(o){var l=Wf(o);return l.length==1&&l[0][2]?Kg(l[0][0],l[0][1]):function(f){return f===o||bf(f,o,l)}}function mg(o,l){return Xf(o)&&$g(l)?Kg(vr(o),l):function(f){var v=td(f,o);return v===t&&v===l?nd(f,o):Sl(l,v,E|x)}}function eu(o,l,f,v,S){o!==l&&Sf(l,function(R,U){if(S||(S=new er),Kt(R))Fw(o,l,U,f,eu,v,S);else{var z=v?v(Yf(o,U),R,U+"",o,l,S):t;z===t&&(z=R),yf(o,U,z)}},Qn)}function Fw(o,l,f,v,S,R,U){var z=Yf(o,f),X=Yf(l,f),de=U.get(X);if(de){yf(o,f,de);return}var pe=R?R(z,X,f+"",o,l,U):t,me=pe===t;if(me){var Ae=Qe(X),Be=!Ae&&ms(X),Xe=!Ae&&!Be&&ra(X);pe=X,Ae||Be||Xe?Qe(z)?pe=z:rn(z)?pe=jn(z):Be?(me=!1,pe=Cg(X,!0)):Xe?(me=!1,pe=Rg(X,!0)):pe=[]:Al(X)||so(X)?(pe=z,so(z)?pe=wv(z):(!Kt(z)||Br(z))&&(pe=Yg(X))):me=!1}me&&(U.set(X,pe),S(pe,X,v,R,U),U.delete(X)),yf(o,f,pe)}function gg(o,l){var f=o.length;if(f)return l+=l<0?f:0,Fr(l,f)?o[l]:t}function vg(o,l,f){l.length?l=Xt(l,function(R){return Qe(R)?function(U){return no(U,R.length===1?R[0]:R)}:R}):l=[Jn];var v=-1;l=Xt(l,fi(Ve()));var S=pg(o,function(R,U,z){var X=Xt(l,function(de){return de(R)});return{criteria:X,index:++v,value:R}});return uT(S,function(R,U){return jw(R,U,f)})}function Bw(o,l){return xg(o,l,function(f,v){return nd(o,v)})}function xg(o,l,f){for(var v=-1,S=l.length,R={};++v<S;){var U=l[v],z=no(o,U);f(z,U)&&Ml(R,ps(U,o),z)}return R}function kw(o){return function(l){return no(l,o)}}function Rf(o,l,f,v){var S=v?cT:Yo,R=-1,U=l.length,z=o;for(o===l&&(l=jn(l)),f&&(z=Xt(o,fi(f)));++R<U;)for(var X=0,de=l[R],pe=f?f(de):de;(X=S(z,pe,X,v))>-1;)z!==o&&Vc.call(z,X,1),Vc.call(o,X,1);return o}function yg(o,l){for(var f=o?l.length:0,v=f-1;f--;){var S=l[f];if(f==v||S!==R){var R=S;Fr(S)?Vc.call(o,S,1):Df(o,S)}}return o}function Pf(o,l){return o+Yc(eg()*(l-o+1))}function zw(o,l,f,v){for(var S=-1,R=hn(qc((l-o)/(f||1)),0),U=Z(R);R--;)U[v?R:++S]=o,o+=f;return U}function If(o,l){var f="";if(!o||l<1||l>ne)return f;do l%2&&(f+=o),l=Yc(l/2),l&&(o+=o);while(l);return f}function lt(o,l){return $f(jg(o,l,Jn),o+"")}function Gw(o){return ig(sa(o))}function Hw(o,l){var f=sa(o);return uu(f,to(l,0,f.length))}function Ml(o,l,f,v){if(!Kt(o))return o;l=ps(l,o);for(var S=-1,R=l.length,U=R-1,z=o;z!=null&&++S<R;){var X=vr(l[S]),de=f;if(X==="__proto__"||X==="constructor"||X==="prototype")return o;if(S!=U){var pe=z[X];de=v?v(pe,X,z):t,de===t&&(de=Kt(pe)?pe:Fr(l[S+1])?[]:{})}xl(z,X,de),z=z[X]}return o}var Eg=$c?function(o,l){return $c.set(o,l),o}:Jn,Ww=Xc?function(o,l){return Xc(o,"toString",{configurable:!0,enumerable:!1,value:rd(l),writable:!0})}:Jn;function Vw(o){return uu(sa(o))}function Ui(o,l,f){var v=-1,S=o.length;l<0&&(l=-l>S?0:S+l),f=f>S?S:f,f<0&&(f+=S),S=l>f?0:f-l>>>0,l>>>=0;for(var R=Z(S);++v<S;)R[v]=o[v+l];return R}function Xw(o,l){var f;return fs(o,function(v,S,R){return f=l(v,S,R),!f}),!!f}function tu(o,l,f){var v=0,S=o==null?v:o.length;if(typeof l=="number"&&l===l&&S<=ie){for(;v<S;){var R=v+S>>>1,U=o[R];U!==null&&!pi(U)&&(f?U<=l:U<l)?v=R+1:S=R}return S}return Lf(o,l,Jn,f)}function Lf(o,l,f,v){var S=0,R=o==null?0:o.length;if(R===0)return 0;l=f(l);for(var U=l!==l,z=l===null,X=pi(l),de=l===t;S<R;){var pe=Yc((S+R)/2),me=f(o[pe]),Ae=me!==t,Be=me===null,Xe=me===me,it=pi(me);if(U)var qe=v||Xe;else de?qe=Xe&&(v||Ae):z?qe=Xe&&Ae&&(v||!Be):X?qe=Xe&&Ae&&!Be&&(v||!it):Be||it?qe=!1:qe=v?me<=l:me<l;qe?S=pe+1:R=pe}return Dn(R,ye)}function Sg(o,l){for(var f=-1,v=o.length,S=0,R=[];++f<v;){var U=o[f],z=l?l(U):U;if(!f||!tr(z,X)){var X=z;R[S++]=U===0?0:U}}return R}function Mg(o){return typeof o=="number"?o:pi(o)?he:+o}function di(o){if(typeof o=="string")return o;if(Qe(o))return Xt(o,di)+"";if(pi(o))return tg?tg.call(o):"";var l=o+"";return l=="0"&&1/o==-J?"-0":l}function ds(o,l,f){var v=-1,S=Nc,R=o.length,U=!0,z=[],X=z;if(f)U=!1,S=af;else if(R>=r){var de=l?null:nb(o);if(de)return Uc(de);U=!1,S=dl,X=new eo}else X=l?[]:z;e:for(;++v<R;){var pe=o[v],me=l?l(pe):pe;if(pe=f||pe!==0?pe:0,U&&me===me){for(var Ae=X.length;Ae--;)if(X[Ae]===me)continue e;l&&X.push(me),z.push(pe)}else S(X,me,f)||(X!==z&&X.push(me),z.push(pe))}return z}function Df(o,l){return l=ps(l,o),o=Zg(o,l),o==null||delete o[vr(Fi(l))]}function Tg(o,l,f,v){return Ml(o,l,f(no(o,l)),v)}function nu(o,l,f,v){for(var S=o.length,R=v?S:-1;(v?R--:++R<S)&&l(o[R],R,o););return f?Ui(o,v?0:R,v?R+1:S):Ui(o,v?R+1:0,v?S:R)}function wg(o,l){var f=o;return f instanceof mt&&(f=f.value()),lf(l,function(v,S){return S.func.apply(S.thisArg,cs([v],S.args))},f)}function Nf(o,l,f){var v=o.length;if(v<2)return v?ds(o[0]):[];for(var S=-1,R=Z(v);++S<v;)for(var U=o[S],z=-1;++z<v;)z!=S&&(R[S]=yl(R[S]||U,o[z],l,f));return ds(Rn(R,1),l,f)}function bg(o,l,f){for(var v=-1,S=o.length,R=l.length,U={};++v<S;){var z=v<R?l[v]:t;f(U,o[v],z)}return U}function Of(o){return rn(o)?o:[]}function Uf(o){return typeof o=="function"?o:Jn}function ps(o,l){return Qe(o)?o:Xf(o,l)?[o]:tv(bt(o))}var qw=lt;function _s(o,l,f){var v=o.length;return f=f===t?v:f,!l&&f>=v?o:Ui(o,l,f)}var Ag=DT||function(o){return Cn.clearTimeout(o)};function Cg(o,l){if(l)return o.slice();var f=o.length,v=Km?Km(f):new o.constructor(f);return o.copy(v),v}function Ff(o){var l=new o.constructor(o.byteLength);return new Hc(l).set(new Hc(o)),l}function Yw(o,l){var f=l?Ff(o.buffer):o.buffer;return new o.constructor(f,o.byteOffset,o.byteLength)}function $w(o){var l=new o.constructor(o.source,We.exec(o));return l.lastIndex=o.lastIndex,l}function Kw(o){return vl?Nt(vl.call(o)):{}}function Rg(o,l){var f=l?Ff(o.buffer):o.buffer;return new o.constructor(f,o.byteOffset,o.length)}function Pg(o,l){if(o!==l){var f=o!==t,v=o===null,S=o===o,R=pi(o),U=l!==t,z=l===null,X=l===l,de=pi(l);if(!z&&!de&&!R&&o>l||R&&U&&X&&!z&&!de||v&&U&&X||!f&&X||!S)return 1;if(!v&&!R&&!de&&o<l||de&&f&&S&&!v&&!R||z&&f&&S||!U&&S||!X)return-1}return 0}function jw(o,l,f){for(var v=-1,S=o.criteria,R=l.criteria,U=S.length,z=f.length;++v<U;){var X=Pg(S[v],R[v]);if(X){if(v>=z)return X;var de=f[v];return X*(de=="desc"?-1:1)}}return o.index-l.index}function Ig(o,l,f,v){for(var S=-1,R=o.length,U=f.length,z=-1,X=l.length,de=hn(R-U,0),pe=Z(X+de),me=!v;++z<X;)pe[z]=l[z];for(;++S<U;)(me||S<R)&&(pe[f[S]]=o[S]);for(;de--;)pe[z++]=o[S++];return pe}function Lg(o,l,f,v){for(var S=-1,R=o.length,U=-1,z=f.length,X=-1,de=l.length,pe=hn(R-z,0),me=Z(pe+de),Ae=!v;++S<pe;)me[S]=o[S];for(var Be=S;++X<de;)me[Be+X]=l[X];for(;++U<z;)(Ae||S<R)&&(me[Be+f[U]]=o[S++]);return me}function jn(o,l){var f=-1,v=o.length;for(l||(l=Z(v));++f<v;)l[f]=o[f];return l}function gr(o,l,f,v){var S=!f;f||(f={});for(var R=-1,U=l.length;++R<U;){var z=l[R],X=v?v(f[z],o[z],z,f,o):t;X===t&&(X=o[z]),S?Nr(f,z,X):xl(f,z,X)}return f}function Zw(o,l){return gr(o,Vf(o),l)}function Qw(o,l){return gr(o,Xg(o),l)}function iu(o,l){return function(f,v){var S=Qe(f)?iT:yw,R=l?l():{};return S(f,o,Ve(v,2),R)}}function ta(o){return lt(function(l,f){var v=-1,S=f.length,R=S>1?f[S-1]:t,U=S>2?f[2]:t;for(R=o.length>3&&typeof R=="function"?(S--,R):t,U&&Wn(f[0],f[1],U)&&(R=S<3?t:R,S=1),l=Nt(l);++v<S;){var z=f[v];z&&o(l,z,v,R)}return l})}function Dg(o,l){return function(f,v){if(f==null)return f;if(!Zn(f))return o(f,v);for(var S=f.length,R=l?S:-1,U=Nt(f);(l?R--:++R<S)&&v(U[R],R,U)!==!1;);return f}}function Ng(o){return function(l,f,v){for(var S=-1,R=Nt(l),U=v(l),z=U.length;z--;){var X=U[o?z:++S];if(f(R[X],X,R)===!1)break}return l}}function Jw(o,l,f){var v=l&y,S=Tl(o);function R(){var U=this&&this!==Cn&&this instanceof R?S:o;return U.apply(v?f:this,arguments)}return R}function Og(o){return function(l){l=bt(l);var f=$o(l)?Ji(l):t,v=f?f[0]:l.charAt(0),S=f?_s(f,1).join(""):l.slice(1);return v[o]()+S}}function na(o){return function(l){return lf(Dv(Lv(l).replace(WM,"")),o,"")}}function Tl(o){return function(){var l=arguments;switch(l.length){case 0:return new o;case 1:return new o(l[0]);case 2:return new o(l[0],l[1]);case 3:return new o(l[0],l[1],l[2]);case 4:return new o(l[0],l[1],l[2],l[3]);case 5:return new o(l[0],l[1],l[2],l[3],l[4]);case 6:return new o(l[0],l[1],l[2],l[3],l[4],l[5]);case 7:return new o(l[0],l[1],l[2],l[3],l[4],l[5],l[6])}var f=ea(o.prototype),v=o.apply(f,l);return Kt(v)?v:f}}function eb(o,l,f){var v=Tl(o);function S(){for(var R=arguments.length,U=Z(R),z=R,X=ia(S);z--;)U[z]=arguments[z];var de=R<3&&U[0]!==X&&U[R-1]!==X?[]:us(U,X);if(R-=de.length,R<f)return zg(o,l,ru,S.placeholder,t,U,de,t,t,f-R);var pe=this&&this!==Cn&&this instanceof S?v:o;return hi(pe,this,U)}return S}function Ug(o){return function(l,f,v){var S=Nt(l);if(!Zn(l)){var R=Ve(f,3);l=vn(l),f=function(z){return R(S[z],z,S)}}var U=o(l,f,v);return U>-1?S[R?l[U]:U]:t}}function Fg(o){return Ur(function(l){var f=l.length,v=f,S=Ni.prototype.thru;for(o&&l.reverse();v--;){var R=l[v];if(typeof R!="function")throw new Di(a);if(S&&!U&&lu(R)=="wrapper")var U=new Ni([],!0)}for(v=U?v:f;++v<f;){R=l[v];var z=lu(R),X=z=="wrapper"?Hf(R):t;X&&qf(X[0])&&X[1]==(O|T|w|B)&&!X[4].length&&X[9]==1?U=U[lu(X[0])].apply(U,X[3]):U=R.length==1&&qf(R)?U[z]():U.thru(R)}return function(){var de=arguments,pe=de[0];if(U&&de.length==1&&Qe(pe))return U.plant(pe).value();for(var me=0,Ae=f?l[me].apply(this,de):pe;++me<f;)Ae=l[me].call(this,Ae);return Ae}})}function ru(o,l,f,v,S,R,U,z,X,de){var pe=l&O,me=l&y,Ae=l&m,Be=l&(T|C),Xe=l&M,it=Ae?t:Tl(o);function qe(){for(var pt=arguments.length,gt=Z(pt),_i=pt;_i--;)gt[_i]=arguments[_i];if(Be)var Vn=ia(qe),mi=fT(gt,Vn);if(v&&(gt=Ig(gt,v,S,Be)),R&&(gt=Lg(gt,R,U,Be)),pt-=mi,Be&&pt<de){var sn=us(gt,Vn);return zg(o,l,ru,qe.placeholder,f,gt,sn,z,X,de-pt)}var nr=me?f:this,zr=Ae?nr[o]:o;return pt=gt.length,z?gt=yb(gt,z):Xe&&pt>1&&gt.reverse(),pe&&X<pt&&(gt.length=X),this&&this!==Cn&&this instanceof qe&&(zr=it||Tl(zr)),zr.apply(nr,gt)}return qe}function Bg(o,l){return function(f,v){return Cw(f,o,l(v),{})}}function su(o,l){return function(f,v){var S;if(f===t&&v===t)return l;if(f!==t&&(S=f),v!==t){if(S===t)return v;typeof f=="string"||typeof v=="string"?(f=di(f),v=di(v)):(f=Mg(f),v=Mg(v)),S=o(f,v)}return S}}function Bf(o){return Ur(function(l){return l=Xt(l,fi(Ve())),lt(function(f){var v=this;return o(l,function(S){return hi(S,v,f)})})})}function ou(o,l){l=l===t?" ":di(l);var f=l.length;if(f<2)return f?If(l,o):l;var v=If(l,qc(o/Ko(l)));return $o(l)?_s(Ji(v),0,o).join(""):v.slice(0,o)}function tb(o,l,f,v){var S=l&y,R=Tl(o);function U(){for(var z=-1,X=arguments.length,de=-1,pe=v.length,me=Z(pe+X),Ae=this&&this!==Cn&&this instanceof U?R:o;++de<pe;)me[de]=v[de];for(;X--;)me[de++]=arguments[++z];return hi(Ae,S?f:this,me)}return U}function kg(o){return function(l,f,v){return v&&typeof v!="number"&&Wn(l,f,v)&&(f=v=t),l=kr(l),f===t?(f=l,l=0):f=kr(f),v=v===t?l<f?1:-1:kr(v),zw(l,f,v,o)}}function au(o){return function(l,f){return typeof l=="string"&&typeof f=="string"||(l=Bi(l),f=Bi(f)),o(l,f)}}function zg(o,l,f,v,S,R,U,z,X,de){var pe=l&T,me=pe?U:t,Ae=pe?t:U,Be=pe?R:t,Xe=pe?t:R;l|=pe?w:I,l&=~(pe?I:w),l&b||(l&=~(y|m));var it=[o,l,S,Be,me,Xe,Ae,z,X,de],qe=f.apply(t,it);return qf(o)&&Qg(qe,it),qe.placeholder=v,Jg(qe,o,l)}function kf(o){var l=un[o];return function(f,v){if(f=Bi(f),v=v==null?0:Dn(tt(v),292),v&&Jm(f)){var S=(bt(f)+"e").split("e"),R=l(S[0]+"e"+(+S[1]+v));return S=(bt(R)+"e").split("e"),+(S[0]+"e"+(+S[1]-v))}return l(f)}}var nb=Qo&&1/Uc(new Qo([,-0]))[1]==J?function(o){return new Qo(o)}:ad;function Gg(o){return function(l){var f=Nn(l);return f==He?_f(l):f==Lt?xT(l):hT(l,o(l))}}function Or(o,l,f,v,S,R,U,z){var X=l&m;if(!X&&typeof o!="function")throw new Di(a);var de=v?v.length:0;if(de||(l&=~(w|I),v=S=t),U=U===t?U:hn(tt(U),0),z=z===t?z:tt(z),de-=S?S.length:0,l&I){var pe=v,me=S;v=S=t}var Ae=X?t:Hf(o),Be=[o,l,f,v,S,pe,me,R,U,z];if(Ae&&gb(Be,Ae),o=Be[0],l=Be[1],f=Be[2],v=Be[3],S=Be[4],z=Be[9]=Be[9]===t?X?0:o.length:hn(Be[9]-de,0),!z&&l&(T|C)&&(l&=~(T|C)),!l||l==y)var Xe=Jw(o,l,f);else l==T||l==C?Xe=eb(o,l,z):(l==w||l==(y|w))&&!S.length?Xe=tb(o,l,f,v):Xe=ru.apply(t,Be);var it=Ae?Eg:Qg;return Jg(it(Xe,Be),o,l)}function Hg(o,l,f,v){return o===t||tr(o,Zo[f])&&!Pt.call(v,f)?l:o}function Wg(o,l,f,v,S,R){return Kt(o)&&Kt(l)&&(R.set(l,o),eu(o,l,t,Wg,R),R.delete(l)),o}function ib(o){return Al(o)?t:o}function Vg(o,l,f,v,S,R){var U=f&E,z=o.length,X=l.length;if(z!=X&&!(U&&X>z))return!1;var de=R.get(o),pe=R.get(l);if(de&&pe)return de==l&&pe==o;var me=-1,Ae=!0,Be=f&x?new eo:t;for(R.set(o,l),R.set(l,o);++me<z;){var Xe=o[me],it=l[me];if(v)var qe=U?v(it,Xe,me,l,o,R):v(Xe,it,me,o,l,R);if(qe!==t){if(qe)continue;Ae=!1;break}if(Be){if(!cf(l,function(pt,gt){if(!dl(Be,gt)&&(Xe===pt||S(Xe,pt,f,v,R)))return Be.push(gt)})){Ae=!1;break}}else if(!(Xe===it||S(Xe,it,f,v,R))){Ae=!1;break}}return R.delete(o),R.delete(l),Ae}function rb(o,l,f,v,S,R,U){switch(f){case k:if(o.byteLength!=l.byteLength||o.byteOffset!=l.byteOffset)return!1;o=o.buffer,l=l.buffer;case Te:return!(o.byteLength!=l.byteLength||!R(new Hc(o),new Hc(l)));case Pe:case Ce:case It:return tr(+o,+l);case ze:return o.name==l.name&&o.message==l.message;case Et:case N:return o==l+"";case He:var z=_f;case Lt:var X=v&E;if(z||(z=Uc),o.size!=l.size&&!X)return!1;var de=U.get(o);if(de)return de==l;v|=x,U.set(o,l);var pe=Vg(z(o),z(l),v,S,R,U);return U.delete(o),pe;case P:if(vl)return vl.call(o)==vl.call(l)}return!1}function sb(o,l,f,v,S,R){var U=f&E,z=zf(o),X=z.length,de=zf(l),pe=de.length;if(X!=pe&&!U)return!1;for(var me=X;me--;){var Ae=z[me];if(!(U?Ae in l:Pt.call(l,Ae)))return!1}var Be=R.get(o),Xe=R.get(l);if(Be&&Xe)return Be==l&&Xe==o;var it=!0;R.set(o,l),R.set(l,o);for(var qe=U;++me<X;){Ae=z[me];var pt=o[Ae],gt=l[Ae];if(v)var _i=U?v(gt,pt,Ae,l,o,R):v(pt,gt,Ae,o,l,R);if(!(_i===t?pt===gt||S(pt,gt,f,v,R):_i)){it=!1;break}qe||(qe=Ae=="constructor")}if(it&&!qe){var Vn=o.constructor,mi=l.constructor;Vn!=mi&&"constructor"in o&&"constructor"in l&&!(typeof Vn=="function"&&Vn instanceof Vn&&typeof mi=="function"&&mi instanceof mi)&&(it=!1)}return R.delete(o),R.delete(l),it}function Ur(o){return $f(jg(o,t,sv),o+"")}function zf(o){return ug(o,vn,Vf)}function Gf(o){return ug(o,Qn,Xg)}var Hf=$c?function(o){return $c.get(o)}:ad;function lu(o){for(var l=o.name+"",f=Jo[l],v=Pt.call(Jo,l)?f.length:0;v--;){var S=f[v],R=S.func;if(R==null||R==o)return S.name}return l}function ia(o){var l=Pt.call(A,"placeholder")?A:o;return l.placeholder}function Ve(){var o=A.iteratee||sd;return o=o===sd?dg:o,arguments.length?o(arguments[0],arguments[1]):o}function cu(o,l){var f=o.__data__;return db(l)?f[typeof l=="string"?"string":"hash"]:f.map}function Wf(o){for(var l=vn(o),f=l.length;f--;){var v=l[f],S=o[v];l[f]=[v,S,$g(S)]}return l}function io(o,l){var f=mT(o,l);return fg(f)?f:t}function ob(o){var l=Pt.call(o,Qs),f=o[Qs];try{o[Qs]=t;var v=!0}catch{}var S=zc.call(o);return v&&(l?o[Qs]=f:delete o[Qs]),S}var Vf=gf?function(o){return o==null?[]:(o=Nt(o),ls(gf(o),function(l){return Zm.call(o,l)}))}:ld,Xg=gf?function(o){for(var l=[];o;)cs(l,Vf(o)),o=Wc(o);return l}:ld,Nn=Hn;(vf&&Nn(new vf(new ArrayBuffer(1)))!=k||_l&&Nn(new _l)!=He||xf&&Nn(xf.resolve())!=Vt||Qo&&Nn(new Qo)!=Lt||ml&&Nn(new ml)!=ve)&&(Nn=function(o){var l=Hn(o),f=l==Tt?o.constructor:t,v=f?ro(f):"";if(v)switch(v){case HT:return k;case WT:return He;case VT:return Vt;case XT:return Lt;case qT:return ve}return l});function ab(o,l,f){for(var v=-1,S=f.length;++v<S;){var R=f[v],U=R.size;switch(R.type){case"drop":o+=U;break;case"dropRight":l-=U;break;case"take":l=Dn(l,o+U);break;case"takeRight":o=hn(o,l-U);break}}return{start:o,end:l}}function lb(o){var l=o.match(D);return l?l[1].split(K):[]}function qg(o,l,f){l=ps(l,o);for(var v=-1,S=l.length,R=!1;++v<S;){var U=vr(l[v]);if(!(R=o!=null&&f(o,U)))break;o=o[U]}return R||++v!=S?R:(S=o==null?0:o.length,!!S&&mu(S)&&Fr(U,S)&&(Qe(o)||so(o)))}function cb(o){var l=o.length,f=new o.constructor(l);return l&&typeof o[0]=="string"&&Pt.call(o,"index")&&(f.index=o.index,f.input=o.input),f}function Yg(o){return typeof o.constructor=="function"&&!wl(o)?ea(Wc(o)):{}}function ub(o,l,f){var v=o.constructor;switch(l){case Te:return Ff(o);case Pe:case Ce:return new v(+o);case k:return Yw(o,f);case fe:case ee:case we:case De:case Fe:case Re:case Oe:case Ke:case Je:return Rg(o,f);case He:return new v;case It:case N:return new v(o);case Et:return $w(o);case Lt:return new v;case P:return Kw(o)}}function hb(o,l){var f=l.length;if(!f)return o;var v=f-1;return l[v]=(f>1?"& ":"")+l[v],l=l.join(f>2?", ":" "),o.replace(Jh,`{
/* [wrapped with `+l+`] */
`)}function fb(o){return Qe(o)||so(o)||!!(Qm&&o&&o[Qm])}function Fr(o,l){var f=typeof o;return l=l??ne,!!l&&(f=="number"||f!="symbol"&&ft.test(o))&&o>-1&&o%1==0&&o<l}function Wn(o,l,f){if(!Kt(f))return!1;var v=typeof l;return(v=="number"?Zn(f)&&Fr(l,f.length):v=="string"&&l in f)?tr(f[l],o):!1}function Xf(o,l){if(Qe(o))return!1;var f=typeof o;return f=="number"||f=="symbol"||f=="boolean"||o==null||pi(o)?!0:Kn.test(o)||!$t.test(o)||l!=null&&o in Nt(l)}function db(o){var l=typeof o;return l=="string"||l=="number"||l=="symbol"||l=="boolean"?o!=="__proto__":o===null}function qf(o){var l=lu(o),f=A[l];if(typeof f!="function"||!(l in mt.prototype))return!1;if(o===f)return!0;var v=Hf(f);return!!v&&o===v[0]}function pb(o){return!!$m&&$m in o}var _b=Bc?Br:cd;function wl(o){var l=o&&o.constructor,f=typeof l=="function"&&l.prototype||Zo;return o===f}function $g(o){return o===o&&!Kt(o)}function Kg(o,l){return function(f){return f==null?!1:f[o]===l&&(l!==t||o in Nt(f))}}function mb(o){var l=pu(o,function(v){return f.size===h&&f.clear(),v}),f=l.cache;return l}function gb(o,l){var f=o[1],v=l[1],S=f|v,R=S<(y|m|O),U=v==O&&f==T||v==O&&f==B&&o[7].length<=l[8]||v==(O|B)&&l[7].length<=l[8]&&f==T;if(!(R||U))return o;v&y&&(o[2]=l[2],S|=f&y?0:b);var z=l[3];if(z){var X=o[3];o[3]=X?Ig(X,z,l[4]):z,o[4]=X?us(o[3],d):l[4]}return z=l[5],z&&(X=o[5],o[5]=X?Lg(X,z,l[6]):z,o[6]=X?us(o[5],d):l[6]),z=l[7],z&&(o[7]=z),v&O&&(o[8]=o[8]==null?l[8]:Dn(o[8],l[8])),o[9]==null&&(o[9]=l[9]),o[0]=l[0],o[1]=S,o}function vb(o){var l=[];if(o!=null)for(var f in Nt(o))l.push(f);return l}function xb(o){return zc.call(o)}function jg(o,l,f){return l=hn(l===t?o.length-1:l,0),function(){for(var v=arguments,S=-1,R=hn(v.length-l,0),U=Z(R);++S<R;)U[S]=v[l+S];S=-1;for(var z=Z(l+1);++S<l;)z[S]=v[S];return z[l]=f(U),hi(o,this,z)}}function Zg(o,l){return l.length<2?o:no(o,Ui(l,0,-1))}function yb(o,l){for(var f=o.length,v=Dn(l.length,f),S=jn(o);v--;){var R=l[v];o[v]=Fr(R,f)?S[R]:t}return o}function Yf(o,l){if(!(l==="constructor"&&typeof o[l]=="function")&&l!="__proto__")return o[l]}var Qg=ev(Eg),bl=OT||function(o,l){return Cn.setTimeout(o,l)},$f=ev(Ww);function Jg(o,l,f){var v=l+"";return $f(o,hb(v,Eb(lb(v),f)))}function ev(o){var l=0,f=0;return function(){var v=kT(),S=W-(v-f);if(f=v,S>0){if(++l>=te)return arguments[0]}else l=0;return o.apply(t,arguments)}}function uu(o,l){var f=-1,v=o.length,S=v-1;for(l=l===t?v:l;++f<l;){var R=Pf(f,S),U=o[R];o[R]=o[f],o[f]=U}return o.length=l,o}var tv=mb(function(o){var l=[];return o.charCodeAt(0)===46&&l.push(""),o.replace(Ri,function(f,v,S,R){l.push(S?R.replace(ue,"$1"):v||f)}),l});function vr(o){if(typeof o=="string"||pi(o))return o;var l=o+"";return l=="0"&&1/o==-J?"-0":l}function ro(o){if(o!=null){try{return kc.call(o)}catch{}try{return o+""}catch{}}return""}function Eb(o,l){return Li(ce,function(f){var v="_."+f[0];l&f[1]&&!Nc(o,v)&&o.push(v)}),o.sort()}function nv(o){if(o instanceof mt)return o.clone();var l=new Ni(o.__wrapped__,o.__chain__);return l.__actions__=jn(o.__actions__),l.__index__=o.__index__,l.__values__=o.__values__,l}function Sb(o,l,f){(f?Wn(o,l,f):l===t)?l=1:l=hn(tt(l),0);var v=o==null?0:o.length;if(!v||l<1)return[];for(var S=0,R=0,U=Z(qc(v/l));S<v;)U[R++]=Ui(o,S,S+=l);return U}function Mb(o){for(var l=-1,f=o==null?0:o.length,v=0,S=[];++l<f;){var R=o[l];R&&(S[v++]=R)}return S}function Tb(){var o=arguments.length;if(!o)return[];for(var l=Z(o-1),f=arguments[0],v=o;v--;)l[v-1]=arguments[v];return cs(Qe(f)?jn(f):[f],Rn(l,1))}var wb=lt(function(o,l){return rn(o)?yl(o,Rn(l,1,rn,!0)):[]}),bb=lt(function(o,l){var f=Fi(l);return rn(f)&&(f=t),rn(o)?yl(o,Rn(l,1,rn,!0),Ve(f,2)):[]}),Ab=lt(function(o,l){var f=Fi(l);return rn(f)&&(f=t),rn(o)?yl(o,Rn(l,1,rn,!0),t,f):[]});function Cb(o,l,f){var v=o==null?0:o.length;return v?(l=f||l===t?1:tt(l),Ui(o,l<0?0:l,v)):[]}function Rb(o,l,f){var v=o==null?0:o.length;return v?(l=f||l===t?1:tt(l),l=v-l,Ui(o,0,l<0?0:l)):[]}function Pb(o,l){return o&&o.length?nu(o,Ve(l,3),!0,!0):[]}function Ib(o,l){return o&&o.length?nu(o,Ve(l,3),!0):[]}function Lb(o,l,f,v){var S=o==null?0:o.length;return S?(f&&typeof f!="number"&&Wn(o,l,f)&&(f=0,v=S),Tw(o,l,f,v)):[]}function iv(o,l,f){var v=o==null?0:o.length;if(!v)return-1;var S=f==null?0:tt(f);return S<0&&(S=hn(v+S,0)),Oc(o,Ve(l,3),S)}function rv(o,l,f){var v=o==null?0:o.length;if(!v)return-1;var S=v-1;return f!==t&&(S=tt(f),S=f<0?hn(v+S,0):Dn(S,v-1)),Oc(o,Ve(l,3),S,!0)}function sv(o){var l=o==null?0:o.length;return l?Rn(o,1):[]}function Db(o){var l=o==null?0:o.length;return l?Rn(o,J):[]}function Nb(o,l){var f=o==null?0:o.length;return f?(l=l===t?1:tt(l),Rn(o,l)):[]}function Ob(o){for(var l=-1,f=o==null?0:o.length,v={};++l<f;){var S=o[l];v[S[0]]=S[1]}return v}function ov(o){return o&&o.length?o[0]:t}function Ub(o,l,f){var v=o==null?0:o.length;if(!v)return-1;var S=f==null?0:tt(f);return S<0&&(S=hn(v+S,0)),Yo(o,l,S)}function Fb(o){var l=o==null?0:o.length;return l?Ui(o,0,-1):[]}var Bb=lt(function(o){var l=Xt(o,Of);return l.length&&l[0]===o[0]?wf(l):[]}),kb=lt(function(o){var l=Fi(o),f=Xt(o,Of);return l===Fi(f)?l=t:f.pop(),f.length&&f[0]===o[0]?wf(f,Ve(l,2)):[]}),zb=lt(function(o){var l=Fi(o),f=Xt(o,Of);return l=typeof l=="function"?l:t,l&&f.pop(),f.length&&f[0]===o[0]?wf(f,t,l):[]});function Gb(o,l){return o==null?"":FT.call(o,l)}function Fi(o){var l=o==null?0:o.length;return l?o[l-1]:t}function Hb(o,l,f){var v=o==null?0:o.length;if(!v)return-1;var S=v;return f!==t&&(S=tt(f),S=S<0?hn(v+S,0):Dn(S,v-1)),l===l?ET(o,l,S):Oc(o,zm,S,!0)}function Wb(o,l){return o&&o.length?gg(o,tt(l)):t}var Vb=lt(av);function av(o,l){return o&&o.length&&l&&l.length?Rf(o,l):o}function Xb(o,l,f){return o&&o.length&&l&&l.length?Rf(o,l,Ve(f,2)):o}function qb(o,l,f){return o&&o.length&&l&&l.length?Rf(o,l,t,f):o}var Yb=Ur(function(o,l){var f=o==null?0:o.length,v=Ef(o,l);return yg(o,Xt(l,function(S){return Fr(S,f)?+S:S}).sort(Pg)),v});function $b(o,l){var f=[];if(!(o&&o.length))return f;var v=-1,S=[],R=o.length;for(l=Ve(l,3);++v<R;){var U=o[v];l(U,v,o)&&(f.push(U),S.push(v))}return yg(o,S),f}function Kf(o){return o==null?o:GT.call(o)}function Kb(o,l,f){var v=o==null?0:o.length;return v?(f&&typeof f!="number"&&Wn(o,l,f)?(l=0,f=v):(l=l==null?0:tt(l),f=f===t?v:tt(f)),Ui(o,l,f)):[]}function jb(o,l){return tu(o,l)}function Zb(o,l,f){return Lf(o,l,Ve(f,2))}function Qb(o,l){var f=o==null?0:o.length;if(f){var v=tu(o,l);if(v<f&&tr(o[v],l))return v}return-1}function Jb(o,l){return tu(o,l,!0)}function eA(o,l,f){return Lf(o,l,Ve(f,2),!0)}function tA(o,l){var f=o==null?0:o.length;if(f){var v=tu(o,l,!0)-1;if(tr(o[v],l))return v}return-1}function nA(o){return o&&o.length?Sg(o):[]}function iA(o,l){return o&&o.length?Sg(o,Ve(l,2)):[]}function rA(o){var l=o==null?0:o.length;return l?Ui(o,1,l):[]}function sA(o,l,f){return o&&o.length?(l=f||l===t?1:tt(l),Ui(o,0,l<0?0:l)):[]}function oA(o,l,f){var v=o==null?0:o.length;return v?(l=f||l===t?1:tt(l),l=v-l,Ui(o,l<0?0:l,v)):[]}function aA(o,l){return o&&o.length?nu(o,Ve(l,3),!1,!0):[]}function lA(o,l){return o&&o.length?nu(o,Ve(l,3)):[]}var cA=lt(function(o){return ds(Rn(o,1,rn,!0))}),uA=lt(function(o){var l=Fi(o);return rn(l)&&(l=t),ds(Rn(o,1,rn,!0),Ve(l,2))}),hA=lt(function(o){var l=Fi(o);return l=typeof l=="function"?l:t,ds(Rn(o,1,rn,!0),t,l)});function fA(o){return o&&o.length?ds(o):[]}function dA(o,l){return o&&o.length?ds(o,Ve(l,2)):[]}function pA(o,l){return l=typeof l=="function"?l:t,o&&o.length?ds(o,t,l):[]}function jf(o){if(!(o&&o.length))return[];var l=0;return o=ls(o,function(f){if(rn(f))return l=hn(f.length,l),!0}),df(l,function(f){return Xt(o,uf(f))})}function lv(o,l){if(!(o&&o.length))return[];var f=jf(o);return l==null?f:Xt(f,function(v){return hi(l,t,v)})}var _A=lt(function(o,l){return rn(o)?yl(o,l):[]}),mA=lt(function(o){return Nf(ls(o,rn))}),gA=lt(function(o){var l=Fi(o);return rn(l)&&(l=t),Nf(ls(o,rn),Ve(l,2))}),vA=lt(function(o){var l=Fi(o);return l=typeof l=="function"?l:t,Nf(ls(o,rn),t,l)}),xA=lt(jf);function yA(o,l){return bg(o||[],l||[],xl)}function EA(o,l){return bg(o||[],l||[],Ml)}var SA=lt(function(o){var l=o.length,f=l>1?o[l-1]:t;return f=typeof f=="function"?(o.pop(),f):t,lv(o,f)});function cv(o){var l=A(o);return l.__chain__=!0,l}function MA(o,l){return l(o),o}function hu(o,l){return l(o)}var TA=Ur(function(o){var l=o.length,f=l?o[0]:0,v=this.__wrapped__,S=function(R){return Ef(R,o)};return l>1||this.__actions__.length||!(v instanceof mt)||!Fr(f)?this.thru(S):(v=v.slice(f,+f+(l?1:0)),v.__actions__.push({func:hu,args:[S],thisArg:t}),new Ni(v,this.__chain__).thru(function(R){return l&&!R.length&&R.push(t),R}))});function wA(){return cv(this)}function bA(){return new Ni(this.value(),this.__chain__)}function AA(){this.__values__===t&&(this.__values__=Mv(this.value()));var o=this.__index__>=this.__values__.length,l=o?t:this.__values__[this.__index__++];return{done:o,value:l}}function CA(){return this}function RA(o){for(var l,f=this;f instanceof jc;){var v=nv(f);v.__index__=0,v.__values__=t,l?S.__wrapped__=v:l=v;var S=v;f=f.__wrapped__}return S.__wrapped__=o,l}function PA(){var o=this.__wrapped__;if(o instanceof mt){var l=o;return this.__actions__.length&&(l=new mt(this)),l=l.reverse(),l.__actions__.push({func:hu,args:[Kf],thisArg:t}),new Ni(l,this.__chain__)}return this.thru(Kf)}function IA(){return wg(this.__wrapped__,this.__actions__)}var LA=iu(function(o,l,f){Pt.call(o,f)?++o[f]:Nr(o,f,1)});function DA(o,l,f){var v=Qe(o)?Bm:Mw;return f&&Wn(o,l,f)&&(l=t),v(o,Ve(l,3))}function NA(o,l){var f=Qe(o)?ls:lg;return f(o,Ve(l,3))}var OA=Ug(iv),UA=Ug(rv);function FA(o,l){return Rn(fu(o,l),1)}function BA(o,l){return Rn(fu(o,l),J)}function kA(o,l,f){return f=f===t?1:tt(f),Rn(fu(o,l),f)}function uv(o,l){var f=Qe(o)?Li:fs;return f(o,Ve(l,3))}function hv(o,l){var f=Qe(o)?rT:ag;return f(o,Ve(l,3))}var zA=iu(function(o,l,f){Pt.call(o,f)?o[f].push(l):Nr(o,f,[l])});function GA(o,l,f,v){o=Zn(o)?o:sa(o),f=f&&!v?tt(f):0;var S=o.length;return f<0&&(f=hn(S+f,0)),gu(o)?f<=S&&o.indexOf(l,f)>-1:!!S&&Yo(o,l,f)>-1}var HA=lt(function(o,l,f){var v=-1,S=typeof l=="function",R=Zn(o)?Z(o.length):[];return fs(o,function(U){R[++v]=S?hi(l,U,f):El(U,l,f)}),R}),WA=iu(function(o,l,f){Nr(o,f,l)});function fu(o,l){var f=Qe(o)?Xt:pg;return f(o,Ve(l,3))}function VA(o,l,f,v){return o==null?[]:(Qe(l)||(l=l==null?[]:[l]),f=v?t:f,Qe(f)||(f=f==null?[]:[f]),vg(o,l,f))}var XA=iu(function(o,l,f){o[f?0:1].push(l)},function(){return[[],[]]});function qA(o,l,f){var v=Qe(o)?lf:Hm,S=arguments.length<3;return v(o,Ve(l,4),f,S,fs)}function YA(o,l,f){var v=Qe(o)?sT:Hm,S=arguments.length<3;return v(o,Ve(l,4),f,S,ag)}function $A(o,l){var f=Qe(o)?ls:lg;return f(o,_u(Ve(l,3)))}function KA(o){var l=Qe(o)?ig:Gw;return l(o)}function jA(o,l,f){(f?Wn(o,l,f):l===t)?l=1:l=tt(l);var v=Qe(o)?vw:Hw;return v(o,l)}function ZA(o){var l=Qe(o)?xw:Vw;return l(o)}function QA(o){if(o==null)return 0;if(Zn(o))return gu(o)?Ko(o):o.length;var l=Nn(o);return l==He||l==Lt?o.size:Af(o).length}function JA(o,l,f){var v=Qe(o)?cf:Xw;return f&&Wn(o,l,f)&&(l=t),v(o,Ve(l,3))}var eC=lt(function(o,l){if(o==null)return[];var f=l.length;return f>1&&Wn(o,l[0],l[1])?l=[]:f>2&&Wn(l[0],l[1],l[2])&&(l=[l[0]]),vg(o,Rn(l,1),[])}),du=NT||function(){return Cn.Date.now()};function tC(o,l){if(typeof l!="function")throw new Di(a);return o=tt(o),function(){if(--o<1)return l.apply(this,arguments)}}function fv(o,l,f){return l=f?t:l,l=o&&l==null?o.length:l,Or(o,O,t,t,t,t,l)}function dv(o,l){var f;if(typeof l!="function")throw new Di(a);return o=tt(o),function(){return--o>0&&(f=l.apply(this,arguments)),o<=1&&(l=t),f}}var Zf=lt(function(o,l,f){var v=y;if(f.length){var S=us(f,ia(Zf));v|=w}return Or(o,v,l,f,S)}),pv=lt(function(o,l,f){var v=y|m;if(f.length){var S=us(f,ia(pv));v|=w}return Or(l,v,o,f,S)});function _v(o,l,f){l=f?t:l;var v=Or(o,T,t,t,t,t,t,l);return v.placeholder=_v.placeholder,v}function mv(o,l,f){l=f?t:l;var v=Or(o,C,t,t,t,t,t,l);return v.placeholder=mv.placeholder,v}function gv(o,l,f){var v,S,R,U,z,X,de=0,pe=!1,me=!1,Ae=!0;if(typeof o!="function")throw new Di(a);l=Bi(l)||0,Kt(f)&&(pe=!!f.leading,me="maxWait"in f,R=me?hn(Bi(f.maxWait)||0,l):R,Ae="trailing"in f?!!f.trailing:Ae);function Be(sn){var nr=v,zr=S;return v=S=t,de=sn,U=o.apply(zr,nr),U}function Xe(sn){return de=sn,z=bl(pt,l),pe?Be(sn):U}function it(sn){var nr=sn-X,zr=sn-de,Uv=l-nr;return me?Dn(Uv,R-zr):Uv}function qe(sn){var nr=sn-X,zr=sn-de;return X===t||nr>=l||nr<0||me&&zr>=R}function pt(){var sn=du();if(qe(sn))return gt(sn);z=bl(pt,it(sn))}function gt(sn){return z=t,Ae&&v?Be(sn):(v=S=t,U)}function _i(){z!==t&&Ag(z),de=0,v=X=S=z=t}function Vn(){return z===t?U:gt(du())}function mi(){var sn=du(),nr=qe(sn);if(v=arguments,S=this,X=sn,nr){if(z===t)return Xe(X);if(me)return Ag(z),z=bl(pt,l),Be(X)}return z===t&&(z=bl(pt,l)),U}return mi.cancel=_i,mi.flush=Vn,mi}var nC=lt(function(o,l){return og(o,1,l)}),iC=lt(function(o,l,f){return og(o,Bi(l)||0,f)});function rC(o){return Or(o,M)}function pu(o,l){if(typeof o!="function"||l!=null&&typeof l!="function")throw new Di(a);var f=function(){var v=arguments,S=l?l.apply(this,v):v[0],R=f.cache;if(R.has(S))return R.get(S);var U=o.apply(this,v);return f.cache=R.set(S,U)||R,U};return f.cache=new(pu.Cache||Dr),f}pu.Cache=Dr;function _u(o){if(typeof o!="function")throw new Di(a);return function(){var l=arguments;switch(l.length){case 0:return!o.call(this);case 1:return!o.call(this,l[0]);case 2:return!o.call(this,l[0],l[1]);case 3:return!o.call(this,l[0],l[1],l[2])}return!o.apply(this,l)}}function sC(o){return dv(2,o)}var oC=qw(function(o,l){l=l.length==1&&Qe(l[0])?Xt(l[0],fi(Ve())):Xt(Rn(l,1),fi(Ve()));var f=l.length;return lt(function(v){for(var S=-1,R=Dn(v.length,f);++S<R;)v[S]=l[S].call(this,v[S]);return hi(o,this,v)})}),Qf=lt(function(o,l){var f=us(l,ia(Qf));return Or(o,w,t,l,f)}),vv=lt(function(o,l){var f=us(l,ia(vv));return Or(o,I,t,l,f)}),aC=Ur(function(o,l){return Or(o,B,t,t,t,l)});function lC(o,l){if(typeof o!="function")throw new Di(a);return l=l===t?l:tt(l),lt(o,l)}function cC(o,l){if(typeof o!="function")throw new Di(a);return l=l==null?0:hn(tt(l),0),lt(function(f){var v=f[l],S=_s(f,0,l);return v&&cs(S,v),hi(o,this,S)})}function uC(o,l,f){var v=!0,S=!0;if(typeof o!="function")throw new Di(a);return Kt(f)&&(v="leading"in f?!!f.leading:v,S="trailing"in f?!!f.trailing:S),gv(o,l,{leading:v,maxWait:l,trailing:S})}function hC(o){return fv(o,1)}function fC(o,l){return Qf(Uf(l),o)}function dC(){if(!arguments.length)return[];var o=arguments[0];return Qe(o)?o:[o]}function pC(o){return Oi(o,g)}function _C(o,l){return l=typeof l=="function"?l:t,Oi(o,g,l)}function mC(o){return Oi(o,p|g)}function gC(o,l){return l=typeof l=="function"?l:t,Oi(o,p|g,l)}function vC(o,l){return l==null||sg(o,l,vn(l))}function tr(o,l){return o===l||o!==o&&l!==l}var xC=au(Tf),yC=au(function(o,l){return o>=l}),so=hg(function(){return arguments}())?hg:function(o){return en(o)&&Pt.call(o,"callee")&&!Zm.call(o,"callee")},Qe=Z.isArray,EC=Lm?fi(Lm):Rw;function Zn(o){return o!=null&&mu(o.length)&&!Br(o)}function rn(o){return en(o)&&Zn(o)}function SC(o){return o===!0||o===!1||en(o)&&Hn(o)==Pe}var ms=UT||cd,MC=Dm?fi(Dm):Pw;function TC(o){return en(o)&&o.nodeType===1&&!Al(o)}function wC(o){if(o==null)return!0;if(Zn(o)&&(Qe(o)||typeof o=="string"||typeof o.splice=="function"||ms(o)||ra(o)||so(o)))return!o.length;var l=Nn(o);if(l==He||l==Lt)return!o.size;if(wl(o))return!Af(o).length;for(var f in o)if(Pt.call(o,f))return!1;return!0}function bC(o,l){return Sl(o,l)}function AC(o,l,f){f=typeof f=="function"?f:t;var v=f?f(o,l):t;return v===t?Sl(o,l,t,f):!!v}function Jf(o){if(!en(o))return!1;var l=Hn(o);return l==ze||l==Ee||typeof o.message=="string"&&typeof o.name=="string"&&!Al(o)}function CC(o){return typeof o=="number"&&Jm(o)}function Br(o){if(!Kt(o))return!1;var l=Hn(o);return l==st||l==Ue||l==F||l==yt}function xv(o){return typeof o=="number"&&o==tt(o)}function mu(o){return typeof o=="number"&&o>-1&&o%1==0&&o<=ne}function Kt(o){var l=typeof o;return o!=null&&(l=="object"||l=="function")}function en(o){return o!=null&&typeof o=="object"}var yv=Nm?fi(Nm):Lw;function RC(o,l){return o===l||bf(o,l,Wf(l))}function PC(o,l,f){return f=typeof f=="function"?f:t,bf(o,l,Wf(l),f)}function IC(o){return Ev(o)&&o!=+o}function LC(o){if(_b(o))throw new Ze(s);return fg(o)}function DC(o){return o===null}function NC(o){return o==null}function Ev(o){return typeof o=="number"||en(o)&&Hn(o)==It}function Al(o){if(!en(o)||Hn(o)!=Tt)return!1;var l=Wc(o);if(l===null)return!0;var f=Pt.call(l,"constructor")&&l.constructor;return typeof f=="function"&&f instanceof f&&kc.call(f)==PT}var ed=Om?fi(Om):Dw;function OC(o){return xv(o)&&o>=-ne&&o<=ne}var Sv=Um?fi(Um):Nw;function gu(o){return typeof o=="string"||!Qe(o)&&en(o)&&Hn(o)==N}function pi(o){return typeof o=="symbol"||en(o)&&Hn(o)==P}var ra=Fm?fi(Fm):Ow;function UC(o){return o===t}function FC(o){return en(o)&&Nn(o)==ve}function BC(o){return en(o)&&Hn(o)==Se}var kC=au(Cf),zC=au(function(o,l){return o<=l});function Mv(o){if(!o)return[];if(Zn(o))return gu(o)?Ji(o):jn(o);if(pl&&o[pl])return vT(o[pl]());var l=Nn(o),f=l==He?_f:l==Lt?Uc:sa;return f(o)}function kr(o){if(!o)return o===0?o:0;if(o=Bi(o),o===J||o===-J){var l=o<0?-1:1;return l*ge}return o===o?o:0}function tt(o){var l=kr(o),f=l%1;return l===l?f?l-f:l:0}function Tv(o){return o?to(tt(o),0,Ie):0}function Bi(o){if(typeof o=="number")return o;if(pi(o))return he;if(Kt(o)){var l=typeof o.valueOf=="function"?o.valueOf():o;o=Kt(l)?l+"":l}if(typeof o!="string")return o===0?o:+o;o=Wm(o);var f=et.test(o);return f||at.test(o)?tT(o.slice(2),f?2:8):je.test(o)?he:+o}function wv(o){return gr(o,Qn(o))}function GC(o){return o?to(tt(o),-ne,ne):o===0?o:0}function bt(o){return o==null?"":di(o)}var HC=ta(function(o,l){if(wl(l)||Zn(l)){gr(l,vn(l),o);return}for(var f in l)Pt.call(l,f)&&xl(o,f,l[f])}),bv=ta(function(o,l){gr(l,Qn(l),o)}),vu=ta(function(o,l,f,v){gr(l,Qn(l),o,v)}),WC=ta(function(o,l,f,v){gr(l,vn(l),o,v)}),VC=Ur(Ef);function XC(o,l){var f=ea(o);return l==null?f:rg(f,l)}var qC=lt(function(o,l){o=Nt(o);var f=-1,v=l.length,S=v>2?l[2]:t;for(S&&Wn(l[0],l[1],S)&&(v=1);++f<v;)for(var R=l[f],U=Qn(R),z=-1,X=U.length;++z<X;){var de=U[z],pe=o[de];(pe===t||tr(pe,Zo[de])&&!Pt.call(o,de))&&(o[de]=R[de])}return o}),YC=lt(function(o){return o.push(t,Wg),hi(Av,t,o)});function $C(o,l){return km(o,Ve(l,3),mr)}function KC(o,l){return km(o,Ve(l,3),Mf)}function jC(o,l){return o==null?o:Sf(o,Ve(l,3),Qn)}function ZC(o,l){return o==null?o:cg(o,Ve(l,3),Qn)}function QC(o,l){return o&&mr(o,Ve(l,3))}function JC(o,l){return o&&Mf(o,Ve(l,3))}function e1(o){return o==null?[]:Jc(o,vn(o))}function t1(o){return o==null?[]:Jc(o,Qn(o))}function td(o,l,f){var v=o==null?t:no(o,l);return v===t?f:v}function n1(o,l){return o!=null&&qg(o,l,ww)}function nd(o,l){return o!=null&&qg(o,l,bw)}var i1=Bg(function(o,l,f){l!=null&&typeof l.toString!="function"&&(l=zc.call(l)),o[l]=f},rd(Jn)),r1=Bg(function(o,l,f){l!=null&&typeof l.toString!="function"&&(l=zc.call(l)),Pt.call(o,l)?o[l].push(f):o[l]=[f]},Ve),s1=lt(El);function vn(o){return Zn(o)?ng(o):Af(o)}function Qn(o){return Zn(o)?ng(o,!0):Uw(o)}function o1(o,l){var f={};return l=Ve(l,3),mr(o,function(v,S,R){Nr(f,l(v,S,R),v)}),f}function a1(o,l){var f={};return l=Ve(l,3),mr(o,function(v,S,R){Nr(f,S,l(v,S,R))}),f}var l1=ta(function(o,l,f){eu(o,l,f)}),Av=ta(function(o,l,f,v){eu(o,l,f,v)}),c1=Ur(function(o,l){var f={};if(o==null)return f;var v=!1;l=Xt(l,function(R){return R=ps(R,o),v||(v=R.length>1),R}),gr(o,Gf(o),f),v&&(f=Oi(f,p|_|g,ib));for(var S=l.length;S--;)Df(f,l[S]);return f});function u1(o,l){return Cv(o,_u(Ve(l)))}var h1=Ur(function(o,l){return o==null?{}:Bw(o,l)});function Cv(o,l){if(o==null)return{};var f=Xt(Gf(o),function(v){return[v]});return l=Ve(l),xg(o,f,function(v,S){return l(v,S[0])})}function f1(o,l,f){l=ps(l,o);var v=-1,S=l.length;for(S||(S=1,o=t);++v<S;){var R=o==null?t:o[vr(l[v])];R===t&&(v=S,R=f),o=Br(R)?R.call(o):R}return o}function d1(o,l,f){return o==null?o:Ml(o,l,f)}function p1(o,l,f,v){return v=typeof v=="function"?v:t,o==null?o:Ml(o,l,f,v)}var Rv=Gg(vn),Pv=Gg(Qn);function _1(o,l,f){var v=Qe(o),S=v||ms(o)||ra(o);if(l=Ve(l,4),f==null){var R=o&&o.constructor;S?f=v?new R:[]:Kt(o)?f=Br(R)?ea(Wc(o)):{}:f={}}return(S?Li:mr)(o,function(U,z,X){return l(f,U,z,X)}),f}function m1(o,l){return o==null?!0:Df(o,l)}function g1(o,l,f){return o==null?o:Tg(o,l,Uf(f))}function v1(o,l,f,v){return v=typeof v=="function"?v:t,o==null?o:Tg(o,l,Uf(f),v)}function sa(o){return o==null?[]:pf(o,vn(o))}function x1(o){return o==null?[]:pf(o,Qn(o))}function y1(o,l,f){return f===t&&(f=l,l=t),f!==t&&(f=Bi(f),f=f===f?f:0),l!==t&&(l=Bi(l),l=l===l?l:0),to(Bi(o),l,f)}function E1(o,l,f){return l=kr(l),f===t?(f=l,l=0):f=kr(f),o=Bi(o),Aw(o,l,f)}function S1(o,l,f){if(f&&typeof f!="boolean"&&Wn(o,l,f)&&(l=f=t),f===t&&(typeof l=="boolean"?(f=l,l=t):typeof o=="boolean"&&(f=o,o=t)),o===t&&l===t?(o=0,l=1):(o=kr(o),l===t?(l=o,o=0):l=kr(l)),o>l){var v=o;o=l,l=v}if(f||o%1||l%1){var S=eg();return Dn(o+S*(l-o+eT("1e-"+((S+"").length-1))),l)}return Pf(o,l)}var M1=na(function(o,l,f){return l=l.toLowerCase(),o+(f?Iv(l):l)});function Iv(o){return id(bt(o).toLowerCase())}function Lv(o){return o=bt(o),o&&o.replace(wt,dT).replace(VM,"")}function T1(o,l,f){o=bt(o),l=di(l);var v=o.length;f=f===t?v:to(tt(f),0,v);var S=f;return f-=l.length,f>=0&&o.slice(f,S)==l}function w1(o){return o=bt(o),o&&Ct.test(o)?o.replace(Le,pT):o}function b1(o){return o=bt(o),o&&Ic.test(o)?o.replace(as,"\\$&"):o}var A1=na(function(o,l,f){return o+(f?"-":"")+l.toLowerCase()}),C1=na(function(o,l,f){return o+(f?" ":"")+l.toLowerCase()}),R1=Og("toLowerCase");function P1(o,l,f){o=bt(o),l=tt(l);var v=l?Ko(o):0;if(!l||v>=l)return o;var S=(l-v)/2;return ou(Yc(S),f)+o+ou(qc(S),f)}function I1(o,l,f){o=bt(o),l=tt(l);var v=l?Ko(o):0;return l&&v<l?o+ou(l-v,f):o}function L1(o,l,f){o=bt(o),l=tt(l);var v=l?Ko(o):0;return l&&v<l?ou(l-v,f)+o:o}function D1(o,l,f){return f||l==null?l=0:l&&(l=+l),zT(bt(o).replace(ll,""),l||0)}function N1(o,l,f){return(f?Wn(o,l,f):l===t)?l=1:l=tt(l),If(bt(o),l)}function O1(){var o=arguments,l=bt(o[0]);return o.length<3?l:l.replace(o[1],o[2])}var U1=na(function(o,l,f){return o+(f?"_":"")+l.toLowerCase()});function F1(o,l,f){return f&&typeof f!="number"&&Wn(o,l,f)&&(l=f=t),f=f===t?Ie:f>>>0,f?(o=bt(o),o&&(typeof l=="string"||l!=null&&!ed(l))&&(l=di(l),!l&&$o(o))?_s(Ji(o),0,f):o.split(l,f)):[]}var B1=na(function(o,l,f){return o+(f?" ":"")+id(l)});function k1(o,l,f){return o=bt(o),f=f==null?0:to(tt(f),0,o.length),l=di(l),o.slice(f,f+l.length)==l}function z1(o,l,f){var v=A.templateSettings;f&&Wn(o,l,f)&&(l=t),o=bt(o),l=vu({},l,v,Hg);var S=vu({},l.imports,v.imports,Hg),R=vn(S),U=pf(S,R),z,X,de=0,pe=l.interpolate||an,me="__p += '",Ae=mf((l.escape||an).source+"|"+pe.source+"|"+(pe===Qi?Ge:an).source+"|"+(l.evaluate||an).source+"|$","g"),Be="//# sourceURL="+(Pt.call(l,"sourceURL")?(l.sourceURL+"").replace(/\s/g," "):"lodash.templateSources["+ ++KM+"]")+`
...
`;else if(q.test(Xe))throw new Ze(c);me=(X?me.replace(Yt,""):me).replace(H,"$1").replace(se,"$1;"),me="function("+(Xe||"obj")+`) {
`+(Xe?"":`obj || (obj = {});
`)+"var __t, __p = ''"+(z?", __e = _.escape":"")+(X?`, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
`:`;
`)+me+`return __p
}`;var it=Nv(function(){return Mt(R,Be+"return "+me).apply(t,U)});if(it.source=me,Jf(it))throw it;return it}function G1(o){return bt(o).toLowerCase()}function H1(o){return bt(o).toUpperCase()}function W1(o,l,f){if(o=bt(o),o&&(f||l===t))return Wm(o);if(!o||!(l=di(l)))return o;var v=Ji(o),S=Ji(l),R=Vm(v,S),U=Xm(v,S)+1;return _s(v,R,U).join("")}function V1(o,l,f){if(o=bt(o),o&&(f||l===t))return o.slice(0,Ym(o)+1);if(!o||!(l=di(l)))return o;var v=Ji(o),S=Xm(v,Ji(l))+1;return _s(v,0,S).join("")}function X1(o,l,f){if(o=bt(o),o&&(f||l===t))return o.replace(ll,"");if(!o||!(l=di(l)))return o;var v=Ji(o),S=Vm(v,Ji(l));return _s(v,S).join("")}function q1(o,l){var f=L,v=Q;if(Kt(l)){var S="separator"in l?l.separator:S;f="length"in l?tt(l.length):f,v="omission"in l?di(l.omission):v}o=bt(o);var R=o.length;if($o(o)){var U=Ji(o);R=U.length}if(f>=R)return o;var z=f-Ko(v);if(z<1)return v;var X=U?_s(U,0,z).join(""):o.slice(0,z);if(S===t)return X+v;if(U&&(z+=X.length-z),ed(S)){if(o.slice(z).search(S)){var de,pe=X;for(S.global||(S=mf(S.source,bt(We.exec(S))+"g")),S.lastIndex=0;de=S.exec(pe);)var me=de.index;X=X.slice(0,me===t?z:me)}}else if(o.indexOf(di(S),z)!=z){var Ae=X.lastIndexOf(S);Ae>-1&&(X=X.slice(0,Ae))}return X+v}function Y1(o){return o=bt(o),o&&ke.test(o)?o.replace(xe,ST):o}var $1=na(function(o,l,f){return o+(f?" ":"")+l.toUpperCase()}),id=Og("toUpperCase");function Dv(o,l,f){return o=bt(o),l=f?t:l,l===t?gT(o)?wT(o):lT(o):o.match(l)||[]}var Nv=lt(function(o,l){try{return hi(o,t,l)}catch(f){return Jf(f)?f:new Ze(f)}}),K1=Ur(function(o,l){return Li(l,function(f){f=vr(f),Nr(o,f,Zf(o[f],o))}),o});function j1(o){var l=o==null?0:o.length,f=Ve();return o=l?Xt(o,function(v){if(typeof v[1]!="function")throw new Di(a);return[f(v[0]),v[1]]}):[],lt(function(v){for(var S=-1;++S<l;){var R=o[S];if(hi(R[0],this,v))return hi(R[1],this,v)}})}function Z1(o){return Sw(Oi(o,p))}function rd(o){return function(){return o}}function Q1(o,l){return o==null||o!==o?l:o}var J1=Fg(),eR=Fg(!0);function Jn(o){return o}function sd(o){return dg(typeof o=="function"?o:Oi(o,p))}function tR(o){return _g(Oi(o,p))}function nR(o,l){return mg(o,Oi(l,p))}var iR=lt(function(o,l){return function(f){return El(f,o,l)}}),rR=lt(function(o,l){return function(f){return El(o,f,l)}});function od(o,l,f){var v=vn(l),S=Jc(l,v);f==null&&!(Kt(l)&&(S.length||!v.length))&&(f=l,l=o,o=this,S=Jc(l,vn(l)));var R=!(Kt(f)&&"chain"in f)||!!f.chain,U=Br(o);return Li(S,function(z){var X=l[z];o[z]=X,U&&(o.prototype[z]=function(){var de=this.__chain__;if(R||de){var pe=o(this.__wrapped__),me=pe.__actions__=jn(this.__actions__);return me.push({func:X,args:arguments,thisArg:o}),pe.__chain__=de,pe}return X.apply(o,cs([this.value()],arguments))})}),o}function sR(){return Cn._===this&&(Cn._=IT),this}function ad(){}function oR(o){return o=tt(o),lt(function(l){return gg(l,o)})}var aR=Bf(Xt),lR=Bf(Bm),cR=Bf(cf);function Ov(o){return Xf(o)?uf(vr(o)):kw(o)}function uR(o){return function(l){return o==null?t:no(o,l)}}var hR=kg(),fR=kg(!0);function ld(){return[]}function cd(){return!1}function dR(){return{}}function pR(){return""}function _R(){return!0}function mR(o,l){if(o=tt(o),o<1||o>ne)return[];var f=Ie,v=Dn(o,Ie);l=Ve(l),o-=Ie;for(var S=df(v,l);++f<o;)l(f);return S}function gR(o){return Qe(o)?Xt(o,vr):pi(o)?[o]:jn(tv(bt(o)))}function vR(o){var l=++RT;return bt(o)+l}var xR=su(function(o,l){return o+l},0),yR=kf("ceil"),ER=su(function(o,l){return o/l},1),SR=kf("floor");function MR(o){return o&&o.length?Qc(o,Jn,Tf):t}function TR(o,l){return o&&o.length?Qc(o,Ve(l,2),Tf):t}function wR(o){return Gm(o,Jn)}function bR(o,l){return Gm(o,Ve(l,2))}function AR(o){return o&&o.length?Qc(o,Jn,Cf):t}function CR(o,l){return o&&o.length?Qc(o,Ve(l,2),Cf):t}var RR=su(function(o,l){return o*l},1),PR=kf("round"),IR=su(function(o,l){return o-l},0);function LR(o){return o&&o.length?ff(o,Jn):0}function DR(o,l){return o&&o.length?ff(o,Ve(l,2)):0}return A.after=tC,A.ary=fv,A.assign=HC,A.assignIn=bv,A.assignInWith=vu,A.assignWith=WC,A.at=VC,A.before=dv,A.bind=Zf,A.bindAll=K1,A.bindKey=pv,A.castArray=dC,A.chain=cv,A.chunk=Sb,A.compact=Mb,A.concat=Tb,A.cond=j1,A.conforms=Z1,A.constant=rd,A.countBy=LA,A.create=XC,A.curry=_v,A.curryRight=mv,A.debounce=gv,A.defaults=qC,A.defaultsDeep=YC,A.defer=nC,A.delay=iC,A.difference=wb,A.differenceBy=bb,A.differenceWith=Ab,A.drop=Cb,A.dropRight=Rb,A.dropRightWhile=Pb,A.dropWhile=Ib,A.fill=Lb,A.filter=NA,A.flatMap=FA,A.flatMapDeep=BA,A.flatMapDepth=kA,A.flatten=sv,A.flattenDeep=Db,A.flattenDepth=Nb,A.flip=rC,A.flow=J1,A.flowRight=eR,A.fromPairs=Ob,A.functions=e1,A.functionsIn=t1,A.groupBy=zA,A.initial=Fb,A.intersection=Bb,A.intersectionBy=kb,A.intersectionWith=zb,A.invert=i1,A.invertBy=r1,A.invokeMap=HA,A.iteratee=sd,A.keyBy=WA,A.keys=vn,A.keysIn=Qn,A.map=fu,A.mapKeys=o1,A.mapValues=a1,A.matches=tR,A.matchesProperty=nR,A.memoize=pu,A.merge=l1,A.mergeWith=Av,A.method=iR,A.methodOf=rR,A.mixin=od,A.negate=_u,A.nthArg=oR,A.omit=c1,A.omitBy=u1,A.once=sC,A.orderBy=VA,A.over=aR,A.overArgs=oC,A.overEvery=lR,A.overSome=cR,A.partial=Qf,A.partialRight=vv,A.partition=XA,A.pick=h1,A.pickBy=Cv,A.property=Ov,A.propertyOf=uR,A.pull=Vb,A.pullAll=av,A.pullAllBy=Xb,A.pullAllWith=qb,A.pullAt=Yb,A.range=hR,A.rangeRight=fR,A.rearg=aC,A.reject=$A,A.remove=$b,A.rest=lC,A.reverse=Kf,A.sampleSize=jA,A.set=d1,A.setWith=p1,A.shuffle=ZA,A.slice=Kb,A.sortBy=eC,A.sortedUniq=nA,A.sortedUniqBy=iA,A.split=F1,A.spread=cC,A.tail=rA,A.take=sA,A.takeRight=oA,A.takeRightWhile=aA,A.takeWhile=lA,A.tap=MA,A.throttle=uC,A.thru=hu,A.toArray=Mv,A.toPairs=Rv,A.toPairsIn=Pv,A.toPath=gR,A.toPlainObject=wv,A.transform=_1,A.unary=hC,A.union=cA,A.unionBy=uA,A.unionWith=hA,A.uniq=fA,A.uniqBy=dA,A.uniqWith=pA,A.unset=m1,A.unzip=jf,A.unzipWith=lv,A.update=g1,A.updateWith=v1,A.values=sa,A.valuesIn=x1,A.without=_A,A.words=Dv,A.wrap=fC,A.xor=mA,A.xorBy=gA,A.xorWith=vA,A.zip=xA,A.zipObject=yA,A.zipObjectDeep=EA,A.zipWith=SA,A.entries=Rv,A.entriesIn=Pv,A.extend=bv,A.extendWith=vu,od(A,A),A.add=xR,A.attempt=Nv,A.camelCase=M1,A.capitalize=Iv,A.ceil=yR,A.clamp=y1,A.clone=pC,A.cloneDeep=mC,A.cloneDeepWith=gC,A.cloneWith=_C,A.conformsTo=vC,A.deburr=Lv,A.defaultTo=Q1,A.divide=ER,A.endsWith=T1,A.eq=tr,A.escape=w1,A.escapeRegExp=b1,A.every=DA,A.find=OA,A.findIndex=iv,A.findKey=$C,A.findLast=UA,A.findLastIndex=rv,A.findLastKey=KC,A.floor=SR,A.forEach=uv,A.forEachRight=hv,A.forIn=jC,A.forInRight=ZC,A.forOwn=QC,A.forOwnRight=JC,A.get=td,A.gt=xC,A.gte=yC,A.has=n1,A.hasIn=nd,A.head=ov,A.identity=Jn,A.includes=GA,A.indexOf=Ub,A.inRange=E1,A.invoke=s1,A.isArguments=so,A.isArray=Qe,A.isArrayBuffer=EC,A.isArrayLike=Zn,A.isArrayLikeObject=rn,A.isBoolean=SC,A.isBuffer=ms,A.isDate=MC,A.isElement=TC,A.isEmpty=wC,A.isEqual=bC,A.isEqualWith=AC,A.isError=Jf,A.isFinite=CC,A.isFunction=Br,A.isInteger=xv,A.isLength=mu,A.isMap=yv,A.isMatch=RC,A.isMatchWith=PC,A.isNaN=IC,A.isNative=LC,A.isNil=NC,A.isNull=DC,A.isNumber=Ev,A.isObject=Kt,A.isObjectLike=en,A.isPlainObject=Al,A.isRegExp=ed,A.isSafeInteger=OC,A.isSet=Sv,A.isString=gu,A.isSymbol=pi,A.isTypedArray=ra,A.isUndefined=UC,A.isWeakMap=FC,A.isWeakSet=BC,A.join=Gb,A.kebabCase=A1,A.last=Fi,A.lastIndexOf=Hb,A.lowerCase=C1,A.lowerFirst=R1,A.lt=kC,A.lte=zC,A.max=MR,A.maxBy=TR,A.mean=wR,A.meanBy=bR,A.min=AR,A.minBy=CR,A.stubArray=ld,A.stubFalse=cd,A.stubObject=dR,A.stubString=pR,A.stubTrue=_R,A.multiply=RR,A.nth=Wb,A.noConflict=sR,A.noop=ad,A.now=du,A.pad=P1,A.padEnd=I1,A.padStart=L1,A.parseInt=D1,A.random=S1,A.reduce=qA,A.reduceRight=YA,A.repeat=N1,A.replace=O1,A.result=f1,A.round=PR,A.runInContext=V,A.sample=KA,A.size=QA,A.snakeCase=U1,A.some=JA,A.sortedIndex=jb,A.sortedIndexBy=Zb,A.sortedIndexOf=Qb,A.sortedLastIndex=Jb,A.sortedLastIndexBy=eA,A.sortedLastIndexOf=tA,A.startCase=B1,A.startsWith=k1,A.subtract=IR,A.sum=LR,A.sumBy=DR,A.template=z1,A.times=mR,A.toFinite=kr,A.toInteger=tt,A.toLength=Tv,A.toLower=G1,A.toNumber=Bi,A.toSafeInteger=GC,A.toString=bt,A.toUpper=H1,A.trim=W1,A.trimEnd=V1,A.trimStart=X1,A.truncate=q1,A.unescape=Y1,A.uniqueId=vR,A.upperCase=$1,A.upperFirst=id,A.each=uv,A.eachRight=hv,A.first=ov,od(A,function(){var o={};return mr(A,function(l,f){Pt.call(A.prototype,f)||(o[f]=l)}),o}(),{chain:!1}),A.VERSION=n,Li(["bind","bindKey","curry","curryRight","partial","partialRight"],function(o){A[o].placeholder=A}),Li(["drop","take"],function(o,l){mt.prototype[o]=function(f){f=f===t?1:hn(tt(f),0);var v=this.__filtered__&&!l?new mt(this):this.clone();return v.__filtered__?v.__takeCount__=Dn(f,v.__takeCount__):v.__views__.push({size:Dn(f,Ie),type:o+(v.__dir__<0?"Right":"")}),v},mt.prototype[o+"Right"]=function(f){return this.reverse()[o](f).reverse()}}),Li(["filter","map","takeWhile"],function(o,l){var f=l+1,v=f==$||f==le;mt.prototype[o]=function(S){var R=this.clone();return R.__iteratees__.push({iteratee:Ve(S,3),type:f}),R.__filtered__=R.__filtered__||v,R}}),Li(["head","last"],function(o,l){var f="take"+(l?"Right":"");mt.prototype[o]=function(){return this[f](1).value()[0]}}),Li(["initial","tail"],function(o,l){var f="drop"+(l?"":"Right");mt.prototype[o]=function(){return this.__filtered__?new mt(this):this[f](1)}}),mt.prototype.compact=function(){return this.filter(Jn)},mt.prototype.find=function(o){return this.filter(o).head()},mt.prototype.findLast=function(o){return this.reverse().find(o)},mt.prototype.invokeMap=lt(function(o,l){return typeof o=="function"?new mt(this):this.map(function(f){return El(f,o,l)})}),mt.prototype.reject=function(o){return this.filter(_u(Ve(o)))},mt.prototype.slice=function(o,l){o=tt(o);var f=this;return f.__filtered__&&(o>0||l<0)?new mt(f):(o<0?f=f.takeRight(-o):o&&(f=f.drop(o)),l!==t&&(l=tt(l),f=l<0?f.dropRight(-l):f.take(l-o)),f)},mt.prototype.takeRightWhile=function(o){return this.reverse().takeWhile(o).reverse()},mt.prototype.toArray=function(){return this.take(Ie)},mr(mt.prototype,function(o,l){var f=/^(?:filter|find|map|reject)|While$/.test(l),v=/^(?:head|last)$/.test(l),S=A[v?"take"+(l=="last"?"Right":""):l],R=v||/^find/.test(l);S&&(A.prototype[l]=function(){var U=this.__wrapped__,z=v?[1]:arguments,X=U instanceof mt,de=z[0],pe=X||Qe(U),me=function(pt){var gt=S.apply(A,cs([pt],z));return v&&Ae?gt[0]:gt};pe&&f&&typeof de=="function"&&de.length!=1&&(X=pe=!1);var Ae=this.__chain__,Be=!!this.__actions__.length,Xe=R&&!Ae,it=X&&!Be;if(!R&&pe){U=it?U:new mt(this);var qe=o.apply(U,z);return qe.__actions__.push({func:hu,args:[me],thisArg:t}),new Ni(qe,Ae)}return Xe&&it?o.apply(this,z):(qe=this.thru(me),Xe?v?qe.value()[0]:qe.value():qe)})}),Li(["pop","push","shift","sort","splice","unshift"],function(o){var l=Fc[o],f=/^(?:push|sort|unshift)$/.test(o)?"tap":"thru",v=/^(?:pop|shift)$/.test(o);A.prototype[o]=function(){var S=arguments;if(v&&!this.__chain__){var R=this.value();return l.apply(Qe(R)?R:[],S)}return this[f](function(U){return l.apply(Qe(U)?U:[],S)})}}),mr(mt.prototype,function(o,l){var f=A[l];if(f){var v=f.name+"";Pt.call(Jo,v)||(Jo[v]=[]),Jo[v].push({name:l,func:f})}}),Jo[ru(t,m).name]=[{name:"wrapper",func:t}],mt.prototype.clone=YT,mt.prototype.reverse=$T,mt.prototype.value=KT,A.prototype.at=TA,A.prototype.chain=wA,A.prototype.commit=bA,A.prototype.next=AA,A.prototype.plant=RA,A.prototype.reverse=PA,A.prototype.toJSON=A.prototype.valueOf=A.prototype.value=IA,A.prototype.first=A.prototype.head,pl&&(A.prototype[pl]=CA),A},jo=bT();Zs?((Zs.exports=jo)._=jo,sf._=jo):Cn._=jo}).call(Fl)})(yh,yh.exports);var Wz=yh.exports;const Ks=new Tk,Vz=new Q_(17.423),Xz=new wk({color:5788374}),r_=new Jr(Vz,Xz);Ks.add(r_);const mm=new PS(16777215,1,100);mm.position.set(30,30,120);mm.intensity=1.5;Ks.add(mm);const qz=new Ck(16777215,.5);Ks.add(qz);const IM=new PS(16777215,1);IM.position.set(0,1,0);Ks.add(IM);const jr={width:window.innerWidth,height:window.innerHeight},Xs=new Wi(75,jr.width/jr.height,.1,1e3);Xs.position.z=40;Ks.add(Xs);const gm=document.getElementById("canvas5");function Yz(i,e,t,n){const r=new CS({canvas:t,antialias:!0,alpha:!0});return r.setPixelRatio(window.devicePixelRatio),r.setSize(n.width,n.height),r.render(i,e),r}const Eh=Yz(Ks,Xs,gm,jr),es=new Hz(Xs,gm);es.enablePan=!1;es.enableZoom=!1;es.autoRotate=!0;es.autoRotateSpeed=5;window.innerWidth>=915?(es.enableDamping=!0,es.enablePan=!0):(es.enableRotate=!1,es.enablePan=!0);window.innerWidth<=915&&gm.addEventListener("touchstart",i=>{i.stopPropagation()});const $z=Wz.throttle(()=>{jr.width=window.innerWidth,jr.height=window.innerHeight,Xs.aspect=jr.width/jr.height,Xs.updateProjectionMatrix(),Eh.setSize(jr.width,jr.height),Eh.setPixelRatio(window.devicePixelRatio)});window.addEventListener("resize",$z);const LM=()=>{es.update(),Eh.render(Ks,Xs),window.requestAnimationFrame(LM)};LM();const DM=PM.timeline({defaults:{duration:1}});DM.fromTo(".navbar",{y:"-100%"},{y:"0%"});DM.fromTo(".heading",{opacity:0},{opacity:1});function NM(){requestAnimationFrame(NM),r_.rotation.x+=.01,r_.rotation.y+=.01,Eh.render(Ks,Xs)}NM();
